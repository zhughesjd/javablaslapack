...
*<br>
*> \htmlonly<br>
*> Download ZGBBRD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgbbrd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgbbrd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgbbrd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGBBRD( VECT, M, N, NCC, KL, KU, AB, LDAB, D, E, Q,<br>
*                          LDQ, PT, LDPT, C, LDC, WORK, RWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          VECT<br>
...
*       COMPLEX*16         AB( LDAB, * ), C( LDC, * ), PT( LDPT, * ),<br>
*      $                   Q( LDQ, * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> ZGBBRD reduces a complex general m-by-n band matrix A to real upper<br>
*> bidiagonal form B by a unitary transformation: Q**H * A * P = B.<br>
*><br>
*> The routine computes B, and optionally forms Q or P**H, or computes<br>
*> Q**H*C for a given matrix C.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*>          Specifies whether or not the matrices Q and P**H are to be<br>
*>          formed.<br>
*>          = 'N': do not form Q or P**H;<br>
*>          = 'Q': form Q only;<br>
*>          = 'P': form P**H only;<br>
*>          = 'B': form both.<br>
*> \endverbatim<br>
...
*> \param[out] Q<br>
*> \verbatim<br>
*>          Q is COMPLEX*16 array, dimension (LDQ,M)<br>
*>          If VECT = 'Q' or 'B', the m-by-m unitary matrix Q.<br>
...
*> \param[out] PT<br>
*> \verbatim<br>
*>          PT is COMPLEX*16 array, dimension (LDPT,N)<br>
*>          If VECT = 'P' or 'B', the n-by-n unitary matrix P'.<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is COMPLEX*16 array, dimension (max(M,N))<br>
*> \endverbatim<br>
*><br>
*> \param[out] RWORK<br>
*> \verbatim<br>
*>          RWORK is DOUBLE PRECISION array, dimension (max(M,N))<br>
*> \endverbatim<br>
*><br>
*> \param[out] INFO<br>
*> \verbatim<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGBCON + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgbcon.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgbcon.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgbcon.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGBCON( NORM, N, KL, KU, AB, LDAB, IPIV, ANORM, RCOND,<br>
*                          WORK, RWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          NORM<br>
...
*> \verbatim<br>
*><br>
*> ZGBCON estimates the reciprocal of the condition number of a complex<br>
*> general band matrix A, in either the 1-norm or the infinity-norm,<br>
*> using the LU factorization computed by ZGBTRF.<br>
*><br>
...
*>          computed by ZGBTRF.  U is stored as an upper triangular band<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGBEQU + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgbequ.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgbequ.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgbequ.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGBEQU( M, N, KL, KU, AB, LDAB, R, C, ROWCND, COLCND,<br>
*                          AMAX, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> ZGBEQU computes row and column scalings intended to equilibrate an<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGBEQUB + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgbequb.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgbequb.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgbequb.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGBEQUB( M, N, KL, KU, AB, LDAB, R, C, ROWCND, COLCND,<br>
*                           AMAX, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, KL, KU, LDAB, M, N<br>
...
*> \verbatim<br>
*><br>
*> ZGBEQUB computes row and column scalings intended to equilibrate an<br>
...
*><br>
*> This routine differs from ZGEEQU by restricting the scaling factors<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGBRFS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgbrfs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgbrfs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgbrfs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGBRFS( TRANS, N, KL, KU, NRHS, AB, LDAB, AFB, LDAFB,<br>
*                          IPIV, B, LDB, X, LDX, FERR, BERR, WORK, RWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANS<br>
...
*> \verbatim<br>
*><br>
*> ZGBRFS improves the computed solution to a system of linear<br>
...
*> \verbatim<br>
*>          IPIV is INTEGER array, dimension (N)<br>
*>          The pivot indices from ZGBTRF; for 1<=i<=N, row i of the<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGBRFSX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgbrfsx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgbrfsx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgbrfsx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGBRFSX( TRANS, EQUED, N, KL, KU, NRHS, AB, LDAB, AFB,<br>
*                           LDAFB, IPIV, R, C, B, LDB, X, LDX, RCOND,<br>
*                           BERR, N_ERR_BNDS, ERR_BNDS_NORM,<br>
*                           ERR_BNDS_COMP, NPARAMS, PARAMS, WORK, RWORK,<br>
*                           INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*>    ZGBRFSX improves the computed solution to a system of linear<br>
...
/**
*> \brief <b> ZGBSV computes the solution to system of linear equations A * X = B for GB matrices</b> (simple driver)<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGBSV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgbsv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgbsv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgbsv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGBSV( N, KL, KU, NRHS, AB, LDAB, IPIV, B, LDB, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> ZGBSV computes the solution to a complex system of linear equations<br>
...
/**
*> \brief <b> ZGBSVX computes the solution to system of linear equations A * X = B for GB matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGBSVX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgbsvx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgbsvx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgbsvx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGBSVX( FACT, TRANS, N, KL, KU, NRHS, AB, LDAB, AFB,<br>
...
*       .. Array Arguments ..<br>
*       INTEGER            IPIV( * )<br>
*       DOUBLE PRECISION   BERR( * ), C( * ), FERR( * ), R( * ),<br>
*      $                   RWORK( * )<br>
*       COMPLEX*16         AB( LDAB, * ), AFB( LDAFB, * ), B( LDB, * ),<br>
*      $                   WORK( * ), X( LDX, * )<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGBSVX uses the LU factorization to compute the solution to a complex<br>
...
*>          A, as computed by ZGBTRF.  U is stored as an upper triangular<br>
...
*>          used. If RWORK(1) is much less than 1, then the stability<br>
...
*>          RWORK(1) contains the reciprocal pivot growth factor for the<br>
...
/**
*> \brief <b> ZGBSVXX computes the solution to system of linear equations A * X = B for GB matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGBSVXX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgbsvxx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgbsvxx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgbsvxx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGBSVXX( FACT, TRANS, N, KL, KU, NRHS, AB, LDAB, AFB,<br>
*                           LDAFB, IPIV, EQUED, R, C, B, LDB, X, LDX,<br>
...
*> \verbatim<br>
*><br>
*>    ZGBSVXX uses the LU factorization to compute the solution to a<br>
*>    complex*16 system of linear equations  A * X = B,  where A is an<br>
*>    N-by-N matrix and X and B are N-by-NRHS matrices.<br>
*><br>
*>    If requested, both normwise and maximum componentwise error bounds<br>
*>    are returned. ZGBSVXX will return a solution with a tiny<br>
...
*><br>
*>    ZGBSVXX accepts user-provided factorizations and equilibration<br>
...
*>    ZGBSVXX call will also produce a solution with either O(eps)<br>
...
*>    differ from what ZGBSVXX would itself produce.<br>
*> \endverbatim<br>
*<br>
*> \par Description:<br>
*  =================<br>
...
/**
*> \brief \b ZGBTF2 computes the LU factorization of a general band matrix using the unblocked version of the algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGBTF2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgbtf2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgbtf2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgbtf2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGBTF2( M, N, KL, KU, AB, LDAB, IPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, KL, KU, LDAB, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGBTF2 computes an LU factorization of a complex m-by-n band matrix<br>
*> A using partial pivoting with row interchanges.<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download ZGBTRF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgbtrf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgbtrf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgbtrf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGBTRF( M, N, KL, KU, AB, LDAB, IPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, KL, KU, LDAB, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGBTRF computes an LU factorization of a complex m-by-n band matrix A<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGBTRS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgbtrs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgbtrs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgbtrs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGBTRS( TRANS, N, KL, KU, NRHS, AB, LDAB, IPIV, B, LDB,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANS<br>
...
*> \verbatim<br>
*><br>
*> ZGBTRS solves a system of linear equations<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEBAK + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgebak.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgebak.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgebak.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEBAK( JOB, SIDE, N, ILO, IHI, SCALE, M, V, LDV,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> ZGEBAK forms the right or left eigenvectors of a complex general<br>
*> matrix by backward transformation on the computed eigenvectors of the<br>
*> balanced matrix output by ZGEBAL.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*>                 scaling.<br>
*>          JOB must be the same as the argument JOB supplied to ZGEBAL.<br>
*> \endverbatim<br>
*><br>
*> \param[in] SIDE<br>
*> \verbatim<br>
...
*> \verbatim<br>
*>          IHI is INTEGER<br>
*>          The integers ILO and IHI determined by ZGEBAL.<br>
...
*> \param[in,out] V<br>
*> \verbatim<br>
*>          V is COMPLEX*16 array, dimension (LDV,M)<br>
*>          On entry, the matrix of right or left eigenvectors to be<br>
*>          transformed, as returned by ZHSEIN or ZTREVC.<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEBAL + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgebal.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgebal.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgebal.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEBAL( JOB, N, A, LDA, ILO, IHI, SCALE, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          JOB<br>
...
*> \verbatim<br>
*><br>
*> ZGEBAL balances a general complex matrix A.  This involves, first,<br>
...
*> \param[out] IHI<br>
*> \verbatim<br>
*>          ILO and IHI are set to INTEGER such that on exit<br>
...
*><br>
*>  This subroutine is based on the EISPACK routine CBAL.<br>
*><br>
...
/**
*> \brief \b ZGEBD2 reduces a general matrix to bidiagonal form using an unblocked algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEBD2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgebd2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgebd2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgebd2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEBD2( M, N, A, LDA, D, E, TAUQ, TAUP, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       COMPLEX*16         A( LDA, * ), TAUP( * ), TAUQ( * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> ZGEBD2 reduces a complex general m by n matrix A to upper or lower<br>
*> real bidiagonal form B by a unitary transformation: Q**H * A * P = B.<br>
*><br>
...
*>            the unitary matrix Q as a product of elementary<br>
...
*>            represent the unitary matrix Q as a product of<br>
...
*> \param[out] TAUQ<br>
*> \verbatim<br>
*>          TAUQ is COMPLEX*16 array dimension (min(M,N))<br>
...
*> \param[out] TAUP<br>
*> \verbatim<br>
*>          TAUP is COMPLEX*16 array, dimension (min(M,N))<br>
*>          The scalar factors of the elementary reflectors which<br>
...
*>  vectors; v(1:i-1) = 0, v(i) = 1, and v(i+1:m) is stored on exit in<br>
*>  A(i+1:m,i); u(1:i) = 0, u(i+1) = 1, and u(i+2:n) is stored on exit in<br>
*>  A(i,i+2:n); tauq is stored in TAUQ(i) and taup in TAUP(i).<br>
*><br>
*>  If m < n,<br>
*><br>
...
*>     H(i) = I - tauq * v * v**H  and G(i) = I - taup * u * u**H<br>
*><br>
*>  where tauq and taup are complex scalars, v and u are complex vectors;<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEBRD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgebrd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgebrd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgebrd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEBRD( M, N, A, LDA, D, E, TAUQ, TAUP, WORK, LWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> ZGEBRD reduces a general complex M-by-N matrix A to upper or lower<br>
*> bidiagonal form B by a unitary transformation: Q**H * A * P = B.<br>
*><br>
*> If m >= n, B is upper bidiagonal; if m < n, B is lower bidiagonal.<br>
*> \endverbatim<br>
...
*><br>
*>  where tauq and taup are complex scalars, and v and u are complex<br>
*>  vectors; v(1:i) = 0, v(i+1) = 1, and v(i+2:m) is stored on exit in<br>
*>  A(i+2:m,i); u(1:i-1) = 0, u(i) = 1, and u(i+1:n) is stored on exit in<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGECON + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgecon.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgecon.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgecon.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGECON( NORM, N, A, LDA, ANORM, RCOND, WORK, RWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          NORM<br>
...
*> \verbatim<br>
*><br>
*> ZGECON estimates the reciprocal of the condition number of a general<br>
*> complex matrix A, in either the 1-norm or the infinity-norm, using<br>
*> the LU factorization computed by ZGETRF.<br>
*><br>
*> An estimate is obtained for norm(inv(A)), and the reciprocal of the<br>
*> condition number is computed as<br>
*>    RCOND = 1 / ( norm(A) * norm(inv(A)) ).<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEEQU + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgeequ.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgeequ.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgeequ.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEEQU( M, N, A, LDA, R, C, ROWCND, COLCND, AMAX,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
...
*> \verbatim<br>
*><br>
*> ZGEEQU computes row and column scalings intended to equilibrate an<br>
*> M-by-N matrix A and reduce its condition number.  R returns the row<br>
*> scale factors and C the column scale factors, chosen to try to make<br>
*> the largest element in each row and column of the matrix B with<br>
*> elements B(i,j)=R(i)*A(i,j)*C(j) have absolute value 1.<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEEQUB + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgeequb.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgeequb.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgeequb.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEEQUB( M, N, A, LDA, R, C, ROWCND, COLCND, AMAX,<br>
*                           INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
...
*> \verbatim<br>
*><br>
*> ZGEEQUB computes row and column scalings intended to equilibrate an<br>
*> M-by-N matrix A and reduce its condition number.  R returns the row<br>
*> scale factors and C the column scale factors, chosen to try to make<br>
*> the largest element in each row and column of the matrix B with<br>
*> elements B(i,j)=R(i)*A(i,j)*C(j) have an absolute value of at most<br>
...
/**
*> \brief <b> ZGEES computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEES + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgees.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgees.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgees.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEES( JOBVS, SORT, SELECT, N, A, LDA, SDIM, W, VS,<br>
*                         LDVS, WORK, LWORK, RWORK, BWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       LOGICAL            BWORK( * )<br>
*       DOUBLE PRECISION   RWORK( * )<br>
*       COMPLEX*16         A( LDA, * ), VS( LDVS, * ), W( * ), WORK( * )<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGEES computes for an N-by-N complex nonsymmetric matrix A, the<br>
*> eigenvalues, the Schur form T, and, optionally, the matrix of Schur<br>
*> vectors Z.  This gives the Schur factorization A = Z*T*(Z**H).<br>
*><br>
*> Optionally, it also orders the eigenvalues on the diagonal of the<br>
*> Schur form so that selected eigenvalues are at the top left.<br>
...
*><br>
*> A complex matrix is in Schur form if it is upper triangular.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*> \param[in] SELECT<br>
*> \verbatim<br>
*>          SELECT is a LOGICAL FUNCTION of one COMPLEX*16 argument<br>
*>          SELECT must be declared EXTERNAL in the calling subroutine.<br>
*>          If SORT = 'S', SELECT is used to select eigenvalues to order<br>
*>          to the top left of the Schur form.<br>
*>          IF SORT = 'N', SELECT is not referenced.<br>
*>          The eigenvalue W(j) is selected if SELECT(W(j)) is true.<br>
*> \endverbatim<br>
*><br>
*> \param[in] N<br>
*> \verbatim<br>
...
*>          On exit, A has been overwritten by its Schur form T.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDA<br>
*> \verbatim<br>
...
*>          SDIM is INTEGER<br>
*>          If SORT = 'N', SDIM = 0.<br>
*>          If SORT = 'S', SDIM = number of eigenvalues for which<br>
*>                         SELECT is true.<br>
*> \endverbatim<br>
*><br>
*> \param[out] W<br>
...
*>          W contains the computed eigenvalues, in the same order that<br>
*>          they appear on the diagonal of the output Schur form T.<br>
*> \endverbatim<br>
*><br>
*> \param[out] VS<br>
*> \verbatim<br>
*>          VS is COMPLEX*16 array, dimension (LDVS,N)<br>
*>          If JOBVS = 'V', VS contains the unitary matrix Z of Schur<br>
*>          vectors.<br>
...
*>                      eigenvalues; elements 1:ILO-1 and i+1:N of W<br>
*>                      contain those eigenvalues which have converged;<br>
*>                      if JOBVS = 'V', VS contains the matrix which<br>
*>                      reduces A to its partially converged Schur form.<br>
*>               = N+1: the eigenvalues could not be reordered because<br>
*>                      some eigenvalues were too close to separate (the<br>
*>                      problem is very ill-conditioned);<br>
*>               = N+2: after reordering, roundoff changed values of<br>
*>                      some complex eigenvalues so that leading<br>
*>                      eigenvalues in the Schur form no longer satisfy<br>
*>                      SELECT = .TRUE..  This could also be caused by<br>
*>                      underflow due to scaling.<br>
*> \endverbatim<br>
*<br>
*  Authors:<br>
*  ========<br>
...
/**
*> \brief <b> ZGEESX computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEESX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgeesx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgeesx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgeesx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEESX( JOBVS, SORT, SELECT, SENSE, N, A, LDA, SDIM, W,<br>
*                          VS, LDVS, RCONDE, RCONDV, WORK, LWORK, RWORK,<br>
*                          BWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> ZGEESX computes for an N-by-N complex nonsymmetric matrix A, the<br>
*> eigenvalues, the Schur form T, and, optionally, the matrix of Schur<br>
*> vectors Z.  This gives the Schur factorization A = Z*T*(Z**H).<br>
*><br>
*> Optionally, it also orders the eigenvalues on the diagonal of the<br>
...
*>          to the top left of the Schur form.<br>
*>          If SORT = 'N', SELECT is not referenced.<br>
*>          An eigenvalue W(j) is selected if SELECT(W(j)) is true.<br>
*> \endverbatim<br>
*><br>
*> \param[in] SENSE<br>
*> \verbatim<br>
...
*>          A is COMPLEX*16 array, dimension (LDA, N)<br>
*>          On entry, the N-by-N matrix A.<br>
*>          On exit, A is overwritten by its Schur form T.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDA<br>
*> \verbatim<br>
...
*> \verbatim<br>
*>          W is COMPLEX*16 array, dimension (N)<br>
*>          W contains the computed eigenvalues, in the same order<br>
...
*>          LWORK is INTEGER<br>
*>          The dimension of the array WORK.  LWORK >= max(1,2*N).<br>
*>          Also, if SENSE = 'E' or 'V' or 'B', LWORK >= 2*SDIM*(N-SDIM),<br>
*>          where SDIM is the number of selected eigenvalues computed by<br>
*>          this routine.  Note that 2*SDIM*(N-SDIM) <= N*N/2. Note also<br>
*>          that an error is only returned if LWORK < max(1,2*N), but if<br>
*>          SENSE = 'E' or 'V' or 'B' this may not be large enough.<br>
*>          For good performance, LWORK must generally be larger.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates upper bound on the optimal size of the<br>
*>          array WORK, returns this value as the first entry of the WORK<br>
*>          array, and no error message related to LWORK is issued by<br>
*>          XERBLA.<br>
*> \endverbatim<br>
*><br>
*> \param[out] RWORK<br>
...
/**
*> \brief <b> ZGEEV computes the eigenvalues and, optionally, the left and/or right eigenvectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEEV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgeev.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgeev.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgeev.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEEV( JOBVL, JOBVR, N, A, LDA, W, VL, LDVL, VR, LDVR,<br>
...
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   RWORK( * )<br>
*       COMPLEX*16         A( LDA, * ), VL( LDVL, * ), VR( LDVR, * ),<br>
*      $                   W( * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> ZGEEV computes for an N-by-N complex nonsymmetric matrix A, the<br>
...
*>          = 'V': left eigenvectors of are computed.<br>
*> \endverbatim<br>
*><br>
*> \param[in] JOBVR<br>
*> \verbatim<br>
...
*> \verbatim<br>
*>          W is COMPLEX*16 array, dimension (N)<br>
*>          W contains the computed eigenvalues.<br>
*> \endverbatim<br>
*><br>
*> \param[out] VL<br>
*> \verbatim<br>
*>          VL is COMPLEX*16 array, dimension (LDVL,N)<br>
...
*>          u(j) = VL(:,j), the j-th column of VL.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDVL<br>
*> \verbatim<br>
...
*> \param[out] VR<br>
*> \verbatim<br>
*>          VR is COMPLEX*16 array, dimension (LDVR,N)<br>
...
*>          v(j) = VR(:,j), the j-th column of VR.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDVR<br>
*> \verbatim<br>
...
*>                elements and i+1:N of W contain eigenvalues which have<br>
*>                converged.<br>
*> \endverbatim<br>
*<br>
*  Authors:<br>
...
/**
*> \brief <b> ZGEEVX computes the eigenvalues and, optionally, the left and/or right eigenvectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEEVX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgeevx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgeevx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgeevx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEEVX( BALANC, JOBVL, JOBVR, SENSE, N, A, LDA, W, VL,<br>
*                          LDVL, VR, LDVR, ILO, IHI, SCALE, ABNRM, RCONDE,<br>
*                          RCONDV, WORK, LWORK, RWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   RCONDE( * ), RCONDV( * ), RWORK( * ),<br>
*      $                   SCALE( * )<br>
*       COMPLEX*16         A( LDA, * ), VL( LDVL, * ), VR( LDVR, * ),<br>
*      $                   W( * ), WORK( * )<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGEEVX computes for an N-by-N complex nonsymmetric matrix A, the<br>
*> eigenvalues and, optionally, the left and/or right eigenvectors.<br>
*><br>
...
*>          = 'S': Diagonally scale the matrix, ie. replace A by<br>
...
*>          JOBVR = 'V', A contains the Schur form of the balanced<br>
*>          version of the matrix A.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDA<br>
*> \verbatim<br>
...
*>          LWORK >= max(1,2*N), and if SENSE = 'V' or 'B',<br>
*>          LWORK >= N*N+2*N.<br>
*>          For good performance, LWORK must generally be larger.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
...
*>                have been computed; elements 1:ILO-1 and i+1:N of W<br>
*>                contain eigenvalues which have converged.<br>
*> \endverbatim<br>
*<br>
*  Authors:<br>
*  ========<br>
...
/**
*> \brief \b ZGEHD2 reduces a general square matrix to upper Hessenberg form using an unblocked algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEHD2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgehd2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgehd2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgehd2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEHD2( N, ILO, IHI, A, LDA, TAU, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            IHI, ILO, INFO, LDA, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGEHD2 reduces a complex general matrix A to upper Hessenberg form H<br>
*> by a unitary similarity transformation:  Q**H * A * Q = H .<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*>          set by a previous call to ZGEBAL; otherwise they should be<br>
...
*>          represent the unitary matrix Q as a product of elementary<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEHRD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgehrd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgehrd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgehrd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEHRD( N, ILO, IHI, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> ZGEHRD reduces a complex general matrix A to upper Hessenberg form H by<br>
*> an unitary similarity transformation:  Q**H * A * Q = H .<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEJSV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgejsv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgejsv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgejsv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*     SUBROUTINE ZGEJSV( JOBA, JOBU, JOBV, JOBR, JOBT, JOBP,<br>
*                         M, N, A, LDA, SVA, U, LDU, V, LDV,<br>
*                         CWORK, LWORK, RWORK, LRWORK, IWORK, INFO )<br>
* <br>
*     .. Scalar Arguments ..<br>
*     IMPLICIT    NONE<br>
...
*     ..<br>
*     .. Array Arguments ..<br>
*     COMPLEX*16     A( LDA, * ),  U( LDU, * ), V( LDV, * ), CWORK( LWORK )<br>
*     DOUBLE PRECISION   SVA( N ), RWORK( LRWORK )      <br>
*     INTEGER     IWORK( * )<br>
...
*> \verbatim<br>
*><br>
*> ZGEJSV computes the singular value decomposition (SVD) of a complex M-by-N<br>
*> matrix [A], where M >= N. The SVD of [A] is written as<br>
*><br>
*>              [A] = [U] * [SIGMA] * [V]^*,<br>
*><br>
*> where [SIGMA] is an N-by-N (M-by-N) matrix which is zero except for its N<br>
*> diagonal elements, [U] is an M-by-N (or M-by-M) unitary matrix, and<br>
*> [V] is an N-by-N unitary matrix. The diagonal elements of [SIGMA] are<br>
...
*>              The computed SVD A = U * S * V^* restores A up to<br>
*>              f(m,n)*epsilon*||A||.<br>
...
*>         value of c*A is around SQRT(BIG), BIG=DLAMCH('O'), then JOBR issues<br>
*>         the licence to kill columns of A whose norm in c*A is less than<br>
*>         SQRT(SFMIN) (for JOBR.EQ.'R'), or less than SMALL=SFMIN/EPSLN,<br>
*>         where SFMIN=DLAMCH('S'), EPSLN=DLAMCH('E').<br>
...
*>              is greater than BIG, use ZGESVJ.<br>
*>       = 'R': RESTRICTED range for sigma(c*A) is [SQRT(SFMIN), SQRT(BIG)]<br>
...
*>         transposed A if A^* seems to be better with respect to convergence.<br>
...
*>         orbit of A^* * A. See the descriptions of WORK(6) and WORK(7).<br>
*>       = 'T': transpose if entropy test indicates possibly faster<br>
*>         convergence of Jacobi process if A^* is taken as input. If A is<br>
*>         replaced with A^*, then the row pivoting is included automatically.<br>
...
*>                         replaces A with A^*. In that case, [V] is computed<br>
*>                         in U as left singular vectors of A^* and then<br>
...
*> \param[out] V<br>
*> \verbatim<br>
*>          V is COMPLEX*16 array, dimension ( LDV, N )<br>
...
*>                         replaces A with A^*. In that case, [U] is computed<br>
*>                         in V as right singular vectors of A^* and then<br>
...
*> \param[out] CWORK<br>
*> \verbatim<br>
*>          CWORK is COMPLEX*16 array, dimension at least LWORK.     <br>
*> \endverbatim<br>
*><br>
*> \param[in] LWORK<br>
*> \verbatim<br>
*>          LWORK is INTEGER<br>
*>          Length of CWORK to confirm proper allocation of workspace.<br>
*>          LWORK depends on the job:<br>
*><br>
*>          1. If only SIGMA is needed ( JOBU.EQ.'N', JOBV.EQ.'N' ) and<br>
*>            1.1 .. no scaled condition estimate required (JOBA.NE.'E'.AND.JOBA.NE.'G'):<br>
*>               LWORK >= 2*N+1. This is the minimal requirement.<br>
*>               ->> For optimal performance (blocked code) the optimal value<br>
*>               is LWORK >= N + (N+1)*NB. Here NB is the optimal<br>
*>               block size for ZGEQP3 and ZGEQRF.<br>
*>               In general, optimal LWORK is computed as <br>
*>               LWORK >= max(N+LWORK(ZGEQP3),N+LWORK(ZGEQRF)).        <br>
*>            1.2. .. an estimate of the scaled condition number of A is<br>
*>               required (JOBA='E', or 'G'). In this case, LWORK the minimal<br>
*>               requirement is LWORK >= N*N + 3*N.<br>
*>               ->> For optimal performance (blocked code) the optimal value <br>
*>               is LWORK >= max(N+(N+1)*NB, N*N+3*N).<br>
*>               In general, the optimal length LWORK is computed as<br>
*>               LWORK >= max(N+LWORK(ZGEQP3),N+LWORK(ZGEQRF), <br>
*>                                                     N+N*N+LWORK(ZPOCON)).<br>
*><br>
*>          2. If SIGMA and the right singular vectors are needed (JOBV.EQ.'V'),<br>
*>             (JOBU.EQ.'N')<br>
*>            -> the minimal requirement is LWORK >= 3*N.<br>
*>            -> For optimal performance, LWORK >= max(N+(N+1)*NB, 3*N,2*N+N*NB),<br>
*>               where NB is the optimal block size for ZGEQP3, ZGEQRF, ZGELQF,<br>
*>               ZUNMLQ. In general, the optimal length LWORK is computed as<br>
*>               LWORK >= max(N+LWORK(ZGEQP3), N+LWORK(ZPOCON), N+LWORK(ZGESVJ),<br>
*>                       N+LWORK(ZGELQF), 2*N+LWORK(ZGEQRF), N+LWORK(ZUNMLQ)).<br>
*><br>
*>          3. If SIGMA and the left singular vectors are needed<br>
*>            -> the minimal requirement is LWORK >= 3*N.<br>
*>            -> For optimal performance:<br>
*>               if JOBU.EQ.'U' :: LWORK >= max(3*N, N+(N+1)*NB, 2*N+N*NB),<br>
*>               where NB is the optimal block size for ZGEQP3, ZGEQRF, ZUNMQR.<br>
*>               In general, the optimal length LWORK is computed as<br>
*>               LWORK >= max(N+LWORK(ZGEQP3),N+LWORK(ZPOCON),<br>
*>                        2*N+LWORK(ZGEQRF), N+LWORK(ZUNMQR)). <br>
*>               <br>
*>          4. If the full SVD is needed: (JOBU.EQ.'U' or JOBU.EQ.'F') and <br>
*>            4.1. if JOBV.EQ.'V'  <br>
*>               the minimal requirement is LWORK >= 5*N+2*N*N. <br>
*>            4.2. if JOBV.EQ.'J' the minimal requirement is <br>
*>               LWORK >= 4*N+N*N.<br>
*>            In both cases, the allocated CWORK can accommodate blocked runs<br>
*>            of ZGEQP3, ZGEQRF, ZGELQF, ZUNMQR, ZUNMLQ.<br>
*> \endverbatim<br>
*><br>
*> \param[out] RWORK<br>
*> \verbatim<br>
*>          RWORK is DOUBLE PRECISION array, dimension at least LRWORK.<br>
*>          On exit,<br>
*>          RWORK(1) = Determines the scaling factor SCALE = RWORK(2) / RWORK(1)<br>
*>                    such that SCALE*SVA(1:N) are the computed singular values<br>
*>                    of A. (See the description of SVA().)<br>
*>          RWORK(2) = See the description of RWORK(1).<br>
*>          RWORK(3) = SCONDA is an estimate for the condition number of<br>
*>                    column equilibrated A. (If JOBA .EQ. 'E' or 'G')<br>
*>                    SCONDA is an estimate of SQRT(||(R^* * R)^(-1)||_1).<br>
*>                    It is computed using SPOCON. It holds<br>
...
*>          the method.<br>
*><br>
*>          RWORK(4) = an estimate of the scaled condition number of the<br>
*>                    triangular factor in the first QR factorization.<br>
*>          RWORK(5) = an estimate of the scaled condition number of the<br>
...
*>          RWORK(6) = the entropy of A^* * A :: this is the Shannon entropy<br>
*>                    of diag(A^* * A) / Trace(A^* * A) taken as point in the<br>
*>                    probability simplex.<br>
*>          RWORK(7) = the entropy of A * A^*. (See the description of RWORK(6).)<br>
*> \endverbatim<br>
*><br>
*> \param[in] LRWORK<br>
*> \verbatim<br>
*>          LRWORK is INTEGER<br>
*>          Length of RWORK to confirm proper allocation of workspace.<br>
*>          LRWORK depends on the job:<br>
*><br>
*>       1. If only singular values are requested i.e. if <br>
*>          LSAME(JOBU,'N') .AND. LSAME(JOBV,'N') <br>
*>          then:<br>
*>          1.1. If LSAME(JOBT,'T') .OR. LSAME(JOBA,'F') .OR. LSAME(JOBA,'G'),<br>
*>          then LRWORK = max( 7, N + 2 * M ). <br>
*>          1.2. Otherwise, LRWORK  = max( 7, 2 * N ).<br>
*>       2. If singular values with the right singular vectors are requested<br>
*>          i.e. if <br>
*>          (LSAME(JOBV,'V').OR.LSAME(JOBV,'J')) .AND. <br>
*>          .NOT.(LSAME(JOBU,'U').OR.LSAME(JOBU,'F'))<br>
*>          then:<br>
*>          2.1. If LSAME(JOBT,'T') .OR. LSAME(JOBA,'F') .OR. LSAME(JOBA,'G'),<br>
*>          then LRWORK = max( 7, N + 2 * M ). <br>
*>          2.2. Otherwise, LRWORK  = max( 7, 2 * N ).      <br>
*>       3. If singular values with the left singular vectors are requested, i.e. if    <br>
*>          (LSAME(JOBU,'U').OR.LSAME(JOBU,'F')) .AND.<br>
*>          .NOT.(LSAME(JOBV,'V').OR.LSAME(JOBV,'J'))<br>
*>          then:<br>
*>          3.1. If LSAME(JOBT,'T') .OR. LSAME(JOBA,'F') .OR. LSAME(JOBA,'G'),<br>
*>          then LRWORK = max( 7, N + 2 * M ). <br>
*>          3.2. Otherwise, LRWORK  = max( 7, 2 * N ).    <br>
*>       4. If singular values with both the left and the right singular vectors <br>
*>          are requested, i.e. if     <br>
*>          (LSAME(JOBU,'U').OR.LSAME(JOBU,'F')) .AND.<br>
*>          (LSAME(JOBV,'V').OR.LSAME(JOBV,'J'))<br>
*>          then:<br>
*>          4.1. If LSAME(JOBT,'T') .OR. LSAME(JOBA,'F') .OR. LSAME(JOBA,'G'),<br>
*>          then LRWORK = max( 7, N + 2 * M ). <br>
*>          4.2. Otherwise, LRWORK  = max( 7, 2 * N ).    <br>
*> \endverbatim<br>
*>          <br>
*> \param[out] IWORK<br>
*> \verbatim<br>
*>          IWORK is INTEGER array, of dimension:<br>
*>                If LSAME(JOBA,'F') .OR. LSAME(JOBA,'G'), then <br>
*>                the dimension of IWORK is max( 3, 2 * N + M ).<br>
*>                Otherwise, the dimension of IWORK is <br>
*>                -> max( 3, 2*N ) for full SVD<br>
*>                -> max( 3, N ) for singular values only or singular<br>
*>                   values with one set of singular vectors (left or right)<br>
*>          On exit,<br>
...
*>           > 0 :  ZGEJSV  did not converge in the maximal allowed number<br>
...
*> \verbatim<br>
*><br>
*>  ZGEJSV implements a preconditioned Jacobi SVD algorithm. It uses ZGEQP3,<br>
*>  ZGEQRF, and ZGELQF as preprocessors and preconditioners. Optionally, an<br>
...
*>  & LAPACK routines called by ZGEJSV are implemented to work in that range.<br>
...
*>  overflow. This code (ZGEJSV) is best used in this restricted range,<br>
...
*>  the choice of some tuning parameters in the iterative part (ZGESVJ) is<br>
*>  left to the implementer on a particular machine.<br>
*>     The rank revealing QR factorization (in this code: ZGEQP3) should be<br>
*>  implemented as in [3]. We have a new version of ZGEQP3 under development<br>
...
*>  well known trick is not used in ZGEJSV because in some cases heavy row<br>
...
*>  implementation of ZGEJSV uses only the simplest, naive data movement.<br>
*<br>
*> \par Contributors:<br>
*  ==================<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download ZGELQ2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgelq2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgelq2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgelq2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGELQ2( M, N, A, LDA, TAU, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGELQ2 computes an LQ factorization of a complex m by n matrix A:<br>
*> A = L * Q.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*><br>
*>     Q = H(k)**H . . . H(2)**H H(1)**H, where k = min(m,n).<br>
*><br>
*>  Each H(i) has the form<br>
*><br>
*>     H(i) = I - tau * v * v**H<br>
*><br>
*>  where tau is a complex scalar, and v is a complex vector with<br>
*>  v(1:i-1) = 0 and v(i) = 1; conjg(v(i+1:n)) is stored on exit in<br>
*>  A(i,i+1:n), and tau in TAU(i).<br>
*> \endverbatim<br>
*><br>
*  =====================================================================<br>
*/
...
*<br>
*> \htmlonly<br>
*> Download ZGELQF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgelqf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgelqf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgelqf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGELQF( M, N, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LWORK, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGELQF computes an LQ factorization of a complex M-by-N matrix A:<br>
*> A = L * Q.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
/**
*> \brief <b> ZGELS solves overdetermined or underdetermined systems for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGELS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgels.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgels.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgels.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGELS( TRANS, M, N, NRHS, A, LDA, B, LDB, WORK, LWORK,<br>
*                         INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANS<br>
...
*> \verbatim<br>
*><br>
*> ZGELS solves overdetermined or underdetermined complex linear systems<br>
*> involving an M-by-N matrix A, or its conjugate-transpose, using a QR<br>
*> or LQ factorization of A.  It is assumed that A has full rank.<br>
*><br>
...
*><br>
*> 3. If TRANS = 'C' and m >= n:  find the minimum norm solution of<br>
*>    an undetermined system A**H * X = B.<br>
*><br>
*> 4. If TRANS = 'C' and m < n:  find the least squares solution of<br>
*>    an overdetermined system, i.e., solve the least squares problem<br>
*>                 minimize || B - A**H * X ||.<br>
*><br>
...
*>          = 'C': the linear system involves A**H.<br>
*> \endverbatim<br>
*><br>
*> \param[in] M<br>
*> \verbatim<br>
...
*>                       factorization as returned by ZGELQF.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDA<br>
*> \verbatim<br>
...
*>          solution in each column is given by the sum of squares of the<br>
...
/**
*> \brief <b> ZGELSD computes the minimum-norm solution to a linear least squares problem for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGELSD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgelsd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgelsd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgelsd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGELSD( M, N, NRHS, A, LDA, B, LDB, S, RCOND, RANK,<br>
*                          WORK, LWORK, RWORK, IWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> ZGELSD computes the minimum-norm solution to a real linear least<br>
*> squares problem:<br>
...
*>     Householder tranformations, reducing the original problem<br>
...
*>          On exit, B is overwritten by the N-by-NRHS solution matrix X.<br>
*>          If m >= n and RANK = n, the residual sum-of-squares for<br>
*>          the solution in the i-th column is given by the sum of<br>
*>          squares of the modulus of elements n+1:m in that column.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDB<br>
*> \verbatim<br>
...
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates the optimal size of the array WORK and the<br>
*>          minimum sizes of the arrays RWORK and IWORK, and returns<br>
*>          these values as the first entries of the WORK, RWORK and<br>
*>          IWORK arrays, and no error message related to LWORK is issued<br>
*>          by XERBLA.<br>
*> \endverbatim<br>
*><br>
*> \param[out] RWORK<br>
...
*>          On exit, if INFO = 0, RWORK(1) returns the minimum LRWORK.<br>
*> \endverbatim<br>
*><br>
*> \param[out] IWORK<br>
*> \verbatim<br>
...
/**
*> \brief <b> ZGELSS solves overdetermined or underdetermined systems for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGELSS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgelss.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgelss.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgelss.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGELSS( M, N, NRHS, A, LDA, B, LDB, S, RCOND, RANK,<br>
*                          WORK, LWORK, RWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LDB, LWORK, M, N, NRHS, RANK<br>
...
*> \verbatim<br>
*><br>
*> ZGELSS computes the minimum norm solution to a complex linear<br>
...
*>          LWORK >=  2*min(M,N) + max(M,N,NRHS)<br>
*>          For good performance, LWORK should generally be larger.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates the optimal size of the WORK array, returns<br>
...
*> \param[out] RWORK<br>
*> \verbatim<br>
*>          RWORK is DOUBLE PRECISION array, dimension (5*min(M,N))<br>
*> \endverbatim<br>
*><br>
*> \param[out] INFO<br>
*> \verbatim<br>
...
/**
*> \brief <b> ZGELSY solves overdetermined or underdetermined systems for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGELSY + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgelsy.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgelsy.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgelsy.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGELSY( M, N, NRHS, A, LDA, B, LDB, JPVT, RCOND, RANK,<br>
*                          WORK, LWORK, RWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LDB, LWORK, M, N, NRHS, RANK<br>
...
*> \verbatim<br>
*><br>
*> ZGELSY computes the minimum-norm solution to a complex linear least<br>
*> squares problem:<br>
*>     minimize || A * X - B ||<br>
...
*> by unitary transformations from the right, arriving at the<br>
...
*>            LWORK >= MN + MAX( 2*MN, NB*(N+1), MN+MN*NB, MN+NB*NRHS )<br>
*>          where NB is an upper bound on the blocksize returned<br>
*>          by ILAENV for the routines ZGEQP3, ZTZRZF, CTZRQF, ZUNMQR,<br>
*>          and ZUNMRZ.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates the optimal size of the WORK array, returns<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEMQRT + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgemqrt.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgemqrt.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgemqrt.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEMQRT( SIDE, TRANS, M, N, K, NB, V, LDV, T, LDT, <br>
*                          C, LDC, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       COMPLEX*16   V( LDV, * ), C( LDC, * ), T( LDT, * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> ZGEMQRT overwrites the general complex M-by-N matrix C with<br>
*><br>
*>                 SIDE = 'L'     SIDE = 'R'<br>
*> TRANS = 'N':      Q C            C Q<br>
*> TRANS = 'C':    Q**H C            C Q**H<br>
*><br>
*> where Q is a complex orthogonal matrix defined as the product of K<br>
*> elementary reflectors:<br>
*><br>
*>       Q = H(1) H(2) . . . H(K) = I - V T V**H<br>
*><br>
*> generated using the compact WY representation as returned by ZGEQRT. <br>
*><br>
...
*> \param[in] V<br>
*> \verbatim<br>
*>          V is COMPLEX*16 array, dimension (LDV,K)<br>
...
*>          On exit, C is overwritten by Q C, Q**H C, C Q**H or C Q.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDC<br>
*> \verbatim<br>
...
/**
*> \brief \b ZGEQL2 computes the QL factorization of a general rectangular matrix using an unblocked algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEQL2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgeql2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgeql2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgeql2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEQL2( M, N, A, LDA, TAU, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGEQL2 computes a QL factorization of a complex m by n matrix A:<br>
*> A = Q * L.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*>          unitary matrix Q as a product of elementary reflectors<br>
*>          (see Further Details).<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDA<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEQLF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgeqlf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgeqlf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgeqlf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEQLF( M, N, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LWORK, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGEQLF computes a QL factorization of a complex M-by-N matrix A:<br>
*> A = Q * L.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEQP3 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgeqp3.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgeqp3.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgeqp3.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEQP3( M, N, A, LDA, JPVT, TAU, WORK, LWORK, RWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LWORK, M, N<br>
...
*> \verbatim<br>
*><br>
*> ZGEQP3 computes a QR factorization with column pivoting of a<br>
...
*>          unitary matrix Q as a product of min(M,N) elementary<br>
*>          reflectors.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDA<br>
...
*>          For optimal performance LWORK >= ( N+1 )*NB, where NB<br>
*>          is the optimal blocksize.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates the optimal size of the WORK array, returns<br>
...
*>     H(i) = I - tau * v * v**H<br>
*><br>
*>  where tau is a complex scalar, and v is a real/complex vector<br>
...
/**
*> \brief \b ZGEQR2 computes the QR factorization of a general rectangular matrix using an unblocked algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEQR2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgeqr2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgeqr2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgeqr2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEQR2( M, N, A, LDA, TAU, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGEQR2 computes a QR factorization of a complex m by n matrix A:<br>
*> A = Q * R.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
/**
*> \brief \b ZGEQR2P computes the QR factorization of a general rectangular matrix with non-negative diagonal elements using an unblocked algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEQR2P + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgeqr2p.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgeqr2p.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgeqr2p.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEQR2P( M, N, A, LDA, TAU, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGEQR2P computes a QR factorization of a complex m by n matrix A:<br>
*> A = Q * R. The diagonal entries of R are real and nonnegative.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*>          are real and nonnegative; the elements below the diagonal,<br>
*>          with the array TAU, represent the unitary matrix Q as a<br>
*>          product of elementary reflectors (see Further Details).<br>
*> \endverbatim<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEQRF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgeqrf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgeqrf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgeqrf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEQRF( M, N, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LWORK, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGEQRF computes a QR factorization of a complex M-by-N matrix A:<br>
*> A = Q * R.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEQRFP + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgeqrfp.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgeqrfp.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgeqrfp.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEQRFP( M, N, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LWORK, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGEQRFP computes a QR factorization of a complex M-by-N matrix A:<br>
*> A = Q * R. The diagonal entries of R are real and nonnegative.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEQRT + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgeqrt.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgeqrt.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgeqrt.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEQRT( M, N, NB, A, LDA, T, LDT, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER INFO, LDA, LDT, M, N, NB<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       COMPLEX*16 A( LDA, * ), T( LDT, * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> ZGEQRT computes a blocked QR factorization of a complex M-by-N matrix A<br>
...
*> \param[out] T<br>
*> \verbatim<br>
*>          T is COMPLEX*16 array, dimension (LDT,MIN(M,N))<br>
...
/**
*> \brief \b ZGEQRT2 computes a QR factorization of a general real or complex matrix using the compact WY representation of Q.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEQRT2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgeqrt2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgeqrt2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgeqrt2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGEQRT2( M, N, A, LDA, T, LDT, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER   INFO, LDA, LDT, M, N<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       COMPLEX*16   A( LDA, * ), T( LDT, * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> ZGEQRT2 computes a QR factorization of a complex M-by-N matrix A, <br>
*> using the compact WY representation of Q. <br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*> \verbatim<br>
*>          A is COMPLEX*16 array, dimension (LDA,N)<br>
*>          On entry, the complex M-by-N matrix A.  On exit, the elements on and<br>
...
*>               H = I - V * T * V**H<br>
*><br>
*>  where V**H is the conjugate transpose of V.<br>
*> \endverbatim<br>
*><br>
*  =====================================================================<br>
*/
...
/**
*> \brief \b ZGEQRT3 recursively computes a QR factorization of a general real or complex matrix using the compact WY representation of Q.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGEQRT3 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgeqrt3.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgeqrt3.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgeqrt3.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       RECURSIVE SUBROUTINE ZGEQRT3( M, N, A, LDA, T, LDT, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> ZGEQRT3 recursively computes a QR factorization of a complex M-by-N <br>
...
*> \verbatim<br>
*>          A is COMPLEX*16 array, dimension (LDA,N)<br>
*>          On entry, the complex M-by-N matrix A.  On exit, the elements on <br>
*>          and above the diagonal contain the N-by-N upper triangular matrix R;<br>
*>          the elements below the diagonal are the columns of V.  See below for<br>
*>          further details.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDA<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGERFS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgerfs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgerfs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgerfs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGERFS( TRANS, N, NRHS, A, LDA, AF, LDAF, IPIV, B, LDB,<br>
...
*> \verbatim<br>
*><br>
*> ZGERFS improves the computed solution to a system of linear<br>
...
*> \verbatim<br>
*>          IPIV is INTEGER array, dimension (N)<br>
*>          The pivot indices from ZGETRF; for 1<=i<=N, row i of the<br>
*>          matrix was interchanged with row IPIV(i).<br>
*> \endverbatim<br>
*><br>
*> \param[in] B<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGERFSX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgerfsx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgerfsx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgerfsx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGERFSX( TRANS, EQUED, N, NRHS, A, LDA, AF, LDAF, IPIV,<br>
...
*> \verbatim<br>
*><br>
*>    ZGERFSX improves the computed solution to a system of linear<br>
*>    equations and provides error bounds and backward error estimates<br>
*>    for the solution.  In addition to normwise error bound, the code<br>
*>    provides maximum componentwise error bound if possible.  See<br>
*>    comments for ERR_BNDS_NORM and ERR_BNDS_COMP for details of the<br>
...
/**
*> \brief \b ZGERQ2 computes the RQ factorization of a general rectangular matrix using an unblocked algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGERQ2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgerq2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgerq2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgerq2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGERQ2( M, N, A, LDA, TAU, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGERQ2 computes an RQ factorization of a complex m by n matrix A:<br>
*> A = R * Q.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*>          elements, with the array TAU, represent the unitary matrix<br>
...
*>  The matrix Q is represented as a product of elementary reflectors<br>
*><br>
*>     Q = H(1)**H H(2)**H . . . H(k)**H, where k = min(m,n).<br>
*><br>
*>  Each H(i) has the form<br>
*><br>
*>     H(i) = I - tau * v * v**H<br>
*><br>
*>  where tau is a complex scalar, and v is a complex vector with<br>
*>  v(n-k+i+1:n) = 0 and v(n-k+i) = 1; conjg(v(1:n-k+i-1)) is stored on<br>
*>  exit in A(m-k+i,1:n-k+i-1), and tau in TAU(i).<br>
*> \endverbatim<br>
*><br>
*  =====================================================================<br>
*/
...
*<br>
*> \htmlonly<br>
*> Download ZGERQF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgerqf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgerqf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgerqf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGERQF( M, N, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LWORK, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGERQF computes an RQ factorization of a complex M-by-N matrix A:<br>
*> A = R * Q.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
/**
*> \brief \b ZGESC2 solves a system of linear equations using the LU factorization with complete pivoting computed by sgetc2.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGESC2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgesc2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgesc2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgesc2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGESC2( N, A, LDA, RHS, IPIV, JPIV, SCALE )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            LDA, N<br>
*       DOUBLE PRECISION   SCALE<br>
...
*> \verbatim<br>
*><br>
*> ZGESC2 solves a system of linear equations<br>
*><br>
*>           A * X = scale* RHS<br>
*><br>
*> with a general N-by-N matrix A using the LU factorization with<br>
*> complete pivoting computed by ZGETC2.<br>
*><br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*>          matrix A computed by ZGETC2:  A = P * L * U * Q<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDA<br>
*> \verbatim<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGESDD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgesdd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgesdd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgesdd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGESDD( JOBZ, M, N, A, LDA, S, U, LDU, VT, LDVT,<br>
*                          WORK, LWORK, RWORK, IWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          JOBZ<br>
...
*       INTEGER            IWORK( * )<br>
*       DOUBLE PRECISION   RWORK( * ), S( * )<br>
*       COMPLEX*16         A( LDA, * ), U( LDU, * ), VT( LDVT, * ),<br>
*      $                   WORK( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> ZGESDD computes the singular value decomposition (SVD) of a complex<br>
*> M-by-N matrix A, optionally computing the left and/or right singular<br>
*> vectors, by using divide-and-conquer method. The SVD is written<br>
*><br>
*>      A = U * SIGMA * conjugate-transpose(V)<br>
*><br>
*> where SIGMA is an M-by-N matrix which is zero except for its<br>
*> min(m,n) diagonal elements, U is an M-by-M unitary matrix, and<br>
*> V is an N-by-N unitary matrix.  The diagonal elements of SIGMA<br>
...
*><br>
*> Note that the routine returns VT = V**H, not V.<br>
*><br>
*> The divide and conquer algorithm makes very mild assumptions about<br>
*> floating point arithmetic. It will work on machines with a guard<br>
*> digit in add/subtract, or on those binary machines without guard<br>
...
*>          = 'A':  all M columns of U and all N rows of V**H are<br>
...
*>                  in the array A;<br>
*>          = 'N':  no columns of U or rows of V**H are computed.<br>
*> \endverbatim<br>
*><br>
*> \param[in] M<br>
*> \verbatim<br>
...
*> \param[out] U<br>
*> \verbatim<br>
*>          U is COMPLEX*16 array, dimension (LDU,UCOL)<br>
...
*>          LDU is INTEGER<br>
*>          The leading dimension of the array U.  LDU >= 1;<br>
*>          if JOBZ = 'S' or 'A' or JOBZ = 'O' and M < N, LDU >= M.<br>
*> \endverbatim<br>
*><br>
*> \param[out] VT<br>
*> \verbatim<br>
*>          VT is COMPLEX*16 array, dimension (LDVT,N)<br>
...
*>          If JOBZ = 'N', LWORK >= 2*mn + mx.<br>
*>          If JOBZ = 'O', LWORK >= 2*mn*mn + 2*mn + mx.<br>
*>          If JOBZ = 'S', LWORK >=   mn*mn + 3*mn.<br>
*>          If JOBZ = 'A', LWORK >=   mn*mn + 2*mn + mx.<br>
...
*>          RWORK is DOUBLE PRECISION array, dimension (MAX(1,LRWORK))<br>
*>          Let mx = max(M,N) and mn = min(M,N).<br>
*>          If JOBZ = 'N',    LRWORK >= 5*mn (LAPACK <= 3.6 needs 7*mn);<br>
*>          else if mx >> mn, LRWORK >= 5*mn*mn + 5*mn;<br>
*>          else              LRWORK >= max( 5*mn*mn + 5*mn,<br>
*>                                           2*mx*mn + 2*mn*mn + mn ).<br>
*> \endverbatim<br>
*><br>
*> \param[out] IWORK<br>
*> \verbatim<br>
...
*>          = 0:  successful exit.<br>
*>          < 0:  if INFO = -i, the i-th argument had an illegal value.<br>
*>          > 0:  The updating process of DBDSDC did not converge.<br>
*> \endverbatim<br>
*<br>
*  Authors:<br>
*  ========<br>
...
/**
*> \brief <b> ZGESV computes the solution to system of linear equations A * X = B for GE matrices</b> (simple driver)<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGESV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgesv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgesv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgesv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGESV( N, NRHS, A, LDA, IPIV, B, LDB, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> ZGESV computes the solution to a complex system of linear equations<br>
*>    A * X = B,<br>
...
/**
*> \brief <b> ZGESVD computes the singular value decomposition (SVD) for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGESVD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgesvd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgesvd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgesvd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGESVD( JOBU, JOBVT, M, N, A, LDA, S, U, LDU, VT, LDVT,<br>
*                          WORK, LWORK, RWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> ZGESVD computes the singular value decomposition (SVD) of a complex<br>
*> M-by-N matrix A, optionally computing the left and/or right singular<br>
...
*> U and V are the left and right singular vectors of A.<br>
*><br>
*> Note that the routine returns V**H, not V.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*>          V**H:<br>
*>          = 'A':  all N rows of V**H are returned in the array VT;<br>
*>          = 'S':  the first min(m,n) rows of V**H (the right singular<br>
*>                  vectors) are returned in the array VT;<br>
*>          = 'O':  the first min(m,n) rows of V**H (the right singular<br>
*>                  vectors) are overwritten on the array A;<br>
*>          = 'N':  no rows of V**H (no right singular vectors) are<br>
*>                  computed.<br>
*><br>
...
*>          If JOBU = 'A', U contains the M-by-M unitary matrix U;<br>
...
*> \verbatim<br>
*>          VT is COMPLEX*16 array, dimension (LDVT,N)<br>
*>          If JOBVT = 'A', VT contains the N-by-N unitary matrix<br>
*>          V**H;<br>
...
*> \verbatim<br>
*>          RWORK is DOUBLE PRECISION array, dimension (5*min(M,N))<br>
*>          On exit, if INFO > 0, RWORK(1:MIN(M,N)-1) contains the<br>
*>          unconverged superdiagonal elements of an upper bidiagonal<br>
*>          matrix B whose diagonal is in S (not necessarily sorted).<br>
*>          B satisfies A = U * B * VT, so it has the same singular<br>
*>          values as A, and singular vectors related by U and VT.<br>
*> \endverbatim<br>
*><br>
*> \param[out] INFO<br>
*> \verbatim<br>
...
*>          = 0:  successful exit.<br>
*>          < 0:  if INFO = -i, the i-th argument had an illegal value.<br>
*>          > 0:  if ZBDSQR did not converge, INFO specifies how many<br>
...
/**
*> \brief <b> ZGESVDX computes the singular value decomposition (SVD) for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGESVDX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgesvdx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgesvdx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgesvdx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*     SUBROUTINE CGESVDX( JOBU, JOBVT, RANGE, M, N, A, LDA, VL, VU, <br>
*    $                    IL, IU, NS, S, U, LDU, VT, LDVT, WORK, <br>
*    $                    LWORK, RWORK, IWORK, INFO )<br>
*      <br>
*<br>
*     .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*>  ZGESVDX computes the singular value decomposition (SVD) of a complex<br>
*>  M-by-N matrix A, optionally computing the left and/or right singular<br>
*>  vectors. The SVD is written<br>
*><br>
...
*>  U and V are the left and right singular vectors of A.<br>
*><br>
*>  ZGESVDX uses an eigenvalue problem for obtaining the SVD, which<br>
...
*> \verbatim<br>
*>          RWORK is DOUBLE PRECISION array, dimension (MAX(1,LRWORK))<br>
*>          LRWORK >= MIN(M,N)*(MIN(M,N)*2+15*MIN(M,N)).<br>
*> \endverbatim<br>
*><br>
*> \param[out] IWORK<br>
*> \verbatim<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGESVJ + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgesvj.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgesvj.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgesvj.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGESVJ( JOBA, JOBU, JOBV, M, N, A, LDA, SVA, MV, V,<br>
*                          LDV, CWORK, LWORK, RWORK, LRWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LDV, LWORK, LRWORK, M, MV, N<br>
*       CHARACTER*1        JOBA, JOBU, JOBV<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       COMPLEX*16         A( LDA, * ),  V( LDV, * ), CWORK( LWORK )<br>
*       DOUBLE PRECISION   RWORK( LRWORK ),  SVA( N )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> ZGESVJ computes the singular value decomposition (SVD) of a complex<br>
*> M-by-N matrix A, where M >= N. The SVD of A is written as<br>
*>                                    [++]   [xx]   [x0]   [xx]<br>
*>              A = U * SIGMA * V^*,  [++] = [xx] * [ox] * [xx]<br>
*>                                    [++]   [xx]<br>
*> where SIGMA is an N-by-N diagonal matrix, U is an M-by-N orthonormal<br>
*> matrix, and V is an N-by-N unitary matrix. The diagonal elements<br>
...
*>                 in the array RWORK as RANKA=NINT(RWORK(2)). Also see the<br>
*>                 descriptions of SVA and RWORK. The computed columns of U<br>
*>                 are mutually numerically orthogonal up to approximately<br>
*>                 TOL=SQRT(M)*EPS (default); or TOL=CTOL*EPS (JOBU.EQ.'C'),<br>
*>                 see the description of JOBU.<br>
*>                 If INFO .GT. 0,<br>
*>                 the procedure ZGESVJ did not converge in the given number<br>
...
*>                 || A - SCALE * U * SIGMA * V^* ||_2 / ||A||_2 is small.<br>
*>          If JOBU .EQ. 'N':<br>
*>                 If INFO .EQ. 0 :<br>
...
*>          On exit,<br>
*>          If INFO .EQ. 0 :<br>
*>          depending on the value SCALE = RWORK(1), we have:<br>
*>                 If SCALE .EQ. ONE:<br>
...
*><br>
*>          If INFO .GT. 0 :<br>
*>          the procedure ZGESVJ did not converge in the given number of<br>
...
*> \verbatim<br>
*>          MV is INTEGER<br>
*>          If JOBV .EQ. 'A', then the product of Jacobi rotations in ZGESVJ<br>
...
*> \endverbatim<br>
*><br>
*> \param[in,out] CWORK<br>
*> \verbatim<br>
*>          CWORK is COMPLEX*16 array, dimension M+N.<br>
*>          Used as work space.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LWORK<br>
*> \verbatim<br>
*>          LWORK is INTEGER.<br>
*>          Length of CWORK, LWORK >= M+N.<br>
*> \endverbatim<br>
*><br>
*> \param[in,out] RWORK<br>
*> \verbatim<br>
*>          RWORK is DOUBLE PRECISION array, dimension max(6,M+N).<br>
*>          On entry,<br>
*>          If JOBU .EQ. 'C' :<br>
*>          RWORK(1) = CTOL, where CTOL defines the threshold for convergence.<br>
...
*>                    below EPSILON.<br>
*>          On exit,<br>
*>          RWORK(1) = SCALE is the scaling factor such that SCALE*SVA(1:N)<br>
*>                    are the computed singular values of A.<br>
*>                    (See description of SVA().)<br>
*>          RWORK(2) = NINT(RWORK(2)) is the number of the computed nonzero<br>
*>                    singular values.<br>
*>          RWORK(3) = NINT(RWORK(3)) is the number of the computed singular<br>
*>                    values that are larger than the underflow threshold.<br>
*>          RWORK(4) = NINT(RWORK(4)) is the number of sweeps of Jacobi<br>
*>                    rotations needed for numerical convergence.<br>
*>          RWORK(5) = max_{i.NE.j} |COS(A(:,i),A(:,j))| in the last sweep.<br>
*>                    This is useful information in cases when ZGESVJ did<br>
*>                    not converge, as it can be used to estimate whether<br>
*>                    the output is stil useful and for post festum analysis.<br>
*>          RWORK(6) = the largest absolute value over all sines of the<br>
...
*> \verbatim<br>
*>          LRWORK is INTEGER<br>
*>         Length of RWORK, LRWORK >= MAX(6,N).<br>
*> \endverbatim<br>
*><br>
*> \param[out] INFO<br>
*> \verbatim<br>
...
*>          = 0 : successful exit.<br>
*>          < 0 : if INFO = -i, then the i-th argument had an illegal value<br>
*>          > 0 : ZGESVJ did not converge in the maximal allowed number <br>
*>                (NSWEEP=30) of sweeps. The output may still be useful. <br>
*>                See the description of RWORK.<br>
*> \endverbatim<br>
*><br>
*  Authors:<br>
*  ========<br>
...
*> rotations. In the case of underflow of the tangent of the Jacobi angle, a<br>
*> modified Jacobi transformation of Drmac [3] is used. Pivot strategy uses<br>
*> column interchanges of de Rijk [1]. The relative accuracy of the computed<br>
*> singular values and the accuracy of the computed singular vectors (in<br>
*> angle metric) is as guaranteed by the theory of Demmel and Veselic [2].<br>
...
*> Veselic [4,5], and it is the kernel routine in the SIGMA library [6].<br>
...
*  ================<br>
*><br>
*> [1] P. P. M. De Rijk: A one-sided Jacobi algorithm for computing the<br>
*>    singular value decomposition on a vector computer. <br>
*>    SIAM J. Sci. Stat. Comp., Vol. 10 (1998), pp. 359-371. <br>
*> [2] J. Demmel and K. Veselic: Jacobi method is more accurate than QR.<br>
*> [3] Z. Drmac: Implementation of Jacobi rotations for accurate singular<br>
*>    value computation in floating point arithmetic.<br>
*>    SIAM J. Sci. Comp., Vol. 18 (1997), pp. 1200-1222.<br>
*> [4] Z. Drmac and K. Veselic: New fast and accurate Jacobi SVD algorithm I.<br>
*>    SIAM J. Matrix Anal. Appl. Vol. 35, No. 2 (2008), pp. 1322-1342.<br>
*>    LAPACK Working note 169.<br>
*> [5] Z. Drmac and K. Veselic: New fast and accurate Jacobi SVD algorithm II.<br>
*>    SIAM J. Matrix Anal. Appl. Vol. 35, No. 2 (2008), pp. 1343-1362.<br>
*>    LAPACK Working note 170.<br>
*> [6] Z. Drmac: SIGMA - mathematical software library for accurate SVD, PSV,<br>
*>    QSVD, (H,K)-SVD computations.<br>
*>    Department of Mathematics, University of Zagreb, 2008, 2015.<br>
*> \endverbatim<br>
*<br>
*>  \par Bugs, examples and comments:<br>
*   =================================<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGESVX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgesvx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgesvx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgesvx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGESVX( FACT, TRANS, N, NRHS, A, LDA, AF, LDAF, IPIV,<br>
...
*> \verbatim<br>
*><br>
*> ZGESVX uses the LU factorization to compute the solution to a complex<br>
...
*>          A = P*L*U as computed by ZGETRF.  If EQUED .ne. 'N', then<br>
...
/**
*> \brief <b> ZGESVXX computes the solution to system of linear equations A * X = B for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGESVXX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgesvxx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgesvxx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgesvxx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGESVXX( FACT, TRANS, N, NRHS, A, LDA, AF, LDAF, IPIV,<br>
...
*> \verbatim<br>
*><br>
*>    ZGESVXX uses the LU factorization to compute the solution to a<br>
*>    complex*16 system of linear equations  A * X = B,  where A is an<br>
*>    N-by-N matrix and X and B are N-by-NRHS matrices.<br>
*><br>
*>    If requested, both normwise and maximum componentwise error bounds<br>
*>    are returned. ZGESVXX will return a solution with a tiny<br>
*>    guaranteed error (O(eps) where eps is the working machine<br>
*>    precision) unless the matrix is very ill-conditioned, in which<br>
*>    case a warning is returned. Relevant condition numbers also are<br>
*>    calculated and returned.<br>
*><br>
*>    ZGESVXX accepts user-provided factorizations and equilibration<br>
*>    factors; see the definitions of the FACT and EQUED options.<br>
*>    Solving with refinement and using a factorization from a previous<br>
*>    ZGESVXX call will also produce a solution with either O(eps)<br>
*>    errors or warnings, but we cannot make that claim for general<br>
*>    user-provided factorizations and equilibration factors if they<br>
*>    differ from what ZGESVXX would itself produce.<br>
*> \endverbatim<br>
*<br>
*> \par Description:<br>
*  =================<br>
...
*>     and error bounds could be unreliable. If factorization fails with<br>
*>     0<INFO<=N, then this contains the reciprocal pivot growth factor<br>
*>     for the leading INFO columns of A.  In ZGESVX, this quantity is<br>
*>     returned in WORK(1).<br>
*> \endverbatim<br>
*><br>
*> \param[out] BERR<br>
...
/**
*> \brief \b ZGETC2 computes the LU factorization with complete pivoting of the general n-by-n matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGETC2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgetc2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgetc2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgetc2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGETC2( N, A, LDA, IPIV, JPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGETC2 computes an LU factorization, using complete pivoting, of the<br>
...
*><br>
*> This is a level 1 BLAS version of the algorithm.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*>          INFO is INTEGER<br>
*>           = 0: successful exit<br>
*>           > 0: if INFO = k, U(k, k) is likely to produce overflow if<br>
*>                one tries to solve for x in Ax = b. So U is perturbed<br>
*>                to avoid the overflow.<br>
*> \endverbatim<br>
*<br>
*  Authors:<br>
*  ========<br>
...
/**
*> \brief \b ZGETF2 computes the LU factorization of a general m-by-n matrix using partial pivoting with row interchanges (unblocked algorithm).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGETF2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgetf2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgetf2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgetf2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGETF2( M, N, A, LDA, IPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGETF2 computes an LU factorization of a general m-by-n matrix A<br>
*> using partial pivoting with row interchanges.<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download ZGETRF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgetrf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgetrf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgetrf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGETRF( M, N, A, LDA, IPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGETRF computes an LU factorization of a general M-by-N matrix A<br>
*> using partial pivoting with row interchanges.<br>
*><br>
*> The factorization has the form<br>
*>    A = P * L * U<br>
...
*  ===========<br>
*<br>
*       RECURSIVE SUBROUTINE ZGETRF2( M, N, A, LDA, IPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGETRF2 computes an LU factorization of a general M-by-N matrix A<br>
*> using partial pivoting with row interchanges.<br>
*><br>
*> The factorization has the form<br>
*>    A = P * L * U<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGETRI + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgetri.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgetri.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgetri.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGETRI( N, A, LDA, IPIV, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> ZGETRI computes the inverse of a matrix using the LU factorization<br>
*> computed by ZGETRF.<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download ZGETRS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgetrs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgetrs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgetrs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGETRS( TRANS, N, NRHS, A, LDA, IPIV, B, LDB, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANS<br>
*       INTEGER            INFO, LDA, LDB, N, NRHS<br>
...
*> \verbatim<br>
*><br>
*> ZGETRS solves a system of linear equations<br>
*>    A * X = B,  A**T * X = B,  or  A**H * X = B<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGGBAK + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zggbak.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zggbak.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zggbak.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGGBAK( JOB, SIDE, N, ILO, IHI, LSCALE, RSCALE, M, V,<br>
*                          LDV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          JOB, SIDE<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   LSCALE( * ), RSCALE( * )<br>
*       COMPLEX*16         V( LDV, * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> ZGGBAK forms the right or left eigenvectors of a complex generalized<br>
...
*>          = 'B':  do backward transformations for both permutation and<br>
*>                  scaling.<br>
*>          JOB must be the same as the argument JOB supplied to ZGGBAL.<br>
*> \endverbatim<br>
*><br>
*> \param[in] SIDE<br>
*> \verbatim<br>
...
*> \verbatim<br>
*>          IHI is INTEGER<br>
*>          The integers ILO and IHI determined by ZGGBAL.<br>
*>          1 <= ILO <= IHI <= N, if N > 0; ILO=1 and IHI=0, if N=0.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LSCALE<br>
...
*>          to the left side of A and B, as returned by ZGGBAL.<br>
*> \endverbatim<br>
*><br>
*> \param[in] RSCALE<br>
*> \verbatim<br>
...
*>          Details of the permutations and/or scaling factors applied<br>
*>          to the right side of A and B, as returned by ZGGBAL.<br>
*> \endverbatim<br>
*><br>
*> \param[in] M<br>
*> \verbatim<br>
...
*>          V is COMPLEX*16 array, dimension (LDV,M)<br>
*>          On entry, the matrix of right or left eigenvectors to be<br>
*>          transformed, as returned by ZTGEVC.<br>
*>          On exit, V is overwritten by the transformed eigenvectors.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDV<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGGBAL + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zggbal.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zggbal.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zggbal.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGGBAL( JOB, N, A, LDA, B, LDB, ILO, IHI, LSCALE,<br>
*                          RSCALE, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          JOB<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   LSCALE( * ), RSCALE( * ), WORK( * )<br>
*       COMPLEX*16         A( LDA, * ), B( LDB, * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> ZGGBAL balances a pair of general complex matrices (A,B).  This<br>
...
*>          row interchanged with row j, and D(j) is the scaling factor<br>
*>          applied to row j, then<br>
...
*>          column interchanged with column j, and D(j) is the scaling<br>
*>          factor applied to column j, then<br>
*>            RSCALE(j) = P(j)    for J = 1,...,ILO-1<br>
*>                      = D(j)    for J = ILO,...,IHI<br>
*>                      = P(j)    for J = IHI+1,...,N.<br>
*>          The order in which the interchanges are made is N to IHI+1,<br>
*>          then 1 to ILO-1.<br>
...
/**
*> \brief <b> ZGGES computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGGES + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgges.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgges.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgges.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGGES( JOBVSL, JOBVSR, SORT, SELCTG, N, A, LDA, B, LDB,<br>
*                         SDIM, ALPHA, BETA, VSL, LDVSL, VSR, LDVSR, WORK,<br>
*                         LWORK, RWORK, BWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> ZGGES computes for a pair of N-by-N complex nonsymmetric matrices<br>
*> (A,B), the generalized eigenvalues, the generalized complex Schur<br>
*> form (S, T), and optionally left and/or right Schur vectors (VSL<br>
*> and VSR). This gives the generalized Schur factorization<br>
*><br>
*>         (A,B) = ( (VSL)*S*(VSR)**H, (VSL)*T*(VSR)**H )<br>
*><br>
*> where (VSR)**H is the conjugate-transpose of VSR.<br>
*><br>
...
*> triangular matrix S and the upper triangular matrix T. The leading<br>
*> columns of VSL and VSR then form an unitary basis for the<br>
...
*> ZGGEV instead, which is faster.)<br>
*><br>
...
*> reasonable interpretation for beta=0, and even for both being zero.<br>
*><br>
*> A pair of matrices (S,T) is in generalized complex Schur form if S<br>
*> and T are upper triangular and, in addition, the diagonal elements<br>
*> of T are non-negative real numbers.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*> \param[in] SELCTG<br>
*> \verbatim<br>
*>          SELCTG is a LOGICAL FUNCTION of two COMPLEX*16 arguments<br>
...
*>          to the top left of the Schur form.<br>
*>          An eigenvalue ALPHA(j)/BETA(j) is selected if<br>
*>          SELCTG(ALPHA(j),BETA(j)) is true.<br>
*><br>
...
*>          generalized eigenvalues.  ALPHA(j), j=1,...,N  and  BETA(j),<br>
*>          j=1,...,N  are the diagonals of the complex Schur form (A,B)<br>
*>          output by ZGGES. The  BETA(j) will be non-negative real.<br>
*><br>
*>          Note: the quotients ALPHA(j)/BETA(j) may easily over- or<br>
...
*>          comparable with norm(A) in magnitude, and BETA always less<br>
*>          than and usually comparable with norm(B).<br>
*> \endverbatim<br>
*><br>
*> \param[out] VSL<br>
*> \verbatim<br>
*>          VSL is COMPLEX*16 array, dimension (LDVSL,N)<br>
...
*> \param[out] VSR<br>
*> \verbatim<br>
*>          VSR is COMPLEX*16 array, dimension (LDVSR,N)<br>
...
*> \param[out] RWORK<br>
*> \verbatim<br>
*>          RWORK is DOUBLE PRECISION array, dimension (8*N)<br>
*> \endverbatim<br>
*><br>
*> \param[out] BWORK<br>
*> \verbatim<br>
...
/**
*> \brief <b> ZGGES3 computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices (blocked algorithm)</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGGES3 + dependencies<br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgges3.f"><br>
*> [TGZ]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgges3.f"><br>
*> [ZIP]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgges3.f"><br>
*> [TXT]</a><br>
*> \endhtmlonly<br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGGES3( JOBVSL, JOBVSR, SORT, SELCTG, N, A, LDA, B,<br>
*      $                   LDB, SDIM, ALPHA, BETA, VSL, LDVSL, VSR, LDVSR,<br>
...
*> \verbatim<br>
*><br>
*> ZGGES3 computes for a pair of N-by-N complex nonsymmetric matrices<br>
*> (A,B), the generalized eigenvalues, the generalized complex Schur<br>
*> form (S, T), and optionally left and/or right Schur vectors (VSL<br>
*> and VSR). This gives the generalized Schur factorization<br>
*><br>
...
*>          generalized eigenvalues.  ALPHA(j), j=1,...,N  and  BETA(j),<br>
*>          j=1,...,N  are the diagonals of the complex Schur form (A,B)<br>
*>          output by ZGGES3. The  BETA(j) will be non-negative real.<br>
*><br>
*>          Note: the quotients ALPHA(j)/BETA(j) may easily over- or<br>
*>          underflow, and BETA(j) may even be zero.  Thus, the user<br>
*>          should avoid naively computing the ratio alpha/beta.<br>
...
/**
*> \brief <b> ZGGESX computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGGESX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zggesx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zggesx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zggesx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGGESX( JOBVSL, JOBVSR, SORT, SELCTG, SENSE, N, A, LDA,<br>
*                          B, LDB, SDIM, ALPHA, BETA, VSL, LDVSL, VSR,<br>
*                          LDVSR, RCONDE, RCONDV, WORK, LWORK, RWORK,<br>
...
*       LOGICAL            BWORK( * )<br>
*       INTEGER            IWORK( * )<br>
*       DOUBLE PRECISION   RCONDE( 2 ), RCONDV( 2 ), RWORK( * )<br>
*       COMPLEX*16         A( LDA, * ), ALPHA( * ), B( LDB, * ),<br>
*      $                   BETA( * ), VSL( LDVSL, * ), VSR( LDVSR, * ),<br>
*      $                   WORK( * )<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGGESX computes for a pair of N-by-N complex nonsymmetric matrices<br>
*> (A,B), the generalized eigenvalues, the complex Schur form (S,T),<br>
*> and, optionally, the left and/or right matrices of Schur vectors (VSL<br>
*> and VSR).  This gives the generalized Schur factorization<br>
*><br>
*>      (A,B) = ( (VSL) S (VSR)**H, (VSL) T (VSR)**H )<br>
*><br>
...
*> Optionally, it also orders the eigenvalues so that a selected cluster<br>
*> of eigenvalues appears in the leading diagonal blocks of the upper<br>
*> triangular matrix S and the upper triangular matrix T; computes<br>
...
*><br>
*> A pair of matrices (S,T) is in generalized complex Schur form if T is<br>
*> upper triangular with non-negative diagonal and S is upper<br>
*> triangular.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*> \param[in] SELCTG<br>
*> \verbatim<br>
*>          SELCTG is procedure) LOGICAL FUNCTION of two COMPLEX*16 arguments<br>
*>          SELCTG must be declared EXTERNAL in the calling subroutine.<br>
*>          If SORT = 'N', SELCTG is not referenced.<br>
*>          If SORT = 'S', SELCTG is used to select eigenvalues to sort<br>
*>          to the top left of the Schur form.<br>
...
*>          ordering may change the value of complex eigenvalues<br>
*>          (especially if the eigenvalue is ill-conditioned), in this<br>
*>          case INFO is set to N+3 see INFO below).<br>
*> \endverbatim<br>
*><br>
*> \param[in] SENSE<br>
*> \verbatim<br>
...
*>          BETA is COMPLEX*16 array, dimension (N)<br>
*>          On exit, ALPHA(j)/BETA(j), j=1,...,N, will be the<br>
*>          generalized eigenvalues.  ALPHA(j) and BETA(j),j=1,...,N  are<br>
*>          the diagonals of the complex Schur form (S,T).  BETA(j) will<br>
*>          be non-negative real.<br>
*><br>
*>          Note: the quotients ALPHA(j)/BETA(j) may easily over- or<br>
*>          underflow, and BETA(j) may even be zero.  Thus, the user<br>
*>          should avoid naively computing the ratio alpha/beta.<br>
...
*>          LWORK >= MAX(1,2*N).  Note that 2*SDIM*(N-SDIM) <= N*N/2.<br>
*>          Note also that an error is only returned if<br>
*>          LWORK < MAX(1,2*N), but if SENSE = 'E' or 'V' or 'B' this may<br>
*>          not be large enough.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
...
/**
*> \brief <b> ZGGEV computes the eigenvalues and, optionally, the left and/or right eigenvectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGGEV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zggev.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zggev.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zggev.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGGEV( JOBVL, JOBVR, N, A, LDA, B, LDB, ALPHA, BETA,<br>
*                         VL, LDVL, VR, LDVR, WORK, LWORK, RWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          JOBVL, JOBVR<br>
...
*> \verbatim<br>
*><br>
*> ZGGEV computes for a pair of N-by-N complex nonsymmetric matrices<br>
*> (A,B), the generalized eigenvalues, and optionally, the left and/or<br>
*> right generalized eigenvectors.<br>
*><br>
...
*> being zero.<br>
*><br>
*> The right generalized eigenvector v(j) corresponding to the<br>
*> generalized eigenvalue lambda(j) of (A,B) satisfies<br>
*><br>
*>              A * v(j) = lambda(j) * B * v(j).<br>
*><br>
*> The left generalized eigenvector u(j) corresponding to the<br>
*> generalized eigenvalues lambda(j) of (A,B) satisfies<br>
*><br>
...
*> \verbatim<br>
*>          VL is COMPLEX*16 array, dimension (LDVL,N)<br>
*>          If JOBVL = 'V', the left generalized eigenvectors u(j) are<br>
*>          stored one after another in the columns of VL, in the same<br>
*>          order as their eigenvalues.<br>
...
*> \verbatim<br>
*>          VR is COMPLEX*16 array, dimension (LDVR,N)<br>
*>          If JOBVR = 'V', the right generalized eigenvectors v(j) are<br>
*>          stored one after another in the columns of VR, in the same<br>
*>          order as their eigenvalues.<br>
*>          Each eigenvector is scaled so the largest component has<br>
*>          abs(real part) + abs(imag. part) = 1.<br>
...
*>                calculated, but ALPHA(j) and BETA(j) should be<br>
*>                correct for j=INFO+1,...,N.<br>
*>          > N:  =N+1: other then QZ iteration failed in DHGEQZ,<br>
...
/**
*> \brief <b> ZGGEV3 computes the eigenvalues and, optionally, the left and/or right eigenvectors for GE matrices (blocked algorithm)</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGGEV3 + dependencies<br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zggev3.f"><br>
*> [TGZ]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zggev3.f"><br>
*> [ZIP]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zggev3.f"><br>
*> [TXT]</a><br>
*> \endhtmlonly<br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGGEV3( JOBVL, JOBVR, N, A, LDA, B, LDB, ALPHA, BETA,<br>
*                          VL, LDVL, VR, LDVR, WORK, LWORK, RWORK, INFO )<br>
*<br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          JOBVL, JOBVR<br>
...
*> \verbatim<br>
*><br>
*> ZGGEV3 computes for a pair of N-by-N complex nonsymmetric matrices<br>
*> (A,B), the generalized eigenvalues, and optionally, the left and/or<br>
*> right generalized eigenvectors.<br>
*><br>
*> A generalized eigenvalue for a pair of matrices (A,B) is a scalar<br>
...
/**
*> \brief <b> ZGGEVX computes the eigenvalues and, optionally, the left and/or right eigenvectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGGEVX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zggevx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zggevx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zggevx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGGEVX( BALANC, JOBVL, JOBVR, SENSE, N, A, LDA, B, LDB,<br>
*                          ALPHA, BETA, VL, LDVL, VR, LDVR, ILO, IHI,<br>
*                          LSCALE, RSCALE, ABNRM, BBNRM, RCONDE, RCONDV,<br>
*                          WORK, LWORK, RWORK, IWORK, BWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          BALANC, JOBVL, JOBVR, SENSE<br>
...
*       LOGICAL            BWORK( * )<br>
*       INTEGER            IWORK( * )<br>
*       DOUBLE PRECISION   LSCALE( * ), RCONDE( * ), RCONDV( * ),<br>
*      $                   RSCALE( * ), RWORK( * )<br>
*       COMPLEX*16         A( LDA, * ), ALPHA( * ), B( LDB, * ),<br>
*      $                   BETA( * ), VL( LDVL, * ), VR( LDVR, * ),<br>
*      $                   WORK( * )<br>
...
*> \verbatim<br>
*><br>
*> ZGGEVX computes for a pair of N-by-N complex nonsymmetric matrices<br>
*> (A,B) the generalized eigenvalues, and optionally, the left and/or<br>
*> right generalized eigenvectors.<br>
*><br>
*> Optionally, it also computes a balancing transformation to improve<br>
*> the conditioning of the eigenvalues and eigenvectors (ILO, IHI,<br>
...
*>          or both, then A contains the first part of the complex Schur<br>
...
*>          or both, then B contains the second part of the complex<br>
*>          Schur form of the "balanced" versions of the input A and B.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDB<br>
*> \verbatim<br>
...
*> \verbatim<br>
*>          BETA is COMPLEX*16 array, dimension (N)<br>
*>          On exit, ALPHA(j)/BETA(j), j=1,...,N, will be the generalized<br>
*>          eigenvalues.<br>
*><br>
*>          Note: the quotient ALPHA(j)/BETA(j) ) may easily over- or<br>
*>          underflow, and BETA(j) may even be zero.  Thus, the user<br>
*>          should avoid naively computing the ratio ALPHA/BETA.<br>
*>          However, ALPHA will be always less than and usually<br>
*>          comparable with norm(A) in magnitude, and BETA always less<br>
...
*>          stored one after another in the columns of VL, in the same<br>
*>          order as their eigenvalues.<br>
*>          Each eigenvector will be scaled so the largest component<br>
*>          will have abs(real part) + abs(imag. part) = 1.<br>
*>          Not referenced if JOBVL = 'N'.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDVL<br>
...
*>          of the array. If the eigenvalues cannot be reordered to<br>
*>          compute RCONDV(j), RCONDV(j) is set to 0; this can only occur<br>
*>          when the true value would be very small anyway.<br>
...
*>          LWORK is INTEGER<br>
*>          The dimension of the array WORK. LWORK >= max(1,2*N).<br>
*>          If SENSE = 'E', LWORK >= max(1,4*N).<br>
*>          If SENSE = 'V' or 'B', LWORK >= max(1,2*N*N+2*N).<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates the optimal size of the WORK array, returns<br>
*>          this value as the first entry of the WORK array, and no error<br>
...
*>          lrwork must be at least max(1,6*N) if BALANC = 'S' or 'B',<br>
*>          and at least max(1,2*N) otherwise.<br>
*>          Real workspace.<br>
*> \endverbatim<br>
*><br>
*> \param[out] IWORK<br>
...
*>          = 1,...,N:<br>
*>                The QZ iteration failed.  No eigenvectors have been<br>
*>                calculated, but ALPHA(j) and BETA(j) should be correct<br>
*>                for j=INFO+1,...,N.<br>
*>          > N:  =N+1: other than QZ iteration failed in ZHGEQZ.<br>
*>                =N+2: error return from ZTGEVC.<br>
*> \endverbatim<br>
*<br>
*  Authors:<br>
*  ========<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGGGLM + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zggglm.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zggglm.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zggglm.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGGGLM( N, M, P, A, LDA, B, LDB, D, X, Y, WORK, LWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       COMPLEX*16         A( LDA, * ), B( LDB, * ), D( * ), WORK( * ),<br>
*      $                   X( * ), Y( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> ZGGGLM solves a general Gauss-Markov linear model (GLM) problem:<br>
*><br>
...
*> \param[in,out] B<br>
*> \verbatim<br>
*>          B is COMPLEX*16 array, dimension (LDB,P)<br>
...
*> \param[out] X<br>
*> \verbatim<br>
*>          X is COMPLEX*16 array, dimension (M)<br>
*> \endverbatim<br>
*><br>
*> \param[out] Y<br>
*> \verbatim<br>
*>          Y is COMPLEX*16 array, dimension (P)<br>
*><br>
...
*>          ZGEQRF, ZGERQF, ZUNMQR and ZUNMRQ.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates the optimal size of the WORK array, returns<br>
*>          this value as the first entry of the WORK array, and no error<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGGHD3 + dependencies<br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgghd3.f"><br>
*> [TGZ]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgghd3.f"><br>
*> [ZIP]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgghd3.f"><br>
*> [TXT]</a><br>
*> \endhtmlonly<br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGGHD3( COMPQ, COMPZ, N, ILO, IHI, A, LDA, B, LDB, Q,<br>
...
*> \verbatim<br>
*><br>
*> ZGGHD3 reduces a pair of complex matrices (A,B) to generalized upper<br>
*> Hessenberg form using unitary transformations, where A is a<br>
...
*> factorization and moving the unitary matrix Q to the left side<br>
*> of the equation.<br>
*><br>
...
*> where y = Z**H*x.<br>
*><br>
*> The unitary matrices Q and Z are determined as products of Givens<br>
*> rotations.  They may either be formed explicitly, or they may be<br>
*> postmultiplied into input matrices Q1 and Z1, so that<br>
*>      Q1 * A * Z1**H = (Q1*Q) * H * (Z1*Z)**H<br>
*>      Q1 * B * Z1**H = (Q1*Q) * T * (Z1*Z)**H<br>
*> If Q1 is the unitary matrix from the QR factorization of B in the<br>
*> original equation A*x = lambda*B*x, then ZGGHD3 reduces the original<br>
*> problem to generalized Hessenberg form.<br>
*><br>
*> This is a blocked variant of CGGHRD, using matrix-matrix<br>
...
*>          = 'V': Q must contain a unitary matrix Q1 on entry,<br>
...
*>                 unitary matrix Z is returned;<br>
*>          = 'V': Z must contain a unitary matrix Z1 on entry,<br>
...
*>          normally set by a previous call to ZGGBAL; otherwise they<br>
...
*>          On exit, the upper triangular matrix T = Q**H B Z.  The<br>
...
*>          On entry, if COMPQ = 'V', the unitary matrix Q1, typically<br>
*>          from the QR factorization of B.<br>
*>          On exit, if COMPQ='I', the unitary matrix Q, and if<br>
...
*>          On entry, if COMPZ = 'V', the unitary matrix Z1.<br>
*>          On exit, if COMPZ='I', the unitary matrix Z, and if<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGGHRD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgghrd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgghrd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgghrd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGGHRD( COMPQ, COMPZ, N, ILO, IHI, A, LDA, B, LDB, Q,<br>
*                          LDQ, Z, LDZ, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          COMPQ, COMPZ<br>
...
*> \verbatim<br>
*><br>
*> ZGGHRD reduces a pair of complex matrices (A,B) to generalized upper<br>
*> Hessenberg form using unitary transformations, where A is a<br>
*> general matrix and B is upper triangular.  The form of the<br>
*> generalized eigenvalue problem is<br>
*>    A*x = lambda*B*x,<br>
...
*>      Q1 * B * Z1**H = (Q1*Q) * T * (Z1*Z)**H<br>
*> If Q1 is the unitary matrix from the QR factorization of B in the<br>
*> original equation A*x = lambda*B*x, then ZGGHRD reduces the original<br>
*> problem to generalized Hessenberg form.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
/**
*> \brief <b> ZGGLSE solves overdetermined or underdetermined systems for OTHER matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGGLSE + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgglse.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgglse.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgglse.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGGLSE( M, N, P, A, LDA, B, LDB, C, D, X, WORK, LWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LDB, LWORK, M, N, P<br>
...
*> \verbatim<br>
*><br>
*> ZGGLSE solves the linear equality-constrained least squares (LSE)<br>
*> problem:<br>
*><br>
...
*> \param[in,out] C<br>
*> \verbatim<br>
*>          C is COMPLEX*16 array, dimension (M)<br>
...
*> \param[in,out] D<br>
*> \verbatim<br>
*>          D is COMPLEX*16 array, dimension (P)<br>
...
*>          where NB is an upper bound for the optimal blocksizes for<br>
*>          ZGEQRF, CGERQF, ZUNMQR and CUNMRQ.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates the optimal size of the WORK array, returns<br>
*>          this value as the first entry of the WORK array, and no error<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGGQRF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zggqrf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zggqrf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zggqrf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGGQRF( N, M, P, A, LDA, TAUA, B, LDB, TAUB, WORK,<br>
*                          LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LDB, LWORK, M, N, P<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       COMPLEX*16         A( LDA, * ), B( LDB, * ), TAUA( * ), TAUB( * ),<br>
*      $                   WORK( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> ZGGQRF computes a generalized QR factorization of an N-by-M matrix A<br>
*> and an N-by-P matrix B:<br>
*><br>
*>             A = Q*R,        B = Q*T*Z,<br>
*><br>
*> where Q is an N-by-N unitary matrix, Z is a P-by-P unitary matrix,<br>
*> and R and T assume one of the forms:<br>
*><br>
...
*><br>
*>              inv(B)*A = Z**H * (inv(T)*R)<br>
*><br>
*> where inv(B) denotes the inverse of the matrix B, and Z**H denotes the<br>
*> conjugate transpose of matrix Z.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*>          with the array TAUA, represent the unitary matrix Q as a<br>
...
*> \param[out] TAUA<br>
*> \verbatim<br>
*>          TAUA is COMPLEX*16 array, dimension (min(N,M))<br>
*>          The scalar factors of the elementary reflectors which<br>
*>          represent the unitary matrix Q (see Further Details).<br>
*> \endverbatim<br>
*><br>
...
*> \param[out] TAUB<br>
*> \verbatim<br>
*>          TAUB is COMPLEX*16 array, dimension (min(N,P))<br>
*>          The scalar factors of the elementary reflectors which<br>
...
*>          blocksize for a call of ZUNMQR.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates the optimal size of the WORK array, returns<br>
*>          this value as the first entry of the WORK array, and no error<br>
...
*>     H(i) = I - taua * v * v**H<br>
*><br>
*>  where taua is a complex scalar, and v is a complex vector with<br>
...
*>  To use Q to update another matrix, use LAPACK subroutine ZUNMQR.<br>
*><br>
...
*>     H(i) = I - taub * v * v**H<br>
*><br>
*>  where taub is a complex scalar, and v is a complex vector with<br>
...
*>  To use Z to update another matrix, use LAPACK subroutine ZUNMRQ.<br>
*> \endverbatim<br>
*><br>
*  =====================================================================<br>
*/
...
*<br>
*> \htmlonly<br>
*> Download ZGGRQF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zggrqf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zggrqf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zggrqf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGGRQF( M, P, N, A, LDA, TAUA, B, LDB, TAUB, WORK,<br>
*                          LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LDB, LWORK, M, N, P<br>
...
*> \verbatim<br>
*><br>
*> ZGGRQF computes a generalized RQ factorization of an M-by-N matrix A<br>
*> and a P-by-N matrix B:<br>
*><br>
*>             A = R*Q,        B = Z*T*Q,<br>
*><br>
*> where Q is an N-by-N unitary matrix, Z is a P-by-P unitary<br>
...
*> \param[out] TAUA<br>
*> \verbatim<br>
*>          TAUA is COMPLEX*16 array, dimension (min(M,N))<br>
*>          The scalar factors of the elementary reflectors which<br>
*>          represent the unitary matrix Q (see Further Details).<br>
*> \endverbatim<br>
*><br>
...
*> \param[out] TAUB<br>
*> \verbatim<br>
*>          TAUB is COMPLEX*16 array, dimension (min(P,N))<br>
*>          The scalar factors of the elementary reflectors which<br>
*>          represent the unitary matrix Z (see Further Details).<br>
*> \endverbatim<br>
*><br>
...
*>          blocksize for a call of ZUNMRQ.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates the optimal size of the WORK array, returns<br>
*>          this value as the first entry of the WORK array, and no error<br>
...
/**
*> \brief <b> ZGGSVD3 computes the singular value decomposition (SVD) for OTHER matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGGSVD3 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zggsvd3.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zggsvd3.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zggsvd3.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGGSVD3( JOBU, JOBV, JOBQ, M, N, P, K, L, A, LDA, B,<br>
...
*       .. Array Arguments ..<br>
*       INTEGER            IWORK( * )<br>
*       DOUBLE PRECISION   ALPHA( * ), BETA( * ), RWORK( * )<br>
*       COMPLEX*16         A( LDA, * ), B( LDB, * ), Q( LDQ, * ),<br>
*      $                   U( LDU, * ), V( LDV, * ), WORK( * )<br>
*       ..<br>
*  <br>
...
*> \verbatim<br>
*><br>
*> ZGGSVD3 computes the generalized singular value decomposition (GSVD)<br>
*> of an M-by-N complex matrix A and P-by-N complex matrix B:<br>
*><br>
*>       U**H*A*Q = D1*( 0 R ),    V**H*B*Q = D2*( 0 R )<br>
*><br>
*> where U, V and Q are unitary matrices.<br>
*> Let K+L = the effective numerical rank of the<br>
*> matrix (A**H,B**H)**H, then R is a (K+L)-by-(K+L) nonsingular upper<br>
*> triangular matrix, D1 and D2 are M-by-(K+L) and P-by-(K+L) "diagonal"<br>
*> matrices and of the following structures, respectively:<br>
*><br>
*> If M-K-L >= 0,<br>
*><br>
*>                     K  L<br>
...
*><br>
*> The routine computes C, S, R, and optionally the unitary<br>
...
*>                      A*inv(B) = U*(D1*inv(D2))*V**H.<br>
*> If ( A**H,B**H)**H has orthonormal columns, then the GSVD of A and B is also<br>
*> equal to the CS decomposition of A and B. Furthermore, the GSVD can<br>
*> be used to derive the solution of the eigenvalue problem:<br>
*>                      A**H*A x = lambda* B**H*B x.<br>
*> In some literature, the GSVD of A and B is presented in the form<br>
*>                  U**H*A*X = ( 0 D1 ),   V**H*B*X = ( 0 D2 )<br>
*> where U and V are orthogonal and X is nonsingular, and D1 and D2 are<br>
...
*> \verbatim<br>
*>          JOBU is CHARACTER*1<br>
*>          = 'U':  Unitary matrix U is computed;<br>
*>          = 'N':  U is not computed.<br>
*> \endverbatim<br>
*><br>
*> \param[in] JOBV<br>
*> \verbatim<br>
*>          JOBV is CHARACTER*1<br>
*>          = 'V':  Unitary matrix V is computed;<br>
*>          = 'N':  V is not computed.<br>
*> \endverbatim<br>
*><br>
*> \param[in] JOBQ<br>
...
*>          = 'Q':  Unitary matrix Q is computed;<br>
...
*>          K + L = effective numerical rank of (A**H,B**H)**H.<br>
*> \endverbatim<br>
*><br>
*> \param[in,out] A<br>
*> \verbatim<br>
...
*>          B is COMPLEX*16 array, dimension (LDB,N)<br>
*>          On entry, the P-by-N matrix B.<br>
*>          On exit, B contains part of the triangular matrix R if<br>
*>          M-K-L < 0.  See Purpose for details.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDB<br>
*> \verbatim<br>
...
*>          If JOBU = 'U', U contains the M-by-M unitary matrix U.<br>
...
*>          If JOBV = 'V', V contains the P-by-P unitary matrix V.<br>
...
*> \verbatim<br>
*>          Q is COMPLEX*16 array, dimension (LDQ,N)<br>
*>          If JOBQ = 'Q', Q contains the N-by-N unitary matrix Q.<br>
...
*>                converge.  For further details, see subroutine ZTGSJA.<br>
*> \endverbatim<br>
*<br>
*> \par Internal Parameters:<br>
*  =========================<br>
...
*>          rank of (A**H,B**H)**H. Generally, they are set to<br>
...
*  =====================<br>
*><br>
*>  ZGGSVD3 replaces the deprecated subroutine ZGGSVD.<br>
*><br>
*  =====================================================================<br>
*/
...
*<br>
*> \htmlonly<br>
*> Download ZGGSVP3 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zggsvp3.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zggsvp3.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zggsvp3.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGGSVP3( JOBU, JOBV, JOBQ, M, P, N, A, LDA, B, LDB,<br>
*                           TOLA, TOLB, K, L, U, LDU, V, LDV, Q, LDQ,<br>
*                           IWORK, RWORK, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          JOBQ, JOBU, JOBV<br>
*       INTEGER            INFO, K, L, LDA, LDB, LDQ, LDU, LDV, M, N, P, LWORK<br>
...
*> \verbatim<br>
*><br>
*> ZGGSVP3 computes unitary matrices U, V and Q such that<br>
*><br>
*>                    N-K-L  K    L<br>
*>  U**H*A*Q =     K ( 0    A12  A13 )  if M-K-L >= 0;<br>
*>                 L ( 0     0   A23 )<br>
*>             M-K-L ( 0     0    0  )<br>
*><br>
*>                  N-K-L  K    L<br>
...
*> numerical rank of the (M+P)-by-N matrix (A**H,B**H)**H. <br>
*><br>
...
*> \verbatim<br>
*>          U is COMPLEX*16 array, dimension (LDU,M)<br>
*>          If JOBU = 'U', U contains the unitary matrix U.<br>
*>          If JOBU = 'N', U is not referenced.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDU<br>
...
*> \verbatim<br>
*>          V is COMPLEX*16 array, dimension (LDV,P)<br>
*>          If JOBV = 'V', V contains the unitary matrix V.<br>
*>          If JOBV = 'N', V is not referenced.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDV<br>
...
*> \verbatim<br>
*>          Q is COMPLEX*16 array, dimension (LDQ,N)<br>
*>          If JOBQ = 'Q', Q contains the unitary matrix Q.<br>
*>          If JOBQ = 'N', Q is not referenced.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDQ<br>
...
*> \param[out] TAU<br>
*> \verbatim<br>
*>          TAU is COMPLEX*16 array, dimension (N)<br>
*> \endverbatim<br>
*><br>
*> \param[out] WORK<br>
*> \verbatim<br>
...
*> \verbatim<br>
*><br>
*>  The subroutine uses LAPACK subroutine ZGEQP3 for the QR factorization<br>
...
*><br>
*>  ZGGSVP3 replaces the deprecated subroutine ZGGSVP.<br>
*><br>
*> \endverbatim<br>
*><br>
* =====================================================================<br>
...
/**
*> \brief \b ZGSVJ0 pre-processor for the routine zgesvj.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGSVJ0 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgsvj0.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgsvj0.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgsvj0.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGSVJ0( JOBV, M, N, A, LDA, D, SVA, MV, V, LDV, EPS,<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       COMPLEX*16         A( LDA, * ), D( N ), V( LDV, * ), WORK( LWORK )<br>
*       DOUBLE PRECISION   SVA( N )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> ZGSVJ0 is called from ZGESVJ as a pre-processor and that is its main<br>
*> purpose. It applies Jacobi rotations in the same way as ZGESVJ does, but<br>
...
*>          the input matrix.<br>
*>          On exit,<br>
*>          A_onexit * diag(D_onexit) represents the input matrix A*diag(D)<br>
...
*> \verbatim<br>
*>          D is COMPLEX*16 array, dimension (N)<br>
*>          The array D accumulates the scaling factors from the complex scaled<br>
*>          Jacobi rotations.<br>
...
*>          the matrix A_onexit*diag(D_onexit).<br>
*><br>
*> \param[in] MV<br>
*> \verbatim<br>
*>          MV is INTEGER<br>
...
*>          applied only if ABS(COS(angle(A(:,p),A(:,q)))) .GT. TOL.<br>
*> \endverbatim<br>
*><br>
*> \param[in] NSWEEP<br>
*> \verbatim<br>
...
*  =====================<br>
*><br>
*> ZGSVJ0 is used just to enable ZGESVJ to call a simplified version of<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGSVJ1 + dependencies <br>
...
*  ===========<br>
*<br>
*       SUBROUTINE ZGSVJ1( JOBV, M, N, N1, A, LDA, D, SVA, MV, V, LDV,<br>
...
*> \verbatim<br>
*><br>
*> ZGSVJ1 is called from ZGESVJ as a pre-processor and that is its main<br>
*> purpose. It applies Jacobi rotations in the same way as ZGESVJ does, but<br>
...
*> Further Details<br>
*> ~~~~~~~~~~~~~~~<br>
*> ZGSVJ1 applies few sweeps of Jacobi rotations in the column space of<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGTCON + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgtcon.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgtcon.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgtcon.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGTCON( NORM, N, DL, D, DU, DU2, IPIV, ANORM, RCOND,<br>
*                          WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          NORM<br>
...
*       .. Array Arguments ..<br>
*       INTEGER            IPIV( * )<br>
*       COMPLEX*16         D( * ), DL( * ), DU( * ), DU2( * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> ZGTCON estimates the reciprocal of the condition number of a complex<br>
...
*>          LU factorization of A as computed by ZGTTRF.<br>
*> \endverbatim<br>
*><br>
*> \param[in] D<br>
*> \verbatim<br>
...
*> \param[in] DU2<br>
*> \verbatim<br>
*>          DU2 is COMPLEX*16 array, dimension (N-2)<br>
...
*> \date September 2012<br>
*<br>
*> \ingroup complex16GTcomputational<br>
*<br>
*  =====================================================================<br>
*/
...
*<br>
*> \htmlonly<br>
*> Download ZGTRFS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgtrfs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgtrfs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgtrfs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGTRFS( TRANS, N, NRHS, DL, D, DU, DLF, DF, DUF, DU2,<br>
*                          IPIV, B, LDB, X, LDX, FERR, BERR, WORK, RWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> ZGTRFS improves the computed solution to a system of linear<br>
...
*> \param[in] DLF<br>
*> \verbatim<br>
*>          DLF is COMPLEX*16 array, dimension (N-1)<br>
*>          The (n-1) multipliers that define the matrix L from the<br>
*>          LU factorization of A as computed by ZGTTRF.<br>
*> \endverbatim<br>
*><br>
*> \param[in] DF<br>
*> \verbatim<br>
*>          DF is COMPLEX*16 array, dimension (N)<br>
*>          The n diagonal elements of the upper triangular matrix U from<br>
*>          the LU factorization of A.<br>
*> \endverbatim<br>
*><br>
*> \param[in] DUF<br>
*> \verbatim<br>
*>          DUF is COMPLEX*16 array, dimension (N-1)<br>
*>          The (n-1) elements of the first superdiagonal of U.<br>
*> \endverbatim<br>
*><br>
*> \param[in] DU2<br>
...
*> \verbatim<br>
*>          X is COMPLEX*16 array, dimension (LDX,NRHS)<br>
*>          On entry, the solution matrix X, as computed by ZGTTRS.<br>
*>          On exit, the improved solution matrix X.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDX<br>
...
/**
*> \brief <b> ZGTSV computes the solution to system of linear equations A * X = B for GT matrices <b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGTSV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgtsv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgtsv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgtsv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGTSV( N, NRHS, DL, D, DU, B, LDB, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*>          DL is COMPLEX*16 array, dimension (N-1)<br>
*>          On entry, DL must contain the (n-1) subdiagonal elements of<br>
*>          A.<br>
*>          On exit, DL is overwritten by the (n-2) elements of the<br>
*>          second superdiagonal of the upper triangular matrix U from<br>
...
*> \verbatim<br>
*>          DU is COMPLEX*16 array, dimension (N-1)<br>
*>          On entry, DU must contain the (n-1) superdiagonal elements<br>
*>          of A.<br>
*>          On exit, DU is overwritten by the (n-1) elements of the first<br>
*>          superdiagonal of U.<br>
*> \endverbatim<br>
*><br>
*> \param[in,out] B<br>
*> \verbatim<br>
...
*> \date September 2012<br>
*<br>
*> \ingroup complex16GTsolve<br>
*<br>
*  =====================================================================<br>
*/
	public void zgtsv_(INTEGER N,INTEGER NRHS,double[] DL,double[] D,double[] DU,double[] B,INTEGER LDB,INTEGER INFO);
/**
*> \brief <b> ZGTSVX computes the solution to system of linear equations A * X = B for GT matrices <b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGTSVX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgtsvx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgtsvx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgtsvx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGTSVX( FACT, TRANS, N, NRHS, DL, D, DU, DLF, DF, DUF,<br>
...
*> \verbatim<br>
*><br>
*> ZGTSVX uses the LU factorization to compute the solution to a complex<br>
*> system of linear equations A * X = B, A**T * X = B, or A**H * X = B,<br>
...
*>          = 'F':  DLF, DF, DUF, DU2, and IPIV contain the factored form<br>
...
*>          the LU factorization of A as computed by ZGTTRF.<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download ZGTTRF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgttrf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgttrf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgttrf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGTTRF( N, DL, D, DU, DU2, IPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> ZGTTRF computes an LU factorization of a complex tridiagonal matrix A<br>
...
*<br>
*> \htmlonly<br>
*> Download ZGTTRS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgttrs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgttrs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgttrs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGTTRS( TRANS, N, NRHS, DL, D, DU, DU2, IPIV, B, LDB,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANS<br>
...
*       .. Array Arguments ..<br>
*       INTEGER            IPIV( * )<br>
*       COMPLEX*16         B( LDB, * ), D( * ), DL( * ), DU( * ), DU2( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> ZGTTRS solves one of the systems of equations<br>
*>    A * X = B,  A**T * X = B,  or  A**H * X = B,<br>
...
/**
*> \brief \b ZGTTS2 solves a system of linear equations with a tridiagonal matrix using the LU factorization computed by sgttrf.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download ZGTTS2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgtts2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgtts2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgtts2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE ZGTTS2( ITRANS, N, NRHS, DL, D, DU, DU2, IPIV, B, LDB )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> ZGTTS2 solves one of the systems of equations<br>
*>    A * X = B,  A**T * X = B,  or  A**H * X = B,<br>
*> with a tridiagonal matrix A using the LU factorization computed<br>
*> by ZGTTRF.<br>
*> \endverbatim<br>
...
*>          = 2:  A**H * X = B  (Conjugate transpose)<br>
*> \endverbatim<br>
*><br>
*> \param[in] N<br>
*> \verbatim<br>
