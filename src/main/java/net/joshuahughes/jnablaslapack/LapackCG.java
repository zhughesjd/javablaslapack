...
*<br>
*> \htmlonly<br>
*> Download CGBBRD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgbbrd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgbbrd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgbbrd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGBBRD( VECT, M, N, NCC, KL, KU, AB, LDAB, D, E, Q,<br>
...
*       .. Array Arguments ..<br>
*       REAL               D( * ), E( * ), RWORK( * )<br>
*       COMPLEX            AB( LDAB, * ), C( LDC, * ), PT( LDPT, * ),<br>
*      $                   Q( LDQ, * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> CGBBRD reduces a complex general m-by-n band matrix A to real upper<br>
...
*> \param[out] D<br>
*> \verbatim<br>
*>          D is REAL array, dimension (min(M,N))<br>
*>          The diagonal elements of the bidiagonal matrix B.<br>
*> \endverbatim<br>
*><br>
*> \param[out] E<br>
*> \verbatim<br>
*>          E is REAL array, dimension (min(M,N)-1)<br>
*>          The superdiagonal elements of the bidiagonal matrix B.<br>
*> \endverbatim<br>
*><br>
*> \param[out] Q<br>
*> \verbatim<br>
*>          Q is COMPLEX array, dimension (LDQ,M)<br>
...
*> \param[out] PT<br>
*> \verbatim<br>
*>          PT is COMPLEX array, dimension (LDPT,N)<br>
...
*> \param[in,out] C<br>
*> \verbatim<br>
*>          C is COMPLEX array, dimension (LDC,NCC)<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is COMPLEX array, dimension (max(M,N))<br>
*> \endverbatim<br>
*><br>
*> \param[out] RWORK<br>
*> \verbatim<br>
*>          RWORK is REAL array, dimension (max(M,N))<br>
*> \endverbatim<br>
*><br>
*> \param[out] INFO<br>
*> \verbatim<br>
...
*<br>
*> \htmlonly<br>
*> Download CGBCON + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgbcon.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgbcon.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgbcon.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGBCON( NORM, N, KL, KU, AB, LDAB, IPIV, ANORM, RCOND,<br>
*                          WORK, RWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          NORM<br>
...
*> \verbatim<br>
*><br>
*> CGBCON estimates the reciprocal of the condition number of a complex<br>
*> general band matrix A, in either the 1-norm or the infinity-norm,<br>
*> using the LU factorization computed by CGBTRF.<br>
*><br>
...
*>          computed by CGBTRF.  U is stored as an upper triangular band<br>
...
*<br>
*> \htmlonly<br>
*> Download CGBEQU + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgbequ.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgbequ.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgbequ.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGBEQU( M, N, KL, KU, AB, LDAB, R, C, ROWCND, COLCND,<br>
*                          AMAX, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> CGBEQU computes row and column scalings intended to equilibrate an<br>
...
*<br>
*> \htmlonly<br>
*> Download CGBEQUB + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgbequb.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgbequb.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgbequb.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGBEQUB( M, N, KL, KU, AB, LDAB, R, C, ROWCND, COLCND,<br>
*                           AMAX, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, KL, KU, LDAB, M, N<br>
...
*> \verbatim<br>
*><br>
*> CGBEQUB computes row and column scalings intended to equilibrate an<br>
...
*><br>
*> This routine differs from CGEEQU by restricting the scaling factors<br>
...
*<br>
*> \htmlonly<br>
*> Download CGBRFS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgbrfs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgbrfs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgbrfs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGBRFS( TRANS, N, KL, KU, NRHS, AB, LDAB, AFB, LDAFB,<br>
...
*> \verbatim<br>
*><br>
*> CGBRFS improves the computed solution to a system of linear<br>
...
*> \verbatim<br>
*>          IPIV is INTEGER array, dimension (N)<br>
*>          The pivot indices from CGBTRF; for 1<=i<=N, row i of the<br>
...
*<br>
*> \htmlonly<br>
*> Download CGBRFSX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgbrfsx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgbrfsx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgbrfsx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGBRFSX( TRANS, EQUED, N, KL, KU, NRHS, AB, LDAB, AFB,<br>
...
*> \verbatim<br>
*><br>
*>    CGBRFSX improves the computed solution to a system of linear<br>
...
*> \verbatim<br>
*>          IPIV is INTEGER array, dimension (N)<br>
*>     The pivot indices from SGETRF; for 1<=i<=N, row i of the<br>
*>     matrix was interchanged with row IPIV(i).<br>
*> \endverbatim<br>
*><br>
*> \param[in,out] R<br>
*> \verbatim<br>
*>          R is REAL array, dimension (N)<br>
...
/**
*> \brief <b> CGBSV computes the solution to system of linear equations A * X = B for GB matrices</b> (simple driver)<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGBSV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgbsv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgbsv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgbsv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGBSV( N, KL, KU, NRHS, AB, LDAB, IPIV, B, LDB, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> CGBSV computes the solution to a complex system of linear equations<br>
...
/**
*> \brief <b> CGBSVX computes the solution to system of linear equations A * X = B for GB matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGBSVX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgbsvx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgbsvx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgbsvx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGBSVX( FACT, TRANS, N, KL, KU, NRHS, AB, LDAB, AFB,<br>
...
*> \verbatim<br>
*><br>
*> CGBSVX uses the LU factorization to compute the solution to a complex<br>
...
*>          A, as computed by CGBTRF.  U is stored as an upper triangular<br>
...
/**
*> \brief <b> CGBSVXX computes the solution to system of linear equations A * X = B for GB matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGBSVXX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgbsvxx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgbsvxx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgbsvxx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGBSVXX( FACT, TRANS, N, KL, KU, NRHS, AB, LDAB, AFB,<br>
*                           LDAFB, IPIV, EQUED, R, C, B, LDB, X, LDX,<br>
...
*> \verbatim<br>
*><br>
*>    CGBSVXX uses the LU factorization to compute the solution to a<br>
*>    complex system of linear equations  A * X = B,  where A is an<br>
*>    N-by-N matrix and X and B are N-by-NRHS matrices.<br>
*><br>
*>    If requested, both normwise and maximum componentwise error bounds<br>
*>    are returned. CGBSVXX will return a solution with a tiny<br>
...
*><br>
*>    CGBSVXX accepts user-provided factorizations and equilibration<br>
...
*>    CGBSVXX call will also produce a solution with either O(eps)<br>
...
*>    differ from what CGBSVXX would itself produce.<br>
*> \endverbatim<br>
*<br>
*> \par Description:<br>
*  =================<br>
...
*>     for the leading INFO columns of A.  In SGESVX, this quantity is<br>
...
/**
*> \brief \b CGBTF2 computes the LU factorization of a general band matrix using the unblocked version of the algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGBTF2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgbtf2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgbtf2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgbtf2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGBTF2( M, N, KL, KU, AB, LDAB, IPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, KL, KU, LDAB, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGBTF2 computes an LU factorization of a complex m-by-n band matrix<br>
...
*<br>
*> \htmlonly<br>
*> Download CGBTRF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgbtrf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgbtrf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgbtrf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGBTRF( M, N, KL, KU, AB, LDAB, IPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, KL, KU, LDAB, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGBTRF computes an LU factorization of a complex m-by-n band matrix A<br>
...
*<br>
*> \htmlonly<br>
*> Download CGBTRS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgbtrs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgbtrs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgbtrs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGBTRS( TRANS, N, KL, KU, NRHS, AB, LDAB, IPIV, B, LDB,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANS<br>
...
*> \verbatim<br>
*><br>
*> CGBTRS solves a system of linear equations<br>
...
*<br>
*> \htmlonly<br>
*> Download CGEBAK + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgebak.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgebak.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgebak.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEBAK( JOB, SIDE, N, ILO, IHI, SCALE, M, V, LDV,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> CGEBAK forms the right or left eigenvectors of a complex general<br>
*> matrix by backward transformation on the computed eigenvectors of the<br>
*> balanced matrix output by CGEBAL.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*>                 scaling.<br>
*>          JOB must be the same as the argument JOB supplied to CGEBAL.<br>
*> \endverbatim<br>
*><br>
*> \param[in] SIDE<br>
*> \verbatim<br>
...
*> \verbatim<br>
*>          IHI is INTEGER<br>
*>          The integers ILO and IHI determined by CGEBAL.<br>
*>          1 <= ILO <= IHI <= N, if N > 0; ILO=1 and IHI=0, if N=0.<br>
*> \endverbatim<br>
*><br>
*> \param[in] SCALE<br>
*> \verbatim<br>
*>          SCALE is REAL array, dimension (N)<br>
...
*> \param[in,out] V<br>
*> \verbatim<br>
*>          V is COMPLEX array, dimension (LDV,M)<br>
*>          On entry, the matrix of right or left eigenvectors to be<br>
*>          transformed, as returned by CHSEIN or CTREVC.<br>
...
*<br>
*> \htmlonly<br>
*> Download CGEBAL + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgebal.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgebal.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgebal.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEBAL( JOB, N, A, LDA, ILO, IHI, SCALE, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          JOB<br>
...
*> \verbatim<br>
*><br>
*> CGEBAL balances a general complex matrix A.  This involves, first,<br>
...
/**
*> \brief \b CGEBD2 reduces a general matrix to bidiagonal form using an unblocked algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGEBD2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgebd2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgebd2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgebd2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEBD2( M, N, A, LDA, D, E, TAUQ, TAUP, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       .. Array Arguments ..<br>
*       REAL               D( * ), E( * )<br>
*       COMPLEX            A( LDA, * ), TAUP( * ), TAUQ( * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> CGEBD2 reduces a complex general m by n matrix A to upper or lower<br>
...
*> \param[out] TAUQ<br>
*> \verbatim<br>
*>          TAUQ is COMPLEX array dimension (min(M,N))<br>
...
*> \param[out] TAUP<br>
*> \verbatim<br>
*>          TAUP is COMPLEX array, dimension (min(M,N))<br>
*>          The scalar factors of the elementary reflectors which<br>
...
*<br>
*> \htmlonly<br>
*> Download CGEBRD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgebrd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgebrd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgebrd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEBRD( M, N, A, LDA, D, E, TAUQ, TAUP, WORK, LWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> CGEBRD reduces a general complex M-by-N matrix A to upper or lower<br>
*> bidiagonal form B by a unitary transformation: Q**H * A * P = B.<br>
*><br>
*> If m >= n, B is upper bidiagonal; if m < n, B is lower bidiagonal.<br>
*> \endverbatim<br>
...
*<br>
*> \htmlonly<br>
*> Download CGECON + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgecon.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgecon.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgecon.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGECON( NORM, N, A, LDA, ANORM, RCOND, WORK, RWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          NORM<br>
...
*> \verbatim<br>
*><br>
*> CGECON estimates the reciprocal of the condition number of a general<br>
*> complex matrix A, in either the 1-norm or the infinity-norm, using<br>
*> the LU factorization computed by CGETRF.<br>
*><br>
*> An estimate is obtained for norm(inv(A)), and the reciprocal of the<br>
*> condition number is computed as<br>
*>    RCOND = 1 / ( norm(A) * norm(inv(A)) ).<br>
...
*<br>
*> \htmlonly<br>
*> Download CGEEQU + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgeequ.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgeequ.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgeequ.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEEQU( M, N, A, LDA, R, C, ROWCND, COLCND, AMAX,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
...
*> \verbatim<br>
*><br>
*> CGEEQU computes row and column scalings intended to equilibrate an<br>
*> M-by-N matrix A and reduce its condition number.  R returns the row<br>
*> scale factors and C the column scale factors, chosen to try to make<br>
*> the largest element in each row and column of the matrix B with<br>
*> elements B(i,j)=R(i)*A(i,j)*C(j) have absolute value 1.<br>
...
*<br>
*> \htmlonly<br>
*> Download CGEEQUB + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgeequb.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgeequb.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgeequb.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEEQUB( M, N, A, LDA, R, C, ROWCND, COLCND, AMAX,<br>
*                           INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
...
*> \verbatim<br>
*><br>
*> CGEEQUB computes row and column scalings intended to equilibrate an<br>
*> M-by-N matrix A and reduce its condition number.  R returns the row<br>
*> scale factors and C the column scale factors, chosen to try to make<br>
*> the largest element in each row and column of the matrix B with<br>
*> elements B(i,j)=R(i)*A(i,j)*C(j) have an absolute value of at most<br>
...
/**
*> \brief <b> CGEES computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGEES + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgees.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgees.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgees.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEES( JOBVS, SORT, SELECT, N, A, LDA, SDIM, W, VS,<br>
...
*       LOGICAL            BWORK( * )<br>
*       REAL               RWORK( * )<br>
*       COMPLEX            A( LDA, * ), VS( LDVS, * ), W( * ), WORK( * )<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGEES computes for an N-by-N complex nonsymmetric matrix A, the<br>
...
*> \param[in] SELECT<br>
*> \verbatim<br>
*>          SELECT is a LOGICAL FUNCTION of one COMPLEX argument<br>
...
*> \param[out] VS<br>
*> \verbatim<br>
*>          VS is COMPLEX array, dimension (LDVS,N)<br>
...
/**
*> \brief <b> CGEESX computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGEESX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgeesx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgeesx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgeesx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEESX( JOBVS, SORT, SELECT, SENSE, N, A, LDA, SDIM, W,<br>
...
*> \verbatim<br>
*><br>
*> CGEESX computes for an N-by-N complex nonsymmetric matrix A, the<br>
*> eigenvalues, the Schur form T, and, optionally, the matrix of Schur<br>
*> vectors Z.  This gives the Schur factorization A = Z*T*(Z**H).<br>
*><br>
*> Optionally, it also orders the eigenvalues on the diagonal of the<br>
...
/**
*> \brief <b> CGEEV computes the eigenvalues and, optionally, the left and/or right eigenvectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGEEV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgeev.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgeev.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgeev.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEEV( JOBVL, JOBVR, N, A, LDA, W, VL, LDVL, VR, LDVR,<br>
...
*       .. Array Arguments ..<br>
*       REAL   RWORK( * )<br>
*       COMPLEX         A( LDA, * ), VL( LDVL, * ), VR( LDVR, * ),<br>
*      $                   W( * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> CGEEV computes for an N-by-N complex nonsymmetric matrix A, the<br>
...
*> \param[out] VL<br>
*> \verbatim<br>
*>          VL is COMPLEX array, dimension (LDVL,N)<br>
...
*> \param[out] VR<br>
*> \verbatim<br>
*>          VR is COMPLEX array, dimension (LDVR,N)<br>
...
*> \date June 2016<br>
*<br>
*  @generated from zgeev.f, fortran z -> c, Tue Apr 19 01:47:44 2016<br>
*<br>
*> \ingroup complexGEeigen<br>
*<br>
*  =====================================================================<br>
...
/**
*> \brief <b> CGEEVX computes the eigenvalues and, optionally, the left and/or right eigenvectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGEEVX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgeevx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgeevx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgeevx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEEVX( BALANC, JOBVL, JOBVR, SENSE, N, A, LDA, W, VL,<br>
...
*> \verbatim<br>
*><br>
*> CGEEVX computes for an N-by-N complex nonsymmetric matrix A, the<br>
*> eigenvalues and, optionally, the left and/or right eigenvectors.<br>
*><br>
...
*> \param[out] RCONDE<br>
*> \verbatim<br>
*>          RCONDE is REAL array, dimension (N)<br>
...
*> \param[out] RCONDV<br>
*> \verbatim<br>
*>          RCONDV is REAL array, dimension (N)<br>
...
*> \date June 2016<br>
*<br>
*  @generated from zgeevx.f, fortran z -> c, Tue Apr 19 01:47:44 2016<br>
*<br>
*> \ingroup complexGEeigen<br>
*<br>
*  =====================================================================<br>
...
/**
*> \brief \b CGEHD2 reduces a general square matrix to upper Hessenberg form using an unblocked algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGEHD2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgehd2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgehd2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgehd2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEHD2( N, ILO, IHI, A, LDA, TAU, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            IHI, ILO, INFO, LDA, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGEHD2 reduces a complex general matrix A to upper Hessenberg form H<br>
...
*>          set by a previous call to CGEBAL; otherwise they should be<br>
...
*<br>
*> \htmlonly<br>
*> Download CGEHRD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgehrd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgehrd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgehrd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEHRD( N, ILO, IHI, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> CGEHRD reduces a complex general matrix A to upper Hessenberg form H by<br>
...
*<br>
*> \htmlonly<br>
*> Download CGEJSV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgejsv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgejsv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgejsv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*     SUBROUTINE CGEJSV( JOBA, JOBU, JOBV, JOBR, JOBT, JOBP,<br>
...
*     ..<br>
*     .. Array Arguments ..<br>
*     COMPLEX     A( LDA, * ),  U( LDU, * ), V( LDV, * ), CWORK( LWORK )<br>
*     REAL        SVA( N ), RWORK( LRWORK )      <br>
*     INTEGER     IWORK( * )<br>
...
*> \verbatim<br>
*><br>
*> CGEJSV computes the singular value decomposition (SVD) of a complex M-by-N<br>
...
*>         value of c*A is around SQRT(BIG), BIG=SLAMCH('O'), then JOBR issues<br>
...
*>              is greater than BIG, use CGESVJ.<br>
...
*> \param[out] SVA<br>
*> \verbatim<br>
*>          SVA is REAL array, dimension (N)<br>
*>          On exit,<br>
...
*> \param[out] U<br>
*> \verbatim<br>
*>          U is COMPLEX array, dimension ( LDU, N ) or ( LDU, M )<br>
...
*> \param[out] V<br>
*> \verbatim<br>
*>          V is COMPLEX array, dimension ( LDV, N )<br>
...
*> \param[out] CWORK<br>
*> \verbatim<br>
*>          CWORK is COMPLEX array, dimension at least LWORK.     <br>
*> \endverbatim<br>
*><br>
*> \param[in] LWORK<br>
*> \verbatim<br>
...
*>               block size for CGEQP3 and CGEQRF.<br>
*>               In general, optimal LWORK is computed as <br>
*>               LWORK >= max(N+LWORK(CGEQP3),N+LWORK(CGEQRF)).        <br>
...
*>               where NB is the optimal block size for CGEQP3, CGEQRF, CGELQF,<br>
*>               CUNMLQ. In general, the optimal length LWORK is computed as<br>
*>               LWORK >= max(N+LWORK(CGEQP3), N+LWORK(CPOCON), N+LWORK(CGESVJ),<br>
*>                       N+LWORK(CGELQF), 2*N+LWORK(CGEQRF), N+LWORK(CUNMLQ)).<br>
*><br>
...
*>               where NB is the optimal block size for CGEQP3, CGEQRF, CUNMQR.<br>
*>               In general, the optimal length LWORK is computed as<br>
*>               LWORK >= max(N+LWORK(CGEQP3),N+LWORK(CPOCON),<br>
*>                        2*N+LWORK(CGEQRF), N+LWORK(CUNMQR)). <br>
*>               <br>
...
*>            of CGEQP3, CGEQRF, CGELQF, CUNMQR, CUNMLQ.<br>
*> \endverbatim<br>
*><br>
*> \param[out] RWORK<br>
*> \verbatim<br>
*>          RWORK is REAL array, dimension at least LRWORK.<br>
*>          On exit,<br>
...
*>           > 0 :  CGEJSV  did not converge in the maximal allowed number<br>
...
*> \verbatim<br>
*><br>
*>  CGEJSV implements a preconditioned Jacobi SVD algorithm. It uses CGEQP3,<br>
*>  CGEQRF, and CGELQF as preprocessors and preconditioners. Optionally, an<br>
...
*>  & LAPACK routines called by CGEJSV are implemented to work in that range.<br>
...
*>  overflow. This code (CGEJSV) is best used in this restricted range,<br>
*>  meaning that singular values of magnitude below ||A||_2 / SLAMCH('O') are<br>
...
*>  the choice of some tuning parameters in the iterative part (CGESVJ) is<br>
*>  left to the implementer on a particular machine.<br>
*>     The rank revealing QR factorization (in this code: CGEQP3) should be<br>
*>  implemented as in [3]. We have a new version of CGEQP3 under development<br>
...
*>  well known trick is not used in CGEJSV because in some cases heavy row<br>
...
*>  implementation of CGEJSV uses only the simplest, naive data movement.<br>
*<br>
*> \par Contributors:<br>
*  ==================<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download CGELQ2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgelq2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgelq2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgelq2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGELQ2( M, N, A, LDA, TAU, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGELQ2 computes an LQ factorization of a complex m by n matrix A:<br>
*> A = L * Q.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download CGELQF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgelqf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgelqf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgelqf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGELQF( M, N, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LWORK, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGELQF computes an LQ factorization of a complex M-by-N matrix A:<br>
*> A = L * Q.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
/**
*> \brief <b> CGELS solves overdetermined or underdetermined systems for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGELS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgels.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgels.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgels.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGELS( TRANS, M, N, NRHS, A, LDA, B, LDB, WORK, LWORK,<br>
*                         INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANS<br>
...
*> \verbatim<br>
*><br>
*> CGELS solves overdetermined or underdetermined complex linear systems<br>
...
*>                       factorization as returned by CGEQRF;<br>
*>            if M <  N, A is overwritten by details of its LQ<br>
*>                       factorization as returned by CGELQF.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDA<br>
*> \verbatim<br>
...
/**
*> \brief <b> CGELSD computes the minimum-norm solution to a linear least squares problem for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGELSD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgelsd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgelsd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgelsd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGELSD( M, N, NRHS, A, LDA, B, LDB, S, RCOND, RANK,<br>
...
*> \verbatim<br>
*><br>
*> CGELSD computes the minimum-norm solution to a real linear least<br>
*> squares problem:<br>
...
*> \param[out] S<br>
*> \verbatim<br>
*>          S is REAL array, dimension (min(M,N))<br>
...
/**
*> \brief <b> CGELSS solves overdetermined or underdetermined systems for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGELSS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgelss.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgelss.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgelss.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGELSS( M, N, NRHS, A, LDA, B, LDB, S, RCOND, RANK,<br>
*                          WORK, LWORK, RWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LDB, LWORK, M, N, NRHS, RANK<br>
...
*> \verbatim<br>
*><br>
*> CGELSS computes the minimum norm solution to a complex linear<br>
...
*> \param[out] RWORK<br>
*> \verbatim<br>
*>          RWORK is REAL array, dimension (5*min(M,N))<br>
*> \endverbatim<br>
*><br>
*> \param[out] INFO<br>
*> \verbatim<br>
...
/**
*> \brief <b> CGELSY solves overdetermined or underdetermined systems for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGELSY + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgelsy.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgelsy.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgelsy.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGELSY( M, N, NRHS, A, LDA, B, LDB, JPVT, RCOND, RANK,<br>
*                          WORK, LWORK, RWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LDB, LWORK, M, N, NRHS, RANK<br>
...
*> \verbatim<br>
*><br>
*> CGELSY computes the minimum-norm solution to a complex linear least<br>
*> squares problem:<br>
*>     minimize || A * X - B ||<br>
...
*>          by ILAENV for the routines CGEQP3, CTZRZF, CTZRQF, CUNMQR,<br>
*>          and CUNMRZ.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates the optimal size of the WORK array, returns<br>
...
*<br>
*> \htmlonly<br>
*> Download CGEMQRT + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgemqrt.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgemqrt.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgemqrt.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEMQRT( SIDE, TRANS, M, N, K, NB, V, LDV, T, LDT, <br>
*                          C, LDC, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       COMPLEX   V( LDV, * ), C( LDC, * ), T( LDT, * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> CGEMQRT overwrites the general complex M-by-N matrix C with<br>
*><br>
*>                 SIDE = 'L'     SIDE = 'R'<br>
*> TRANS = 'N':      Q C            C Q<br>
...
*><br>
*> generated using the compact WY representation as returned by CGEQRT. <br>
*><br>
...
*> \param[in] V<br>
*> \verbatim<br>
*>          V is COMPLEX array, dimension (LDV,K)<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is COMPLEX array. The dimension of WORK is<br>
...
/**
*> \brief \b CGEQL2 computes the QL factorization of a general rectangular matrix using an unblocked algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGEQL2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgeql2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgeql2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgeql2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEQL2( M, N, A, LDA, TAU, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGEQL2 computes a QL factorization of a complex m by n matrix A:<br>
*> A = Q * L.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download CGEQLF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgeqlf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgeqlf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgeqlf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEQLF( M, N, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LWORK, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGEQLF computes a QL factorization of a complex M-by-N matrix A:<br>
*> A = Q * L.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download CGEQP3 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgeqp3.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgeqp3.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgeqp3.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEQP3( M, N, A, LDA, JPVT, TAU, WORK, LWORK, RWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LWORK, M, N<br>
...
*> \verbatim<br>
*><br>
*> CGEQP3 computes a QR factorization with column pivoting of a<br>
...
/**
*> \brief \b CGEQR2 computes the QR factorization of a general rectangular matrix using an unblocked algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGEQR2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgeqr2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgeqr2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgeqr2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEQR2( M, N, A, LDA, TAU, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGEQR2 computes a QR factorization of a complex m by n matrix A:<br>
*> A = Q * R.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
/**
*> \brief \b CGEQR2P computes the QR factorization of a general rectangular matrix with non-negative diagonal elements using an unblocked algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGEQR2P + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgeqr2p.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgeqr2p.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgeqr2p.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEQR2P( M, N, A, LDA, TAU, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGEQR2P computes a QR factorization of a complex m by n matrix A:<br>
...
*>          real and nonnegative; the elements below the diagonal,<br>
*>          with the array TAU, represent the unitary matrix Q as a<br>
*>          product of elementary reflectors (see Further Details).<br>
*> \endverbatim<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download CGEQRF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgeqrf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgeqrf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgeqrf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEQRF( M, N, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LWORK, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGEQRF computes a QR factorization of a complex M-by-N matrix A:<br>
*> A = Q * R.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download CGEQRFP + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgeqrfp.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgeqrfp.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgeqrfp.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEQRFP( M, N, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LWORK, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGEQRFP computes a QR factorization of a complex M-by-N matrix A:<br>
*> A = Q * R. The diagonal entries of R are real and nonnegative.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download CGEQRT + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgeqrt.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgeqrt.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgeqrt.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEQRT( M, N, NB, A, LDA, T, LDT, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER INFO, LDA, LDT, M, N, NB<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       COMPLEX A( LDA, * ), T( LDT, * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> CGEQRT computes a blocked QR factorization of a complex M-by-N matrix A<br>
...
*> \param[out] T<br>
*> \verbatim<br>
*>          T is COMPLEX array, dimension (LDT,MIN(M,N))<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is COMPLEX array, dimension (NB*N)<br>
*> \endverbatim<br>
*><br>
*> \param[out] INFO<br>
*> \verbatim<br>
...
/**
*> \brief \b CGEQRT2 computes a QR factorization of a general real or complex matrix using the compact WY representation of Q.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGEQRT2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgeqrt2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgeqrt2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgeqrt2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGEQRT2( M, N, A, LDA, T, LDT, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER   INFO, LDA, LDT, M, N<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       COMPLEX   A( LDA, * ), T( LDT, * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> CGEQRT2 computes a QR factorization of a complex M-by-N matrix A, <br>
*> using the compact WY representation of Q. <br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
/**
*> \brief \b CGEQRT3 recursively computes a QR factorization of a general real or complex matrix using the compact WY representation of Q.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGEQRT3 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgeqrt3.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgeqrt3.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgeqrt3.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       RECURSIVE SUBROUTINE CGEQRT3( M, N, A, LDA, T, LDT, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> CGEQRT3 recursively computes a QR factorization of a complex M-by-N matrix A, <br>
*> using the compact WY representation of Q. <br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download CGERFS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgerfs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgerfs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgerfs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGERFS( TRANS, N, NRHS, A, LDA, AF, LDAF, IPIV, B, LDB,<br>
...
*> \verbatim<br>
*><br>
*> CGERFS improves the computed solution to a system of linear<br>
...
*> \verbatim<br>
*>          IPIV is INTEGER array, dimension (N)<br>
*>          The pivot indices from CGETRF; for 1<=i<=N, row i of the<br>
*>          matrix was interchanged with row IPIV(i).<br>
*> \endverbatim<br>
*><br>
*> \param[in] B<br>
...
*<br>
*> \htmlonly<br>
*> Download CGERFSX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgerfsx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgerfsx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgerfsx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGERFSX( TRANS, EQUED, N, NRHS, A, LDA, AF, LDAF, IPIV,<br>
...
*> \verbatim<br>
*><br>
*>    CGERFSX improves the computed solution to a system of linear<br>
*>    equations and provides error bounds and backward error estimates<br>
*>    for the solution.  In addition to normwise error bound, the code<br>
*>    provides maximum componentwise error bound if possible.  See<br>
*>    comments for ERR_BNDS_NORM and ERR_BNDS_COMP for details of the<br>
...
/**
*> \brief \b CGERQ2 computes the RQ factorization of a general rectangular matrix using an unblocked algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGERQ2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgerq2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgerq2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgerq2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGERQ2( M, N, A, LDA, TAU, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGERQ2 computes an RQ factorization of a complex m by n matrix A:<br>
*> A = R * Q.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download CGERQF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgerqf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgerqf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgerqf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGERQF( M, N, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LWORK, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGERQF computes an RQ factorization of a complex M-by-N matrix A:<br>
*> A = R * Q.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
/**
*> \brief \b CGESC2 solves a system of linear equations using the LU factorization with complete pivoting computed by sgetc2.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGESC2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgesc2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgesc2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgesc2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGESC2( N, A, LDA, RHS, IPIV, JPIV, SCALE )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            LDA, N<br>
*       REAL               SCALE<br>
...
*> \verbatim<br>
*><br>
*> CGESC2 solves a system of linear equations<br>
*><br>
*>           A * X = scale* RHS<br>
*><br>
*> with a general N-by-N matrix A using the LU factorization with<br>
*> complete pivoting computed by CGETC2.<br>
*><br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*>          matrix A computed by CGETC2:  A = P * L * U * Q<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDA<br>
*> \verbatim<br>
...
*<br>
*> \htmlonly<br>
*> Download CGESDD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgesdd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgesdd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgesdd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGESDD( JOBZ, M, N, A, LDA, S, U, LDU, VT, LDVT,<br>
*                          WORK, LWORK, RWORK, IWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          JOBZ<br>
...
*       INTEGER            IWORK( * )<br>
*       REAL               RWORK( * ), S( * )<br>
*       COMPLEX            A( LDA, * ), U( LDU, * ), VT( LDVT, * ),<br>
*      $                   WORK( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> CGESDD computes the singular value decomposition (SVD) of a complex<br>
...
*> \param[out] U<br>
*> \verbatim<br>
*>          U is COMPLEX array, dimension (LDU,UCOL)<br>
...
*> \param[out] VT<br>
*> \verbatim<br>
*>          VT is COMPLEX array, dimension (LDVT,N)<br>
...
*>          = 0:  successful exit.<br>
*>          < 0:  if INFO = -i, the i-th argument had an illegal value.<br>
*>          > 0:  The updating process of SBDSDC did not converge.<br>
*> \endverbatim<br>
*<br>
*  Authors:<br>
*  ========<br>
...
/**
*> \brief <b> CGESV computes the solution to system of linear equations A * X = B for GE matrices</b> (simple driver)<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGESV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgesv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgesv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgesv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGESV( N, NRHS, A, LDA, IPIV, B, LDB, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> CGESV computes the solution to a complex system of linear equations<br>
*>    A * X = B,<br>
...
/**
*> \brief <b> CGESVD computes the singular value decomposition (SVD) for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGESVD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgesvd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgesvd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgesvd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGESVD( JOBU, JOBVT, M, N, A, LDA, S, U, LDU, VT, LDVT,<br>
*                          WORK, LWORK, RWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> CGESVD computes the singular value decomposition (SVD) of a complex<br>
*> M-by-N matrix A, optionally computing the left and/or right singular<br>
...
*>          = 0:  successful exit.<br>
*>          < 0:  if INFO = -i, the i-th argument had an illegal value.<br>
*>          > 0:  if CBDSQR did not converge, INFO specifies how many<br>
...
/**
*> \brief <b> CGESVDX computes the singular value decomposition (SVD) for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGESVDX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgesvdx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgesvdx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgesvdx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
...
*> \verbatim<br>
*><br>
*>  CGESVDX computes the singular value decomposition (SVD) of a complex<br>
*>  M-by-N matrix A, optionally computing the left and/or right singular<br>
*>  vectors. The SVD is written<br>
*> <br>
...
*>  U and V are the left and right singular vectors of A.<br>
*> <br>
*>  CGESVDX uses an eigenvalue problem for obtaining the SVD, which <br>
*>  allows for the computation of a subset of singular values and <br>
*>  vectors. See SBDSVDX for details.<br>
*> <br>
...
*>          to converge in SBDSVDX/SSTEVX.<br>
*> \endverbatim<br>
*><br>
*> \param[out] INFO<br>
*> \verbatim<br>
...
*<br>
*> \htmlonly<br>
*> Download CGESVJ + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgesvj.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgesvj.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgesvj.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGESVJ( JOBA, JOBU, JOBV, M, N, A, LDA, SVA, MV, V,<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       COMPLEX            A( LDA, * ),  V( LDV, * ), CWORK( LWORK )<br>
*       REAL               RWORK( LRWORK ),  SVA( N )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
* CGESVJ computes the singular value decomposition (SVD) of a complex<br>
...
*>                 approximately TOL=CTOL*EPS, CTOL=SQRT(M), EPS=SLAMCH('E').<br>
...
*> \verbatim<br>
*>          M is INTEGER<br>
*>          The number of rows of the input matrix A. 1/SLAMCH('E') > M >= 0.<br>
*> \endverbatim<br>
*><br>
*> \param[in] N<br>
*> \verbatim<br>
...
*>                 above the underflow threshold SLAMCH('S'). The singular<br>
...
*>                 If INFO .GT. 0,<br>
*>                 the procedure CGESVJ did not converge in the given number<br>
...
*><br>
*>          If INFO .GT. 0 :<br>
*>          the procedure CGESVJ did not converge in the given number of<br>
...
*> \verbatim<br>
*>          MV is INTEGER<br>
*>          If JOBV .EQ. 'A', then the product of Jacobi rotations in CGESVJ<br>
...
*> \verbatim<br>
*>          CWORK is COMPLEX array, dimension M+N.<br>
...
*>                    This is useful information in cases when CGESVJ did<br>
...
*>          = 0 : successful exit.<br>
*>          < 0 : if INFO = -i, then the i-th argument had an illegal value<br>
*>          > 0 : CGESVJ did not converge in the maximal allowed number <br>
...
*<br>
*> \htmlonly<br>
*> Download CGESVX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgesvx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgesvx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgesvx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGESVX( FACT, TRANS, N, NRHS, A, LDA, AF, LDAF, IPIV,<br>
...
*> \verbatim<br>
*><br>
*> CGESVX uses the LU factorization to compute the solution to a complex<br>
...
*>          A = P*L*U as computed by CGETRF.  If EQUED .ne. 'N', then<br>
...
/**
*> \brief <b> CGESVXX computes the solution to system of linear equations A * X = B for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGESVXX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgesvxx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgesvxx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgesvxx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGESVXX( FACT, TRANS, N, NRHS, A, LDA, AF, LDAF, IPIV,<br>
...
*> \verbatim<br>
*><br>
*>    CGESVXX uses the LU factorization to compute the solution to a<br>
*>    complex system of linear equations  A * X = B,  where A is an<br>
*>    N-by-N matrix and X and B are N-by-NRHS matrices.<br>
*><br>
*>    If requested, both normwise and maximum componentwise error bounds<br>
*>    are returned. CGESVXX will return a solution with a tiny<br>
*>    guaranteed error (O(eps) where eps is the working machine<br>
*>    precision) unless the matrix is very ill-conditioned, in which<br>
*>    case a warning is returned. Relevant condition numbers also are<br>
*>    calculated and returned.<br>
*><br>
*>    CGESVXX accepts user-provided factorizations and equilibration<br>
*>    factors; see the definitions of the FACT and EQUED options.<br>
*>    Solving with refinement and using a factorization from a previous<br>
*>    CGESVXX call will also produce a solution with either O(eps)<br>
*>    errors or warnings, but we cannot make that claim for general<br>
*>    user-provided factorizations and equilibration factors if they<br>
*>    differ from what CGESVXX would itself produce.<br>
*> \endverbatim<br>
*<br>
*> \par Description:<br>
*  =================<br>
...
*>     and error bounds could be unreliable. If factorization fails with<br>
*>     0<INFO<=N, then this contains the reciprocal pivot growth factor<br>
*>     for the leading INFO columns of A.  In CGESVX, this quantity is<br>
*>     returned in WORK(1).<br>
*> \endverbatim<br>
*><br>
*> \param[out] BERR<br>
...
/**
*> \brief \b CGETC2 computes the LU factorization with complete pivoting of the general n-by-n matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGETC2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgetc2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgetc2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgetc2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGETC2( N, A, LDA, IPIV, JPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGETC2 computes an LU factorization, using complete pivoting, of the<br>
...
/**
*> \brief \b CGETF2 computes the LU factorization of a general m-by-n matrix using partial pivoting with row interchanges (unblocked algorithm).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGETF2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgetf2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgetf2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgetf2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGETF2( M, N, A, LDA, IPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGETF2 computes an LU factorization of a general m-by-n matrix A<br>
*> using partial pivoting with row interchanges.<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download CGETRF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgetrf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgetrf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgetrf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGETRF( M, N, A, LDA, IPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGETRF computes an LU factorization of a general M-by-N matrix A<br>
*> using partial pivoting with row interchanges.<br>
*><br>
*> The factorization has the form<br>
*>    A = P * L * U<br>
...
*  ===========<br>
*<br>
*       RECURSIVE SUBROUTINE CGETRF2( M, N, A, LDA, IPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGETRF2 computes an LU factorization of a general M-by-N matrix A<br>
*> using partial pivoting with row interchanges.<br>
*><br>
*> The factorization has the form<br>
*>    A = P * L * U<br>
...
*<br>
*> \htmlonly<br>
*> Download CGETRI + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgetri.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgetri.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgetri.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGETRI( N, A, LDA, IPIV, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> CGETRI computes the inverse of a matrix using the LU factorization<br>
*> computed by CGETRF.<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download CGETRS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgetrs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgetrs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgetrs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGETRS( TRANS, N, NRHS, A, LDA, IPIV, B, LDB, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANS<br>
*       INTEGER            INFO, LDA, LDB, N, NRHS<br>
...
*> \verbatim<br>
*><br>
*> CGETRS solves a system of linear equations<br>
*>    A * X = B,  A**T * X = B,  or  A**H * X = B<br>
...
*<br>
*> \htmlonly<br>
*> Download CGGBAK + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cggbak.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cggbak.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cggbak.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGGBAK( JOB, SIDE, N, ILO, IHI, LSCALE, RSCALE, M, V,<br>
*                          LDV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          JOB, SIDE<br>
...
*> \verbatim<br>
*><br>
*> CGGBAK forms the right or left eigenvectors of a complex generalized<br>
...
*>          = 'B':  do backward transformations for both permutation and<br>
*>                  scaling.<br>
*>          JOB must be the same as the argument JOB supplied to CGGBAL.<br>
*> \endverbatim<br>
*><br>
*> \param[in] SIDE<br>
*> \verbatim<br>
...
*> \verbatim<br>
*>          IHI is INTEGER<br>
*>          The integers ILO and IHI determined by CGGBAL.<br>
*>          1 <= ILO <= IHI <= N, if N > 0; ILO=1 and IHI=0, if N=0.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LSCALE<br>
*> \verbatim<br>
*>          LSCALE is REAL array, dimension (N)<br>
*>          Details of the permutations and/or scaling factors applied<br>
*>          to the left side of A and B, as returned by CGGBAL.<br>
*> \endverbatim<br>
*><br>
*> \param[in] RSCALE<br>
*> \verbatim<br>
*>          RSCALE is REAL array, dimension (N)<br>
*>          Details of the permutations and/or scaling factors applied<br>
*>          to the right side of A and B, as returned by CGGBAL.<br>
*> \endverbatim<br>
*><br>
*> \param[in] M<br>
*> \verbatim<br>
...
*>          V is COMPLEX array, dimension (LDV,M)<br>
*>          On entry, the matrix of right or left eigenvectors to be<br>
*>          transformed, as returned by CTGEVC.<br>
*>          On exit, V is overwritten by the transformed eigenvectors.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDV<br>
...
*<br>
*> \htmlonly<br>
*> Download CGGBAL + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cggbal.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cggbal.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cggbal.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGGBAL( JOB, N, A, LDA, B, LDB, ILO, IHI, LSCALE,<br>
*                          RSCALE, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          JOB<br>
...
*> \verbatim<br>
*><br>
*> CGGBAL balances a pair of general complex matrices (A,B).  This<br>
...
/**
*> \brief <b> CGGES computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGGES + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgges.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgges.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgges.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGGES( JOBVSL, JOBVSR, SORT, SELCTG, N, A, LDA, B, LDB,<br>
...
*> \verbatim<br>
*><br>
*> CGGES computes for a pair of N-by-N complex nonsymmetric matrices<br>
...
*> CGGEV instead, which is faster.)<br>
*><br>
...
*> \param[in] SELCTG<br>
*> \verbatim<br>
*>          SELCTG is a LOGICAL FUNCTION of two COMPLEX arguments<br>
...
*>          output by CGGES. The  BETA(j) will be non-negative real.<br>
*><br>
...
*> \param[out] VSL<br>
*> \verbatim<br>
*>          VSL is COMPLEX array, dimension (LDVSL,N)<br>
...
*> \param[out] VSR<br>
*> \verbatim<br>
*>          VSR is COMPLEX array, dimension (LDVSR,N)<br>
...
*> \param[out] RWORK<br>
*> \verbatim<br>
*>          RWORK is REAL array, dimension (8*N)<br>
*> \endverbatim<br>
*><br>
*> \param[out] BWORK<br>
*> \verbatim<br>
...
*>                =N+3: reordering failed in CTGSEN.<br>
*> \endverbatim<br>
*<br>
*  Authors:<br>
*  ========<br>
...
/**
*> \brief <b> CGGES3 computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices (blocked algorithm)</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at<br>
...
*<br>
*> \htmlonly<br>
*> Download CGGES3 + dependencies<br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgges3.f"><br>
*> [TGZ]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgges3.f"><br>
*> [ZIP]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgges3.f"><br>
*> [TXT]</a><br>
*> \endhtmlonly<br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGGES3( JOBVSL, JOBVSR, SORT, SELCTG, N, A, LDA, B,<br>
...
*> \verbatim<br>
*><br>
*> CGGES3 computes for a pair of N-by-N complex nonsymmetric matrices<br>
*> (A,B), the generalized eigenvalues, the generalized complex Schur<br>
*> form (S, T), and optionally left and/or right Schur vectors (VSL<br>
*> and VSR). This gives the generalized Schur factorization<br>
*><br>
...
*>          generalized eigenvalues.  ALPHA(j), j=1,...,N  and  BETA(j),<br>
*>          j=1,...,N  are the diagonals of the complex Schur form (A,B)<br>
*>          output by CGGES3. The  BETA(j) will be non-negative real.<br>
*><br>
*>          Note: the quotients ALPHA(j)/BETA(j) may easily over- or<br>
*>          underflow, and BETA(j) may even be zero.  Thus, the user<br>
*>          should avoid naively computing the ratio alpha/beta.<br>
...
/**
*> \brief <b> CGGESX computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGGESX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cggesx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cggesx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cggesx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGGESX( JOBVSL, JOBVSR, SORT, SELCTG, SENSE, N, A, LDA,<br>
...
*       LOGICAL            BWORK( * )<br>
*       INTEGER            IWORK( * )<br>
*       REAL               RCONDE( 2 ), RCONDV( 2 ), RWORK( * )<br>
*       COMPLEX            A( LDA, * ), ALPHA( * ), B( LDB, * ),<br>
*      $                   BETA( * ), VSL( LDVSL, * ), VSR( LDVSR, * ),<br>
*      $                   WORK( * )<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGGESX computes for a pair of N-by-N complex nonsymmetric matrices<br>
...
*> \param[in] SELCTG<br>
*> \verbatim<br>
*>          SELCTG is procedure) LOGICAL FUNCTION of two COMPLEX arguments<br>
*>          SELCTG must be declared EXTERNAL in the calling subroutine.<br>
*>          If SORT = 'N', SELCTG is not referenced.<br>
*>          If SORT = 'S', SELCTG is used to select eigenvalues to sort<br>
*>          to the top left of the Schur form.<br>
...
*> \param[out] RCONDE<br>
*> \verbatim<br>
*>          RCONDE is REAL array, dimension ( 2 )<br>
...
*> \param[out] RCONDV<br>
*> \verbatim<br>
*>          RCONDV is REAL array, dimension ( 2 )<br>
...
/**
*> \brief <b> CGGEV computes the eigenvalues and, optionally, the left and/or right eigenvectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGGEV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cggev.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cggev.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cggev.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGGEV( JOBVL, JOBVR, N, A, LDA, B, LDB, ALPHA, BETA,<br>
...
*> \verbatim<br>
*><br>
*> CGGEV computes for a pair of N-by-N complex nonsymmetric matrices<br>
...
*>          > N:  =N+1: other then QZ iteration failed in SHGEQZ,<br>
*>                =N+2: error return from STGEVC.<br>
*> \endverbatim<br>
*<br>
*  Authors:<br>
*  ========<br>
...
/**
*> \brief <b> CGGEV3 computes the eigenvalues and, optionally, the left and/or right eigenvectors for GE matrices (blocked algorithm)</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at<br>
...
*<br>
*> \htmlonly<br>
*> Download CGGEV3 + dependencies<br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cggev3.f"><br>
*> [TGZ]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cggev3.f"><br>
*> [ZIP]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cggev3.f"><br>
*> [TXT]</a><br>
*> \endhtmlonly<br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGGEV3( JOBVL, JOBVR, N, A, LDA, B, LDB, ALPHA, BETA,<br>
*      $                   VL, LDVL, VR, LDVR, WORK, LWORK, RWORK, INFO )<br>
*<br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          JOBVL, JOBVR<br>
...
*> \verbatim<br>
*><br>
*> CGGEV3 computes for a pair of N-by-N complex nonsymmetric matrices<br>
*> (A,B), the generalized eigenvalues, and optionally, the left and/or<br>
*> right generalized eigenvectors.<br>
*><br>
*> A generalized eigenvalue for a pair of matrices (A,B) is a scalar<br>
...
/**
*> \brief <b> CGGEVX computes the eigenvalues and, optionally, the left and/or right eigenvectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGGEVX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cggevx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cggevx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cggevx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGGEVX( BALANC, JOBVL, JOBVR, SENSE, N, A, LDA, B, LDB,<br>
...
*> \verbatim<br>
*><br>
*> CGGEVX computes for a pair of N-by-N complex nonsymmetric matrices<br>
*> (A,B) the generalized eigenvalues, and optionally, the left and/or<br>
*> right generalized eigenvectors.<br>
*><br>
...
*> \param[out] RWORK<br>
*> \verbatim<br>
*>          RWORK is REAL array, dimension (lrwork)<br>
...
*>                for j=INFO+1,...,N.<br>
*>          > N:  =N+1: other than QZ iteration failed in CHGEQZ.<br>
*>                =N+2: error return from CTGEVC.<br>
*> \endverbatim<br>
*<br>
*  Authors:<br>
*  ========<br>
...
*<br>
*> \htmlonly<br>
*> Download CGGGLM + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cggglm.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cggglm.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cggglm.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGGGLM( N, M, P, A, LDA, B, LDB, D, X, Y, WORK, LWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> CGGGLM solves a general Gauss-Markov linear model (GLM) problem:<br>
*><br>
...
*> \param[in,out] A<br>
*> \verbatim<br>
*>          A is COMPLEX array, dimension (LDA,M)<br>
...
*> \param[in,out] B<br>
*> \verbatim<br>
*>          B is COMPLEX array, dimension (LDB,P)<br>
...
*> \param[out] X<br>
*> \verbatim<br>
*>          X is COMPLEX array, dimension (M)<br>
*> \endverbatim<br>
*><br>
*> \param[out] Y<br>
*> \verbatim<br>
*>          Y is COMPLEX array, dimension (P)<br>
*><br>
...
*>          CGEQRF, CGERQF, CUNMQR and CUNMRQ.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates the optimal size of the WORK array, returns<br>
*>          this value as the first entry of the WORK array, and no error<br>
...
*<br>
*> \htmlonly<br>
*> Download CGGHD3 + dependencies<br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgghd3.f"><br>
*> [TGZ]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgghd3.f"><br>
*> [ZIP]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgghd3.f"><br>
*> [TXT]</a><br>
*> \endhtmlonly<br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*        SUBROUTINE CGGHD3( COMPQ, COMPZ, N, ILO, IHI, A, LDA, B, LDB, Q,<br>
...
*><br>
*><br>
*> CGGHD3 reduces a pair of complex matrices (A,B) to generalized upper<br>
...
*> original equation A*x = lambda*B*x, then CGGHD3 reduces the original<br>
...
*>          normally set by a previous call to CGGBAL; otherwise they<br>
...
*<br>
*> \htmlonly<br>
*> Download CGGHRD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgghrd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgghrd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgghrd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGGHRD( COMPQ, COMPZ, N, ILO, IHI, A, LDA, B, LDB, Q,<br>
*                          LDQ, Z, LDZ, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          COMPQ, COMPZ<br>
...
*> \verbatim<br>
*><br>
*> CGGHRD reduces a pair of complex matrices (A,B) to generalized upper<br>
*> Hessenberg form using unitary transformations, where A is a<br>
*> general matrix and B is upper triangular.  The form of the generalized<br>
*> eigenvalue problem is<br>
*>    A*x = lambda*B*x,<br>
*> and B is typically made upper triangular by computing its QR<br>
*> factorization and moving the unitary matrix Q to the left side<br>
*> of the equation.<br>
...
*>      Q1 * B * Z1**H = (Q1*Q) * T * (Z1*Z)**H<br>
*> If Q1 is the unitary matrix from the QR factorization of B in the<br>
*> original equation A*x = lambda*B*x, then CGGHRD reduces the original<br>
*> problem to generalized Hessenberg form.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
/**
*> \brief <b> CGGLSE solves overdetermined or underdetermined systems for OTHER matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGGLSE + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgglse.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgglse.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgglse.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGGLSE( M, N, P, A, LDA, B, LDB, C, D, X, WORK, LWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LDB, LWORK, M, N, P<br>
...
*> \verbatim<br>
*><br>
*> CGGLSE solves the linear equality-constrained least squares (LSE)<br>
*> problem:<br>
*><br>
...
*> \param[in,out] C<br>
*> \verbatim<br>
*>          C is COMPLEX array, dimension (M)<br>
...
*> \param[in,out] D<br>
*> \verbatim<br>
*>          D is COMPLEX array, dimension (P)<br>
...
*<br>
*> \htmlonly<br>
*> Download CGGQRF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cggqrf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cggqrf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cggqrf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGGQRF( N, M, P, A, LDA, TAUA, B, LDB, TAUB, WORK,<br>
*                          LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LDB, LWORK, M, N, P<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       COMPLEX            A( LDA, * ), B( LDB, * ), TAUA( * ), TAUB( * ),<br>
*      $                   WORK( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> CGGQRF computes a generalized QR factorization of an N-by-M matrix A<br>
...
*><br>
*> where inv(B) denotes the inverse of the matrix B, and Z' denotes the<br>
...
*> \param[out] TAUA<br>
*> \verbatim<br>
*>          TAUA is COMPLEX array, dimension (min(N,M))<br>
*>          The scalar factors of the elementary reflectors which<br>
*>          represent the unitary matrix Q (see Further Details).<br>
*> \endverbatim<br>
*><br>
...
*> \param[out] TAUB<br>
*> \verbatim<br>
*>          TAUB is COMPLEX array, dimension (min(N,P))<br>
*>          The scalar factors of the elementary reflectors which<br>
...
*>          blocksize for a call of CUNMQR.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates the optimal size of the WORK array, returns<br>
*>          this value as the first entry of the WORK array, and no error<br>
...
*>  To form Q explicitly, use LAPACK subroutine CUNGQR.<br>
*>  To use Q to update another matrix, use LAPACK subroutine CUNMQR.<br>
*><br>
...
*>  To form Z explicitly, use LAPACK subroutine CUNGRQ.<br>
*>  To use Z to update another matrix, use LAPACK subroutine CUNMRQ.<br>
*> \endverbatim<br>
*><br>
*  =====================================================================<br>
*/
...
*<br>
*> \htmlonly<br>
*> Download CGGRQF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cggrqf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cggrqf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cggrqf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGGRQF( M, P, N, A, LDA, TAUA, B, LDB, TAUB, WORK,<br>
*                          LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LDB, LWORK, M, N, P<br>
...
*> \verbatim<br>
*><br>
*> CGGRQF computes a generalized RQ factorization of an M-by-N matrix A<br>
...
*> \param[out] TAUA<br>
*> \verbatim<br>
*>          TAUA is COMPLEX array, dimension (min(M,N))<br>
*>          The scalar factors of the elementary reflectors which<br>
*>          represent the unitary matrix Q (see Further Details).<br>
*> \endverbatim<br>
*><br>
...
*> \param[out] TAUB<br>
*> \verbatim<br>
*>          TAUB is COMPLEX array, dimension (min(P,N))<br>
*>          The scalar factors of the elementary reflectors which<br>
*>          represent the unitary matrix Z (see Further Details).<br>
*> \endverbatim<br>
*><br>
...
*>          blocksize for a call of CUNMRQ.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates the optimal size of the WORK array, returns<br>
*>          this value as the first entry of the WORK array, and no error<br>
...
*>  To form Q explicitly, use LAPACK subroutine CUNGRQ.<br>
...
/**
*> \brief <b> CGGSVD3 computes the singular value decomposition (SVD) for OTHER matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGGSVD3 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cggsvd3.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cggsvd3.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cggsvd3.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGGSVD3( JOBU, JOBV, JOBQ, M, N, P, K, L, A, LDA, B,<br>
...
*> \verbatim<br>
*><br>
*> CGGSVD3 computes the generalized singular value decomposition (GSVD)<br>
...
*> \param[out] U<br>
*> \verbatim<br>
*>          U is COMPLEX array, dimension (LDU,M)<br>
...
*> \param[out] V<br>
*> \verbatim<br>
*>          V is COMPLEX array, dimension (LDV,P)<br>
...
*>                converge.  For further details, see subroutine CTGSJA.<br>
*> \endverbatim<br>
*<br>
*> \par Internal Parameters:<br>
*  =========================<br>
...
*  =====================<br>
*><br>
*>  CGGSVD3 replaces the deprecated subroutine CGGSVD.<br>
*><br>
*  =====================================================================<br>
*/
...
*<br>
*> \htmlonly<br>
*> Download CGGSVP3 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cggsvp3.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cggsvp3.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cggsvp3.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGGSVP3( JOBU, JOBV, JOBQ, M, P, N, A, LDA, B, LDB,<br>
...
*> \verbatim<br>
*><br>
*> CGGSVP3 computes unitary matrices U, V and Q such that<br>
*><br>
*>                    N-K-L  K    L<br>
...
*> \param[out] TAU<br>
*> \verbatim<br>
*>          TAU is COMPLEX array, dimension (N)<br>
*> \endverbatim<br>
*><br>
*> \param[out] WORK<br>
*> \verbatim<br>
...
*> \verbatim<br>
*><br>
*>  The subroutine uses LAPACK subroutine CGEQP3 for the QR factorization<br>
...
*><br>
*>  CGGSVP3 replaces the deprecated subroutine CGGSVP.<br>
*><br>
*> \endverbatim<br>
*><br>
*  =====================================================================<br>
...
/**
*> \brief \b CGSVJ0 pre-processor for the routine cgesvj.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGSVJ0 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgsvj0.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgsvj0.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgsvj0.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGSVJ0( JOBV, M, N, A, LDA, D, SVA, MV, V, LDV, EPS,<br>
*                          SFMIN, TOL, NSWEEP, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LDV, LWORK, M, MV, N, NSWEEP<br>
*       REAL               EPS, SFMIN, TOL<br>
*       CHARACTER*1        JOBV<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       COMPLEX            A( LDA, * ), D( N ), V( LDV, * ), WORK( LWORK )<br>
*       REAL               SVA( N )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> CGSVJ0 is called from CGESVJ as a pre-processor and that is its main<br>
*> purpose. It applies Jacobi rotations in the same way as CGESVJ does, but<br>
...
*> \verbatim<br>
*>          EPS is REAL<br>
*>          EPS = SLAMCH('Epsilon')<br>
*> \endverbatim<br>
*><br>
*> \param[in] SFMIN<br>
*> \verbatim<br>
*>          SFMIN is REAL<br>
*>          SFMIN = SLAMCH('Safe Minimum')<br>
*> \endverbatim<br>
*><br>
*> \param[in] TOL<br>
*> \verbatim<br>
...
*  =====================<br>
*><br>
*> CGSVJ0 is used just to enable CGESVJ to call a simplified version of<br>
...
*<br>
*> \htmlonly<br>
*> Download CGSVJ1 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgsvj1.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgsvj1.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgsvj1.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGSVJ1( JOBV, M, N, N1, A, LDA, D, SVA, MV, V, LDV,<br>
...
*> \verbatim<br>
*><br>
*> CGSVJ1 is called from CGESVJ as a pre-processor and that is its main<br>
*> purpose. It applies Jacobi rotations in the same way as CGESVJ does, but<br>
...
*> Further Details<br>
*> ~~~~~~~~~~~~~~~<br>
*> CGSVJ1 applies few sweeps of Jacobi rotations in the column space of<br>
...
*<br>
*> \htmlonly<br>
*> Download CGTCON + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgtcon.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgtcon.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgtcon.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGTCON( NORM, N, DL, D, DU, DU2, IPIV, ANORM, RCOND,<br>
*                          WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          NORM<br>
...
*> \verbatim<br>
*><br>
*> CGTCON estimates the reciprocal of the condition number of a complex<br>
...
*>          LU factorization of A as computed by CGTTRF.<br>
*> \endverbatim<br>
*><br>
*> \param[in] D<br>
*> \verbatim<br>
...
*> \param[in] DU2<br>
*> \verbatim<br>
*>          DU2 is COMPLEX array, dimension (N-2)<br>
...
*> \date September 2012<br>
*<br>
*> \ingroup complexGTcomputational<br>
*<br>
*  =====================================================================<br>
*/
...
*<br>
*> \htmlonly<br>
*> Download CGTRFS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgtrfs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgtrfs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgtrfs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGTRFS( TRANS, N, NRHS, DL, D, DU, DLF, DF, DUF, DU2,<br>
*                          IPIV, B, LDB, X, LDX, FERR, BERR, WORK, RWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> CGTRFS improves the computed solution to a system of linear<br>
...
*> \param[in] DLF<br>
*> \verbatim<br>
*>          DLF is COMPLEX array, dimension (N-1)<br>
*>          The (n-1) multipliers that define the matrix L from the<br>
*>          LU factorization of A as computed by CGTTRF.<br>
*> \endverbatim<br>
*><br>
*> \param[in] DF<br>
*> \verbatim<br>
*>          DF is COMPLEX array, dimension (N)<br>
*>          The n diagonal elements of the upper triangular matrix U from<br>
*>          the LU factorization of A.<br>
*> \endverbatim<br>
*><br>
*> \param[in] DUF<br>
*> \verbatim<br>
*>          DUF is COMPLEX array, dimension (N-1)<br>
*>          The (n-1) elements of the first superdiagonal of U.<br>
*> \endverbatim<br>
*><br>
*> \param[in] DU2<br>
...
*> \verbatim<br>
*>          X is COMPLEX array, dimension (LDX,NRHS)<br>
*>          On entry, the solution matrix X, as computed by CGTTRS.<br>
*>          On exit, the improved solution matrix X.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDX<br>
...
/**
*> \brief <b> CGTSV computes the solution to system of linear equations A * X = B for GT matrices <b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGTSV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgtsv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgtsv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgtsv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGTSV( N, NRHS, DL, D, DU, B, LDB, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \date September 2012<br>
*<br>
*> \ingroup complexGTsolve<br>
*<br>
*  =====================================================================<br>
*/
	public void cgtsv_(INTEGER N,INTEGER NRHS,float[] DL,float[] D,float[] DU,float[] B,INTEGER LDB,INTEGER INFO);
/**
*> \brief <b> CGTSVX computes the solution to system of linear equations A * X = B for GT matrices <b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGTSVX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgtsvx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgtsvx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgtsvx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGTSVX( FACT, TRANS, N, NRHS, DL, D, DU, DLF, DF, DUF,<br>
...
*> \verbatim<br>
*><br>
*> CGTSVX uses the LU factorization to compute the solution to a complex<br>
*> system of linear equations A * X = B, A**T * X = B, or A**H * X = B,<br>
...
*>          the LU factorization of A as computed by CGTTRF.<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download CGTTRF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgttrf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgttrf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgttrf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGTTRF( N, DL, D, DU, DU2, IPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> CGTTRF computes an LU factorization of a complex tridiagonal matrix A<br>
...
*<br>
*> \htmlonly<br>
*> Download CGTTRS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgttrs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgttrs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgttrs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGTTRS( TRANS, N, NRHS, DL, D, DU, DU2, IPIV, B, LDB,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANS<br>
...
*> \verbatim<br>
*><br>
*> CGTTRS solves one of the systems of equations<br>
*>    A * X = B,  A**T * X = B,  or  A**H * X = B,<br>
...
/**
*> \brief \b CGTTS2 solves a system of linear equations with a tridiagonal matrix using the LU factorization computed by sgttrf.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download CGTTS2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgtts2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgtts2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgtts2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CGTTS2( ITRANS, N, NRHS, DL, D, DU, DU2, IPIV, B, LDB )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> CGTTS2 solves one of the systems of equations<br>
*>    A * X = B,  A**T * X = B,  or  A**H * X = B,<br>
*> with a tridiagonal matrix A using the LU factorization computed<br>
*> by CGTTRF.<br>
*> \endverbatim<br>
