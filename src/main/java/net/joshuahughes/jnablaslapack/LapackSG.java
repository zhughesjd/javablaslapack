...
*<br>
*> \htmlonly<br>
*> Download SGBBRD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgbbrd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgbbrd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgbbrd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGBBRD( VECT, M, N, NCC, KL, KU, AB, LDAB, D, E, Q,<br>
...
*> \verbatim<br>
*><br>
*> SGBBRD reduces a real general m-by-n band matrix A to upper<br>
...
*> \param[out] Q<br>
*> \verbatim<br>
*>          Q is REAL array, dimension (LDQ,M)<br>
...
*> \param[out] PT<br>
*> \verbatim<br>
*>          PT is REAL array, dimension (LDPT,N)<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is REAL array, dimension (2*max(M,N))<br>
*> \endverbatim<br>
*><br>
*> \param[out] INFO<br>
*> \verbatim<br>
...
*<br>
*> \htmlonly<br>
*> Download SGBCON + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgbcon.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgbcon.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgbcon.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGBCON( NORM, N, KL, KU, AB, LDAB, IPIV, ANORM, RCOND,<br>
*                          WORK, IWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          NORM<br>
...
*> \verbatim<br>
*><br>
*> SGBCON estimates the reciprocal of the condition number of a real<br>
*> general band matrix A, in either the 1-norm or the infinity-norm,<br>
*> using the LU factorization computed by SGBTRF.<br>
*><br>
...
*>          computed by SGBTRF.  U is stored as an upper triangular band<br>
...
*<br>
*> \htmlonly<br>
*> Download SGBEQU + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgbequ.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgbequ.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgbequ.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGBEQU( M, N, KL, KU, AB, LDAB, R, C, ROWCND, COLCND,<br>
*                          AMAX, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> SGBEQU computes row and column scalings intended to equilibrate an<br>
...
*<br>
*> \htmlonly<br>
*> Download SGBEQUB + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgbequb.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgbequb.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgbequb.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGBEQUB( M, N, KL, KU, AB, LDAB, R, C, ROWCND, COLCND,<br>
*                           AMAX, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, KL, KU, LDAB, M, N<br>
...
*> \verbatim<br>
*><br>
*> SGBEQUB computes row and column scalings intended to equilibrate an<br>
...
*><br>
*> This routine differs from SGEEQU by restricting the scaling factors<br>
...
*<br>
*> \htmlonly<br>
*> Download SGBRFS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgbrfs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgbrfs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgbrfs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGBRFS( TRANS, N, KL, KU, NRHS, AB, LDAB, AFB, LDAFB,<br>
...
*> \verbatim<br>
*><br>
*> SGBRFS improves the computed solution to a system of linear<br>
...
*> \verbatim<br>
*>          IPIV is INTEGER array, dimension (N)<br>
*>          The pivot indices from SGBTRF; for 1<=i<=N, row i of the<br>
...
*<br>
*> \htmlonly<br>
*> Download SGBRFSX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgbrfsx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgbrfsx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgbrfsx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGBRFSX( TRANS, EQUED, N, KL, KU, NRHS, AB, LDAB, AFB,<br>
...
*> \verbatim<br>
*><br>
*>    SGBRFSX improves the computed solution to a system of linear<br>
...
/**
*> \brief <b> SGBSV computes the solution to system of linear equations A * X = B for GB matrices</b> (simple driver)<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGBSV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgbsv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgbsv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgbsv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGBSV( N, KL, KU, NRHS, AB, LDAB, IPIV, B, LDB, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> SGBSV computes the solution to a real system of linear equations<br>
...
/**
*> \brief <b> SGBSVX computes the solution to system of linear equations A * X = B for GB matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGBSVX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgbsvx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgbsvx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgbsvx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGBSVX( FACT, TRANS, N, KL, KU, NRHS, AB, LDAB, AFB,<br>
...
*> \verbatim<br>
*><br>
*> SGBSVX uses the LU factorization to compute the solution to a real<br>
...
*>          A, as computed by SGBTRF.  U is stored as an upper triangular<br>
...
/**
*> \brief <b> SGBSVXX computes the solution to system of linear equations A * X = B for GB matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGBSVXX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgbsvxx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgbsvxx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgbsvxx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGBSVXX( FACT, TRANS, N, KL, KU, NRHS, AB, LDAB, AFB,<br>
*                           LDAFB, IPIV, EQUED, R, C, B, LDB, X, LDX,<br>
...
*> \verbatim<br>
*><br>
*>    SGBSVXX uses the LU factorization to compute the solution to a<br>
*>    real system of linear equations  A * X = B,  where A is an<br>
*>    N-by-N matrix and X and B are N-by-NRHS matrices.<br>
*><br>
*>    If requested, both normwise and maximum componentwise error bounds<br>
*>    are returned. SGBSVXX will return a solution with a tiny<br>
...
*><br>
*>    SGBSVXX accepts user-provided factorizations and equilibration<br>
...
*>    SGBSVXX call will also produce a solution with either O(eps)<br>
...
*>    differ from what SGBSVXX would itself produce.<br>
*> \endverbatim<br>
*<br>
*> \par Description:<br>
*  =================<br>
...
/**
*> \brief \b SGBTF2 computes the LU factorization of a general band matrix using the unblocked version of the algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGBTF2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgbtf2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgbtf2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgbtf2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGBTF2( M, N, KL, KU, AB, LDAB, IPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, KL, KU, LDAB, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGBTF2 computes an LU factorization of a real m-by-n band matrix A<br>
...
*<br>
*> \htmlonly<br>
*> Download SGBTRF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgbtrf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgbtrf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgbtrf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGBTRF( M, N, KL, KU, AB, LDAB, IPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, KL, KU, LDAB, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGBTRF computes an LU factorization of a real m-by-n band matrix A<br>
*> using partial pivoting with row interchanges.<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download SGBTRS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgbtrs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgbtrs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgbtrs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGBTRS( TRANS, N, KL, KU, NRHS, AB, LDAB, IPIV, B, LDB,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANS<br>
...
*> \verbatim<br>
*><br>
*> SGBTRS solves a system of linear equations<br>
*>    A * X = B  or  A**T * X = B<br>
...
*<br>
*> \htmlonly<br>
*> Download SGEBAK + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgebak.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgebak.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgebak.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEBAK( JOB, SIDE, N, ILO, IHI, SCALE, M, V, LDV,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> SGEBAK forms the right or left eigenvectors of a real general matrix<br>
*> by backward transformation on the computed eigenvectors of the<br>
*> balanced matrix output by SGEBAL.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*>                 scaling.<br>
*>          JOB must be the same as the argument JOB supplied to SGEBAL.<br>
*> \endverbatim<br>
*><br>
*> \param[in] SIDE<br>
*> \verbatim<br>
...
*> \verbatim<br>
*>          IHI is INTEGER<br>
*>          The integers ILO and IHI determined by SGEBAL.<br>
...
*> \param[in,out] V<br>
*> \verbatim<br>
*>          V is REAL array, dimension (LDV,M)<br>
*>          On entry, the matrix of right or left eigenvectors to be<br>
*>          transformed, as returned by SHSEIN or STREVC.<br>
...
*<br>
*> \htmlonly<br>
*> Download SGEBAL + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgebal.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgebal.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgebal.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEBAL( JOB, N, A, LDA, ILO, IHI, SCALE, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          JOB<br>
...
*> \verbatim<br>
*><br>
*> SGEBAL balances a general real matrix A.  This involves, first,<br>
...
/**
*> \brief \b SGEBD2 reduces a general matrix to bidiagonal form using an unblocked algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGEBD2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgebd2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgebd2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgebd2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEBD2( M, N, A, LDA, D, E, TAUQ, TAUP, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> SGEBD2 reduces a real general m by n matrix A to upper or lower<br>
*> bidiagonal form B by an orthogonal transformation: Q**T * A * P = B.<br>
*><br>
...
*> \param[out] TAUQ<br>
*> \verbatim<br>
*>          TAUQ is REAL array dimension (min(M,N))<br>
...
*> \param[out] TAUP<br>
*> \verbatim<br>
*>          TAUP is REAL array, dimension (min(M,N))<br>
*>          The scalar factors of the elementary reflectors which<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is REAL array, dimension (max(M,N))<br>
*> \endverbatim<br>
*><br>
*> \param[out] INFO<br>
*> \verbatim<br>
...
*<br>
*> \htmlonly<br>
*> Download SGEBRD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgebrd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgebrd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgebrd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEBRD( M, N, A, LDA, D, E, TAUQ, TAUP, WORK, LWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> SGEBRD reduces a general real M-by-N matrix A to upper or lower<br>
*> bidiagonal form B by an orthogonal transformation: Q**T * A * P = B.<br>
*><br>
*> If m >= n, B is upper bidiagonal; if m < n, B is lower bidiagonal.<br>
*> \endverbatim<br>
...
*<br>
*> \htmlonly<br>
*> Download SGECON + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgecon.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgecon.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgecon.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGECON( NORM, N, A, LDA, ANORM, RCOND, WORK, IWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          NORM<br>
...
*> \verbatim<br>
*><br>
*> SGECON estimates the reciprocal of the condition number of a general<br>
*> real matrix A, in either the 1-norm or the infinity-norm, using<br>
*> the LU factorization computed by SGETRF.<br>
*><br>
*> An estimate is obtained for norm(inv(A)), and the reciprocal of the<br>
*> condition number is computed as<br>
*>    RCOND = 1 / ( norm(A) * norm(inv(A)) ).<br>
...
*<br>
*> \htmlonly<br>
*> Download SGEEQU + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgeequ.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgeequ.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgeequ.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEEQU( M, N, A, LDA, R, C, ROWCND, COLCND, AMAX,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
...
*> \verbatim<br>
*><br>
*> SGEEQU computes row and column scalings intended to equilibrate an<br>
*> M-by-N matrix A and reduce its condition number.  R returns the row<br>
*> scale factors and C the column scale factors, chosen to try to make<br>
*> the largest element in each row and column of the matrix B with<br>
*> elements B(i,j)=R(i)*A(i,j)*C(j) have absolute value 1.<br>
...
*<br>
*> \htmlonly<br>
*> Download SGEEQUB + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgeequb.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgeequb.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgeequb.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEEQUB( M, N, A, LDA, R, C, ROWCND, COLCND, AMAX,<br>
*                           INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
...
*> \verbatim<br>
*><br>
*> SGEEQUB computes row and column scalings intended to equilibrate an<br>
*> M-by-N matrix A and reduce its condition number.  R returns the row<br>
*> scale factors and C the column scale factors, chosen to try to make<br>
*> the largest element in each row and column of the matrix B with<br>
*> elements B(i,j)=R(i)*A(i,j)*C(j) have an absolute value of at most<br>
...
/**
*> \brief <b> SGEES computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGEES + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgees.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgees.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgees.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEES( JOBVS, SORT, SELECT, N, A, LDA, SDIM, WR, WI,<br>
...
*> \verbatim<br>
*><br>
*> SGEES computes for an N-by-N real nonsymmetric matrix A, the<br>
...
*> \param[in] SELECT<br>
*> \verbatim<br>
*>          SELECT is LOGICAL FUNCTION of two REAL arguments<br>
...
*> \param[out] VS<br>
*> \verbatim<br>
*>          VS is REAL array, dimension (LDVS,N)<br>
...
/**
*> \brief <b> SGEESX computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGEESX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgeesx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgeesx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgeesx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEESX( JOBVS, SORT, SELECT, SENSE, N, A, LDA, SDIM,<br>
...
*> \verbatim<br>
*><br>
*> SGEESX computes for an N-by-N real nonsymmetric matrix A, the<br>
*> eigenvalues, the real Schur form T, and, optionally, the matrix of<br>
*> Schur vectors Z.  This gives the Schur factorization A = Z*T*(Z**T).<br>
*><br>
*> Optionally, it also orders the eigenvalues on the diagonal of the<br>
...
*> \param[in] SELECT<br>
*> \verbatim<br>
*>          SELECT is a LOGICAL FUNCTION of two REAL arguments<br>
*>          SELECT must be declared EXTERNAL in the calling subroutine.<br>
*>          If SORT = 'S', SELECT is used to select eigenvalues to sort<br>
*>          to the top left of the Schur form.<br>
*>          If SORT = 'N', SELECT is not referenced.<br>
...
/**
*> \brief <b> SGEEV computes the eigenvalues and, optionally, the left and/or right eigenvectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGEEV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgeev.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgeev.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgeev.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEEV( JOBVL, JOBVR, N, A, LDA, WR, WI, VL, LDVL, VR,<br>
...
*> \verbatim<br>
*><br>
*> SGEEV computes for an N-by-N real nonsymmetric matrix A, the<br>
...
*> \param[out] VL<br>
*> \verbatim<br>
*>          VL is REAL array, dimension (LDVL,N)<br>
...
*> \param[out] VR<br>
*> \verbatim<br>
*>          VR is REAL array, dimension (LDVR,N)<br>
...
*> \date June 2016<br>
*<br>
*  @generated from dgeev.f, fortran d -> s, Tue Apr 19 01:47:44 2016<br>
*<br>
*> \ingroup realGEeigen<br>
*<br>
*  =====================================================================<br>
...
/**
*> \brief <b> SGEEVX computes the eigenvalues and, optionally, the left and/or right eigenvectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGEEVX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgeevx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgeevx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgeevx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEEVX( BALANC, JOBVL, JOBVR, SENSE, N, A, LDA, WR, WI,<br>
...
*> \verbatim<br>
*><br>
*> SGEEVX computes for an N-by-N real nonsymmetric matrix A, the<br>
*> eigenvalues and, optionally, the left and/or right eigenvectors.<br>
*><br>
...
*> \date June 2016<br>
*<br>
*  @generated from dgeevx.f, fortran d -> s, Tue Apr 19 01:47:44 2016<br>
*<br>
*> \ingroup realGEeigen<br>
*<br>
*  =====================================================================<br>
...
/**
*> \brief \b SGEHD2 reduces a general square matrix to upper Hessenberg form using an unblocked algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGEHD2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgehd2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgehd2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgehd2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEHD2( N, ILO, IHI, A, LDA, TAU, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            IHI, ILO, INFO, LDA, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGEHD2 reduces a real general matrix A to upper Hessenberg form H by<br>
...
*>          set by a previous call to SGEBAL; otherwise they should be<br>
...
*<br>
*> \htmlonly<br>
*> Download SGEHRD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgehrd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgehrd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgehrd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEHRD( N, ILO, IHI, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> SGEHRD reduces a real general matrix A to upper Hessenberg form H by<br>
*> an orthogonal similarity transformation:  Q**T * A * Q = H .<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download SGEJSV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgejsv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgejsv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgejsv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEJSV( JOBA, JOBU, JOBV, JOBR, JOBT, JOBP,<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       REAL        A( LDA, * ), SVA( N ), U( LDU, * ), V( LDV, * ),<br>
*      $            WORK( LWORK )<br>
*       INTEGER     IWORK( * )<br>
...
*> \verbatim<br>
*><br>
*> SGEJSV computes the singular value decomposition (SVD) of a real M-by-N<br>
...
*> SGEJSV can sometimes compute tiny singular values and their singular vectors much<br>
...
*>              is greater than BIG, use SGESVJ.<br>
...
*> \param[out] V<br>
*> \verbatim<br>
*>          V is REAL array, dimension ( LDV, N )<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is REAL array, dimension at least LWORK.<br>
*>          On exit,<br>
...
*>                    SCONDA is an estimate of SQRT(||(R^t * R)^(-1)||_1).<br>
...
*>               where NB is the optimal block size for DGEQP3, DGEQRF, DGELQ,<br>
*>               DORMLQ. In general, the optimal length LWORK is computed as<br>
*>               LWORK >= max(2*M+N,N+LWORK(DGEQP3), N+LWORK(DPOCON), <br>
*>                       N+LWORK(DGELQ), 2*N+LWORK(DGEQRF), N+LWORK(DORMLQ)).<br>
*><br>
...
*>           > 0 :  SGEJSV  did not converge in the maximal allowed number<br>
...
*> \verbatim<br>
*><br>
*>  SGEJSV implements a preconditioned Jacobi SVD algorithm. It uses SGEQP3,<br>
*>  SGEQRF, and SGELQF as preprocessors and preconditioners. Optionally, an<br>
...
*>  & LAPACK routines called by SGEJSV are implemented to work in that range.<br>
...
*>  overflow. This code (SGEJSV) is best used in this restricted range,<br>
...
*>  the choice of some tuning parameters in the iterative part (SGESVJ) is<br>
*>  left to the implementer on a particular machine.<br>
*>     The rank revealing QR factorization (in this code: SGEQP3) should be<br>
*>  implemented as in [3]. We have a new version of SGEQP3 under development<br>
...
*>  well known trick is not used in SGEJSV because in some cases heavy row<br>
...
*>  implementation of SGEJSV uses only the simplest, naive data movement.<br>
*> \endverbatim<br>
*<br>
*> \par Contributors:<br>
*  ==================<br>
...
*<br>
*> \htmlonly<br>
*> Download SGELQ2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgelq2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgelq2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgelq2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGELQ2( M, N, A, LDA, TAU, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGELQ2 computes an LQ factorization of a real m by n matrix A:<br>
*> A = L * Q.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download SGELQF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgelqf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgelqf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgelqf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGELQF( M, N, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LWORK, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGELQF computes an LQ factorization of a real M-by-N matrix A:<br>
*> A = L * Q.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
/**
*> \brief <b> SGELS solves overdetermined or underdetermined systems for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGELS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgels.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgels.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgels.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGELS( TRANS, M, N, NRHS, A, LDA, B, LDB, WORK, LWORK,<br>
*                         INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANS<br>
...
*> \verbatim<br>
*><br>
*> SGELS solves overdetermined or underdetermined real linear systems<br>
...
*>                       factorization as returned by SGELQF.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDA<br>
*> \verbatim<br>
...
/**
*> \brief <b> SGELSD computes the minimum-norm solution to a linear least squares problem for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGELSD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgelsd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgelsd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgelsd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGELSD( M, N, NRHS, A, LDA, B, LDB, S, RCOND,<br>
*                          RANK, WORK, LWORK, IWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> SGELSD computes the minimum-norm solution to a real linear least<br>
*> squares problem:<br>
...
*>          minimum size of the array IWORK, and returns these values as<br>
*>          the first entries of the WORK and IWORK arrays, and no error<br>
*>          message related to LWORK is issued by XERBLA.<br>
*> \endverbatim<br>
*><br>
*> \param[out] IWORK<br>
...
/**
*> \brief <b> SGELSS solves overdetermined or underdetermined systems for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGELSS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgelss.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgelss.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgelss.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGELSS( M, N, NRHS, A, LDA, B, LDB, S, RCOND, RANK,<br>
*                          WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LDB, LWORK, M, N, NRHS, RANK<br>
...
*> \verbatim<br>
*><br>
*> SGELSS computes the minimum norm solution to a real linear least<br>
*> squares problem:<br>
*><br>
*> Minimize 2-norm(| b - A*x |).<br>
*><br>
...
/**
*> \brief <b> SGELSY solves overdetermined or underdetermined systems for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGELSY + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgelsy.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgelsy.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgelsy.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGELSY( M, N, NRHS, A, LDA, B, LDB, JPVT, RCOND, RANK,<br>
*                          WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LDB, LWORK, M, N, NRHS, RANK<br>
...
*> \verbatim<br>
*><br>
*> SGELSY computes the minimum-norm solution to a real linear least<br>
*> squares problem:<br>
*>     minimize || A * X - B ||<br>
...
*>          by ILAENV for the routines SGEQP3, STZRZF, STZRQF, SORMQR,<br>
*>          and SORMRZ.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates the optimal size of the WORK array, returns<br>
...
*<br>
*> \htmlonly<br>
*> Download SGEMQRT + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgemqrt.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgemqrt.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgemqrt.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEMQRT( SIDE, TRANS, M, N, K, NB, V, LDV, T, LDT, <br>
*                          C, LDC, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       REAL   V( LDV, * ), C( LDC, * ), T( LDT, * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> SGEMQRT overwrites the general real M-by-N matrix C with<br>
*><br>
*>                 SIDE = 'L'     SIDE = 'R'<br>
*> TRANS = 'N':      Q C            C Q<br>
...
*><br>
*> generated using the compact WY representation as returned by SGEQRT. <br>
*><br>
...
*> \param[in] V<br>
*> \verbatim<br>
*>          V is REAL array, dimension (LDV,K)<br>
...
/**
*> \brief \b SGEQL2 computes the QL factorization of a general rectangular matrix using an unblocked algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGEQL2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgeql2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgeql2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgeql2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEQL2( M, N, A, LDA, TAU, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGEQL2 computes a QL factorization of a real m by n matrix A:<br>
*> A = Q * L.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download SGEQLF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgeqlf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgeqlf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgeqlf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEQLF( M, N, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LWORK, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGEQLF computes a QL factorization of a real M-by-N matrix A:<br>
*> A = Q * L.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download SGEQP3 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgeqp3.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgeqp3.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgeqp3.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEQP3( M, N, A, LDA, JPVT, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LWORK, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGEQP3 computes a QR factorization with column pivoting of a<br>
...
/**
*> \brief \b SGEQR2 computes the QR factorization of a general rectangular matrix using an unblocked algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGEQR2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgeqr2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgeqr2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgeqr2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEQR2( M, N, A, LDA, TAU, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGEQR2 computes a QR factorization of a real m by n matrix A:<br>
*> A = Q * R.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
/**
*> \brief \b SGEQR2P computes the QR factorization of a general rectangular matrix with non-negative diagonal elements using an unblocked algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGEQR2P + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgeqr2p.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgeqr2p.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgeqr2p.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEQR2P( M, N, A, LDA, TAU, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGEQR2P computes a QR factorization of a real m by n matrix A:<br>
...
*<br>
*> \htmlonly<br>
*> Download SGEQRF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgeqrf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgeqrf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgeqrf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEQRF( M, N, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LWORK, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGEQRF computes a QR factorization of a real M-by-N matrix A:<br>
*> A = Q * R.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download SGEQRFP + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgeqrfp.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgeqrfp.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgeqrfp.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEQRFP( M, N, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LWORK, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGEQRFP computes a QR factorization of a real M-by-N matrix A:<br>
*> A = Q * R. The diagonal entries of R are nonnegative.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download SGEQRT + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgeqrt.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgeqrt.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgeqrt.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEQRT( M, N, NB, A, LDA, T, LDT, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER INFO, LDA, LDT, M, N, NB<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       REAL A( LDA, * ), T( LDT, * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> SGEQRT computes a blocked QR factorization of a real M-by-N matrix A<br>
...
*> \param[out] T<br>
*> \verbatim<br>
*>          T is REAL array, dimension (LDT,MIN(M,N))<br>
...
/**
*> \brief \b SGEQRT2 computes a QR factorization of a general real or complex matrix using the compact WY representation of Q.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGEQRT2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgeqrt2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgeqrt2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgeqrt2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGEQRT2( M, N, A, LDA, T, LDT, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> SGEQRT2 computes a QR factorization of a real M-by-N matrix A, <br>
*> using the compact WY representation of Q. <br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
/**
*> \brief \b SGEQRT3 recursively computes a QR factorization of a general real or complex matrix using the compact WY representation of Q.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGEQRT3 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgeqrt3.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgeqrt3.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgeqrt3.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       RECURSIVE SUBROUTINE SGEQRT3( M, N, A, LDA, T, LDT, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> SGEQRT3 recursively computes a QR factorization of a real M-by-N <br>
...
*<br>
*> \htmlonly<br>
*> Download SGERFS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgerfs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgerfs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgerfs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGERFS( TRANS, N, NRHS, A, LDA, AF, LDAF, IPIV, B, LDB,<br>
...
*> \verbatim<br>
*><br>
*> SGERFS improves the computed solution to a system of linear<br>
...
*<br>
*> \htmlonly<br>
*> Download SGERFSX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgerfsx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgerfsx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgerfsx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGERFSX( TRANS, EQUED, N, NRHS, A, LDA, AF, LDAF, IPIV,<br>
...
*> \verbatim<br>
*><br>
*>    SGERFSX improves the computed solution to a system of linear<br>
*>    equations and provides error bounds and backward error estimates<br>
*>    for the solution.  In addition to normwise error bound, the code<br>
*>    provides maximum componentwise error bound if possible.  See<br>
*>    comments for ERR_BNDS_NORM and ERR_BNDS_COMP for details of the<br>
...
/**
*> \brief \b SGERQ2 computes the RQ factorization of a general rectangular matrix using an unblocked algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGERQ2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgerq2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgerq2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgerq2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGERQ2( M, N, A, LDA, TAU, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGERQ2 computes an RQ factorization of a real m by n matrix A:<br>
*> A = R * Q.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download SGERQF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgerqf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgerqf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgerqf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGERQF( M, N, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LWORK, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGERQF computes an RQ factorization of a real M-by-N matrix A:<br>
*> A = R * Q.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
/**
*> \brief \b SGESC2 solves a system of linear equations using the LU factorization with complete pivoting computed by sgetc2.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGESC2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgesc2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgesc2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgesc2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGESC2( N, A, LDA, RHS, IPIV, JPIV, SCALE )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            LDA, N<br>
*       REAL               SCALE<br>
...
*> \verbatim<br>
*><br>
*> SGESC2 solves a system of linear equations<br>
*><br>
*>           A * X = scale* RHS<br>
*><br>
*> with a general N-by-N matrix A using the LU factorization with<br>
*> complete pivoting computed by SGETC2.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*>          matrix A computed by SGETC2:  A = P * L * U * Q<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDA<br>
*> \verbatim<br>
...
*<br>
*> \htmlonly<br>
*> Download SGESDD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgesdd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgesdd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgesdd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGESDD( JOBZ, M, N, A, LDA, S, U, LDU, VT, LDVT,<br>
*                          WORK, LWORK, IWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          JOBZ<br>
...
*> \verbatim<br>
*><br>
*> SGESDD computes the singular value decomposition (SVD) of a real<br>
...
*> \param[out] U<br>
*> \verbatim<br>
*>          U is REAL array, dimension (LDU,UCOL)<br>
...
*> \param[out] VT<br>
*> \verbatim<br>
*>          VT is REAL array, dimension (LDVT,N)<br>
...
*>          = 0:  successful exit.<br>
*>          < 0:  if INFO = -i, the i-th argument had an illegal value.<br>
*>          > 0:  SBDSDC did not converge, updating process failed.<br>
*> \endverbatim<br>
*<br>
*  Authors:<br>
*  ========<br>
...
/**
*> \brief <b> SGESV computes the solution to system of linear equations A * X = B for GE matrices</b> (simple driver)<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGESV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgesv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgesv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgesv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGESV( N, NRHS, A, LDA, IPIV, B, LDB, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> SGESV computes the solution to a real system of linear equations<br>
*>    A * X = B,<br>
...
/**
*> \brief <b> SGESVD computes the singular value decomposition (SVD) for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGESVD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgesvd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgesvd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgesvd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGESVD( JOBU, JOBVT, M, N, A, LDA, S, U, LDU, VT, LDVT,<br>
*                          WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> SGESVD computes the singular value decomposition (SVD) of a real<br>
...
*>          = 0:  successful exit.<br>
*>          < 0:  if INFO = -i, the i-th argument had an illegal value.<br>
*>          > 0:  if SBDSQR did not converge, INFO specifies how many<br>
...
/**
*> \brief <b> SGESVDX computes the singular value decomposition (SVD) for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGESVDX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgesvdx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgesvdx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgesvdx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*     SUBROUTINE SGESVDX( JOBU, JOBVT, RANGE, M, N, A, LDA, VL, VU, <br>
...
*> \verbatim<br>
*><br>
*>  SGESVDX computes the singular value decomposition (SVD) of a real<br>
*>  M-by-N matrix A, optionally computing the left and/or right singular<br>
*>  vectors. The SVD is written<br>
*> <br>
*>      A = U * SIGMA * transpose(V)<br>
...
*>  U and V are the left and right singular vectors of A.<br>
*> <br>
*>  SGESVDX uses an eigenvalue problem for obtaining the SVD, which <br>
...
*<br>
*> \htmlonly<br>
*> Download SGESVJ + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgesvj.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgesvj.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgesvj.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGESVJ( JOBA, JOBU, JOBV, M, N, A, LDA, SVA, MV, V,<br>
...
*> \verbatim<br>
*><br>
*> SGESVJ computes the singular value decomposition (SVD) of a real<br>
...
*> SGESVJ can sometimes compute tiny singular values and their singular vectors much<br>
*> more accurately than other SVD routines, see below under Further Details.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*>                 If INFO .GT. 0,<br>
*>                 the procedure SGESVJ did not converge in the given number<br>
...
*><br>
*>          If INFO .GT. 0 :<br>
*>          the procedure SGESVJ did not converge in the given number of<br>
...
*> \verbatim<br>
*>          MV is INTEGER<br>
*>          If JOBV .EQ. 'A', then the product of Jacobi rotations in SGESVJ<br>
...
*> \verbatim<br>
*>          WORK is REAL array, dimension max(4,M+N).<br>
*>          On entry,<br>
*>          If JOBU .EQ. 'C' :<br>
...
*>                    are the computed singular vcalues of A.<br>
...
*>                    This is useful information in cases when SGESVJ did<br>
...
*>          = 0 : successful exit.<br>
*>          < 0 : if INFO = -i, then the i-th argument had an illegal value<br>
*>          > 0 : SGESVJ did not converge in the maximal allowed number (30)<br>
...
*<br>
*> \htmlonly<br>
*> Download SGESVX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgesvx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgesvx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgesvx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGESVX( FACT, TRANS, N, NRHS, A, LDA, AF, LDAF, IPIV,<br>
...
*> \verbatim<br>
*><br>
*> SGESVX uses the LU factorization to compute the solution to a real<br>
...
*>          A = P*L*U as computed by SGETRF.  If EQUED .ne. 'N', then<br>
...
/**
*> \brief <b> SGESVXX computes the solution to system of linear equations A * X = B for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGESVXX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgesvxx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgesvxx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgesvxx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGESVXX( FACT, TRANS, N, NRHS, A, LDA, AF, LDAF, IPIV,<br>
...
*> \verbatim<br>
*><br>
*>    SGESVXX uses the LU factorization to compute the solution to a<br>
*>    real system of linear equations  A * X = B,  where A is an<br>
*>    N-by-N matrix and X and B are N-by-NRHS matrices.<br>
*><br>
*>    If requested, both normwise and maximum componentwise error bounds<br>
*>    are returned. SGESVXX will return a solution with a tiny<br>
*>    guaranteed error (O(eps) where eps is the working machine<br>
*>    precision) unless the matrix is very ill-conditioned, in which<br>
*>    case a warning is returned. Relevant condition numbers also are<br>
*>    calculated and returned.<br>
*><br>
*>    SGESVXX accepts user-provided factorizations and equilibration<br>
*>    factors; see the definitions of the FACT and EQUED options.<br>
*>    Solving with refinement and using a factorization from a previous<br>
*>    SGESVXX call will also produce a solution with either O(eps)<br>
*>    errors or warnings, but we cannot make that claim for general<br>
*>    user-provided factorizations and equilibration factors if they<br>
*>    differ from what SGESVXX would itself produce.<br>
*> \endverbatim<br>
*<br>
*> \par Description:<br>
*  =================<br>
...
/**
*> \brief \b SGETC2 computes the LU factorization with complete pivoting of the general n-by-n matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGETC2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgetc2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgetc2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgetc2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGETC2( N, A, LDA, IPIV, JPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGETC2 computes an LU factorization with complete pivoting of the<br>
...
/**
*> \brief \b SGETF2 computes the LU factorization of a general m-by-n matrix using partial pivoting with row interchanges (unblocked algorithm).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGETF2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgetf2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgetf2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgetf2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGETF2( M, N, A, LDA, IPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGETF2 computes an LU factorization of a general m-by-n matrix A<br>
*> using partial pivoting with row interchanges.<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download SGETRF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgetrf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgetrf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgetrf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGETRF( M, N, A, LDA, IPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGETRF computes an LU factorization of a general M-by-N matrix A<br>
*> using partial pivoting with row interchanges.<br>
*><br>
*> The factorization has the form<br>
*>    A = P * L * U<br>
...
*  ===========<br>
*<br>
*       RECURSIVE SUBROUTINE SGETRF2( M, N, A, LDA, IPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, M, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGETRF2 computes an LU factorization of a general M-by-N matrix A<br>
*> using partial pivoting with row interchanges.<br>
*><br>
*> The factorization has the form<br>
*>    A = P * L * U<br>
...
*<br>
*> \htmlonly<br>
*> Download SGETRI + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgetri.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgetri.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgetri.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGETRI( N, A, LDA, IPIV, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> SGETRI computes the inverse of a matrix using the LU factorization<br>
*> computed by SGETRF.<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download SGETRS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgetrs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgetrs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgetrs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGETRS( TRANS, N, NRHS, A, LDA, IPIV, B, LDB, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANS<br>
*       INTEGER            INFO, LDA, LDB, N, NRHS<br>
...
*> \verbatim<br>
*><br>
*> SGETRS solves a system of linear equations<br>
*>    A * X = B  or  A**T * X = B<br>
...
*<br>
*> \htmlonly<br>
*> Download SGGBAK + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sggbak.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sggbak.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sggbak.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGGBAK( JOB, SIDE, N, ILO, IHI, LSCALE, RSCALE, M, V,<br>
*                          LDV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          JOB, SIDE<br>
...
*> \verbatim<br>
*><br>
*> SGGBAK forms the right or left eigenvectors of a real generalized<br>
...
*>          = 'B':  do backward transformations for both permutation and<br>
*>                  scaling.<br>
*>          JOB must be the same as the argument JOB supplied to SGGBAL.<br>
*> \endverbatim<br>
*><br>
*> \param[in] SIDE<br>
*> \verbatim<br>
...
*> \verbatim<br>
*>          IHI is INTEGER<br>
*>          The integers ILO and IHI determined by SGGBAL.<br>
*>          1 <= ILO <= IHI <= N, if N > 0; ILO=1 and IHI=0, if N=0.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LSCALE<br>
...
*>          to the left side of A and B, as returned by SGGBAL.<br>
*> \endverbatim<br>
*><br>
*> \param[in] RSCALE<br>
*> \verbatim<br>
...
*>          Details of the permutations and/or scaling factors applied<br>
*>          to the right side of A and B, as returned by SGGBAL.<br>
*> \endverbatim<br>
*><br>
*> \param[in] M<br>
*> \verbatim<br>
...
*>          V is REAL array, dimension (LDV,M)<br>
*>          On entry, the matrix of right or left eigenvectors to be<br>
*>          transformed, as returned by STGEVC.<br>
*>          On exit, V is overwritten by the transformed eigenvectors.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDV<br>
...
*<br>
*> \htmlonly<br>
*> Download SGGBAL + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sggbal.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sggbal.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sggbal.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGGBAL( JOB, N, A, LDA, B, LDB, ILO, IHI, LSCALE,<br>
*                          RSCALE, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          JOB<br>
...
*> \verbatim<br>
*><br>
*> SGGBAL balances a pair of general real matrices (A,B).  This<br>
...
/**
*> \brief <b> SGGES computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGGES + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgges.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgges.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgges.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGGES( JOBVSL, JOBVSR, SORT, SELCTG, N, A, LDA, B, LDB,<br>
...
*> \verbatim<br>
*><br>
*> SGGES computes for a pair of N-by-N real nonsymmetric matrices (A,B),<br>
...
*> SGGEV instead, which is faster.)<br>
*><br>
...
*> \param[in] SELCTG<br>
*> \verbatim<br>
*>          SELCTG is a LOGICAL FUNCTION of three REAL arguments<br>
...
*> \param[out] VSL<br>
*> \verbatim<br>
*>          VSL is REAL array, dimension (LDVSL,N)<br>
...
*> \param[out] VSR<br>
*> \verbatim<br>
*>          VSR is REAL array, dimension (LDVSR,N)<br>
...
*>          LWORK is INTEGER<br>
*>          The dimension of the array WORK.<br>
*>          If N = 0, LWORK >= 1, else LWORK >= max(8*N,6*N+16).<br>
*>          For good performance , LWORK must generally be larger.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates the optimal size of the WORK array, returns<br>
...
*>          > N:  =N+1: other than QZ iteration failed in SHGEQZ.<br>
...
*>                =N+3: reordering failed in STGSEN.<br>
*> \endverbatim<br>
*<br>
*  Authors:<br>
*  ========<br>
...
/**
*> \brief <b> SGGES3 computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices (blocked algorithm)</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at<br>
...
*<br>
*> \htmlonly<br>
*> Download SGGES3 + dependencies<br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgges3.f"><br>
*> [TGZ]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgges3.f"><br>
*> [ZIP]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgges3.f"><br>
*> [TXT]</a><br>
*> \endhtmlonly<br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGGES3( JOBVSL, JOBVSR, SORT, SELCTG, N, A, LDA, B,<br>
*      $                   LDB, SDIM, ALPHAR, ALPHAI, BETA, VSL, LDVSL,<br>
*      $                   VSR, LDVSR, WORK, LWORK, BWORK, INFO )<br>
*<br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          JOBVSL, JOBVSR, SORT<br>
*       INTEGER            INFO, LDA, LDB, LDVSL, LDVSR, LWORK, N, SDIM<br>
...
*> \verbatim<br>
*><br>
*> SGGES3 computes for a pair of N-by-N real nonsymmetric matrices (A,B),<br>
*> the generalized eigenvalues, the generalized real Schur form (S,T),<br>
*> optionally, the left and/or right matrices of Schur vectors (VSL and<br>
*> VSR). This gives the generalized Schur factorization<br>
*><br>
...
/**
*> \brief <b> SGGESX computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGGESX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sggesx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sggesx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sggesx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGGESX( JOBVSL, JOBVSR, SORT, SELCTG, SENSE, N, A, LDA,<br>
...
*> \verbatim<br>
*><br>
*> SGGESX computes for a pair of N-by-N real nonsymmetric matrices<br>
...
*> \param[in] SELCTG<br>
*> \verbatim<br>
*>          SELCTG is procedure) LOGICAL FUNCTION of three REAL arguments<br>
*>          SELCTG must be declared EXTERNAL in the calling subroutine.<br>
*>          If SORT = 'N', SELCTG is not referenced.<br>
*>          If SORT = 'S', SELCTG is used to select eigenvalues to sort<br>
*>          to the top left of the Schur form.<br>
...
/**
*> \brief <b> SGGEV computes the eigenvalues and, optionally, the left and/or right eigenvectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGGEV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sggev.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sggev.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sggev.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGGEV( JOBVL, JOBVR, N, A, LDA, B, LDB, ALPHAR, ALPHAI,<br>
...
*> \verbatim<br>
*><br>
*> SGGEV computes for a pair of N-by-N real nonsymmetric matrices (A,B)<br>
...
/**
*> \brief <b> SGGEV3 computes the eigenvalues and, optionally, the left and/or right eigenvectors for GE matrices (blocked algorithm)</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at<br>
...
*<br>
*> \htmlonly<br>
*> Download SGGEV3 + dependencies<br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sggev3.f"><br>
*> [TGZ]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sggev3.f"><br>
*> [ZIP]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sggev3.f"><br>
*> [TXT]</a><br>
*> \endhtmlonly<br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGGEV3( JOBVL, JOBVR, N, A, LDA, B, LDB, ALPHAR,<br>
...
*> \verbatim<br>
*><br>
*> SGGEV3 computes for a pair of N-by-N real nonsymmetric matrices (A,B)<br>
*> the generalized eigenvalues, and optionally, the left and/or right<br>
*> generalized eigenvectors.<br>
*><br>
*> A generalized eigenvalue for a pair of matrices (A,B) is a scalar<br>
...
/**
*> \brief <b> SGGEVX computes the eigenvalues and, optionally, the left and/or right eigenvectors for GE matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGGEVX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sggevx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sggevx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sggevx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGGEVX( BALANC, JOBVL, JOBVR, SENSE, N, A, LDA, B, LDB,<br>
...
*> \verbatim<br>
*><br>
*> SGGEVX computes for a pair of N-by-N real nonsymmetric matrices (A,B)<br>
*> the generalized eigenvalues, and optionally, the left and/or right<br>
*> generalized eigenvectors.<br>
*><br>
*> Optionally also, it computes a balancing transformation to improve<br>
...
*>          LWORK >= max(1,6*N).<br>
*>          If SENSE = 'E', LWORK >= max(1,10*N).<br>
...
*<br>
*> \htmlonly<br>
*> Download SGGGLM + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sggglm.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sggglm.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sggglm.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGGGLM( N, M, P, A, LDA, B, LDB, D, X, Y, WORK, LWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> SGGGLM solves a general Gauss-Markov linear model (GLM) problem:<br>
*><br>
...
*> \param[in,out] B<br>
*> \verbatim<br>
*>          B is REAL array, dimension (LDB,P)<br>
...
*> \param[out] X<br>
*> \verbatim<br>
*>          X is REAL array, dimension (M)<br>
*> \endverbatim<br>
*><br>
*> \param[out] Y<br>
*> \verbatim<br>
*>          Y is REAL array, dimension (P)<br>
*><br>
...
*>          SGEQRF, SGERQF, SORMQR and SORMRQ.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates the optimal size of the WORK array, returns<br>
*>          this value as the first entry of the WORK array, and no error<br>
...
*<br>
*> \htmlonly<br>
*> Download SGGHRD + dependencies<br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgghd3.f"><br>
*> [TGZ]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgghd3.f"><br>
*> [ZIP]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgghd3.f"><br>
*> [TXT]</a><br>
*> \endhtmlonly<br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGGHD3( COMPQ, COMPZ, N, ILO, IHI, A, LDA, B, LDB, Q,<br>
...
*> \verbatim<br>
*><br>
*> SGGHD3 reduces a pair of real matrices (A,B) to generalized upper<br>
...
*> original equation A*x = lambda*B*x, then SGGHD3 reduces the original<br>
*> problem to generalized Hessenberg form.<br>
*><br>
*> This is a blocked variant of SGGHRD, using matrix-matrix<br>
...
*>          normally set by a previous call to SGGBAL; otherwise they<br>
...
*> \htmlonly<br>
*> Download SGGHRD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgghrd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgghrd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgghrd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGGHRD( COMPQ, COMPZ, N, ILO, IHI, A, LDA, B, LDB, Q,<br>
*                          LDQ, Z, LDZ, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          COMPQ, COMPZ<br>
...
*> \verbatim<br>
*><br>
*> SGGHRD reduces a pair of real matrices (A,B) to generalized upper<br>
*> Hessenberg form using orthogonal transformations, where A is a<br>
*> general matrix and B is upper triangular.  The form of the<br>
*> generalized eigenvalue problem is<br>
*>    A*x = lambda*B*x,<br>
...
*><br>
*> If Q1 is the orthogonal matrix from the QR factorization of B in the<br>
*> original equation A*x = lambda*B*x, then SGGHRD reduces the original<br>
*> problem to generalized Hessenberg form.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
/**
*> \brief <b> SGGLSE solves overdetermined or underdetermined systems for OTHER matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGGLSE + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgglse.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgglse.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgglse.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGGLSE( M, N, P, A, LDA, B, LDB, C, D, X, WORK, LWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LDB, LWORK, M, N, P<br>
...
*> \verbatim<br>
*><br>
*> SGGLSE solves the linear equality-constrained least squares (LSE)<br>
*> problem:<br>
*><br>
...
*> \param[in,out] C<br>
*> \verbatim<br>
*>          C is REAL array, dimension (M)<br>
...
*> \param[in,out] D<br>
*> \verbatim<br>
*>          D is REAL array, dimension (P)<br>
...
*<br>
*> \htmlonly<br>
*> Download SGGQRF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sggqrf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sggqrf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sggqrf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGGQRF( N, M, P, A, LDA, TAUA, B, LDB, TAUB, WORK,<br>
*                          LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LDB, LWORK, M, N, P<br>
...
*> \verbatim<br>
*><br>
*> SGGQRF computes a generalized QR factorization of an N-by-M matrix A<br>
...
*> \param[out] TAUA<br>
*> \verbatim<br>
*>          TAUA is REAL array, dimension (min(N,M))<br>
*>          The scalar factors of the elementary reflectors which<br>
*>          represent the orthogonal matrix Q (see Further Details).<br>
*> \endverbatim<br>
*><br>
...
*> \param[out] TAUB<br>
*> \verbatim<br>
*>          TAUB is REAL array, dimension (min(N,P))<br>
*>          The scalar factors of the elementary reflectors which<br>
...
*>          blocksize for a call of SORMQR.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates the optimal size of the WORK array, returns<br>
*>          this value as the first entry of the WORK array, and no error<br>
...
*>  To form Q explicitly, use LAPACK subroutine SORGQR.<br>
*>  To use Q to update another matrix, use LAPACK subroutine SORMQR.<br>
*><br>
...
*>  To form Z explicitly, use LAPACK subroutine SORGRQ.<br>
*>  To use Z to update another matrix, use LAPACK subroutine SORMRQ.<br>
*> \endverbatim<br>
*><br>
*  =====================================================================<br>
*/
...
*<br>
*> \htmlonly<br>
*> Download SGGRQF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sggrqf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sggrqf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sggrqf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGGRQF( M, P, N, A, LDA, TAUA, B, LDB, TAUB, WORK,<br>
*                          LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, LDA, LDB, LWORK, M, N, P<br>
...
*> \verbatim<br>
*><br>
*> SGGRQF computes a generalized RQ factorization of an M-by-N matrix A<br>
...
*> \param[out] TAUA<br>
*> \verbatim<br>
*>          TAUA is REAL array, dimension (min(M,N))<br>
*>          The scalar factors of the elementary reflectors which<br>
*>          represent the orthogonal matrix Q (see Further Details).<br>
*> \endverbatim<br>
*><br>
...
*> \param[out] TAUB<br>
*> \verbatim<br>
*>          TAUB is REAL array, dimension (min(P,N))<br>
*>          The scalar factors of the elementary reflectors which<br>
*>          represent the orthogonal matrix Z (see Further Details).<br>
*> \endverbatim<br>
*><br>
...
*>          blocksize for a call of SORMRQ.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; the routine<br>
*>          only calculates the optimal size of the WORK array, returns<br>
*>          this value as the first entry of the WORK array, and no error<br>
...
*>  To form Q explicitly, use LAPACK subroutine SORGRQ.<br>
...
/**
*> \brief <b> SGGSVD3 computes the singular value decomposition (SVD) for OTHER matrices</b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGGSVD3 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sggsvd3.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sggsvd3.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sggsvd3.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGGSVD3( JOBU, JOBV, JOBQ, M, N, P, K, L, A, LDA, B,<br>
...
*> \verbatim<br>
*><br>
*> SGGSVD3 computes the generalized singular value decomposition (GSVD)<br>
...
*>                converge.  For further details, see subroutine STGSJA.<br>
*> \endverbatim<br>
*<br>
*> \par Internal Parameters:<br>
*  =========================<br>
...
*  =====================<br>
*><br>
*>  SGGSVD3 replaces the deprecated subroutine SGGSVD.<br>
*><br>
*  =====================================================================<br>
*/
...
*<br>
*> \htmlonly<br>
*> Download SGGSVP3 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sggsvp3.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sggsvp3.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sggsvp3.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGGSVP3( JOBU, JOBV, JOBQ, M, P, N, A, LDA, B, LDB,<br>
...
*> \verbatim<br>
*><br>
*> SGGSVP3 computes orthogonal matrices U, V and Q such that<br>
*><br>
*>                    N-K-L  K    L<br>
...
*> \param[out] TAU<br>
*> \verbatim<br>
*>          TAU is REAL array, dimension (N)<br>
*> \endverbatim<br>
*><br>
*> \param[out] WORK<br>
*> \verbatim<br>
...
*> \verbatim<br>
*><br>
*>  The subroutine uses LAPACK subroutine SGEQP3 for the QR factorization<br>
...
*><br>
*>  SGGSVP3 replaces the deprecated subroutine SGGSVP.<br>
*><br>
*> \endverbatim<br>
*><br>
*  =====================================================================<br>
...
/**
*> \brief \b SGSVJ0 pre-processor for the routine sgesvj.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGSVJ0 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgsvj0.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgsvj0.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgsvj0.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGSVJ0( JOBV, M, N, A, LDA, D, SVA, MV, V, LDV, EPS,<br>
...
*> \verbatim<br>
*><br>
*> SGSVJ0 is called from SGESVJ as a pre-processor and that is its main<br>
*> purpose. It applies Jacobi rotations in the same way as SGESVJ does, but<br>
...
*  =====================<br>
*><br>
*> SGSVJ0 is used just to enable SGESVJ to call a simplified version of<br>
...
*<br>
*> \htmlonly<br>
*> Download SGSVJ1 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgsvj1.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgsvj1.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgsvj1.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGSVJ1( JOBV, M, N, N1, A, LDA, D, SVA, MV, V, LDV,<br>
...
*> \verbatim<br>
*><br>
*> SGSVJ1 is called from SGESVJ as a pre-processor and that is its main<br>
*> purpose. It applies Jacobi rotations in the same way as SGESVJ does, but<br>
...
*> Further Details<br>
*> ~~~~~~~~~~~~~~~<br>
*> SGSVJ1 applies few sweeps of Jacobi rotations in the column space of<br>
...
*<br>
*> \htmlonly<br>
*> Download SGTCON + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgtcon.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgtcon.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgtcon.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGTCON( NORM, N, DL, D, DU, DU2, IPIV, ANORM, RCOND,<br>
*                          WORK, IWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          NORM<br>
...
*> \verbatim<br>
*><br>
*> SGTCON estimates the reciprocal of the condition number of a real<br>
...
*>          LU factorization of A as computed by SGTTRF.<br>
*> \endverbatim<br>
*><br>
*> \param[in] D<br>
*> \verbatim<br>
...
*> \param[in] DU2<br>
*> \verbatim<br>
*>          DU2 is REAL array, dimension (N-2)<br>
...
*> \date September 2012<br>
*<br>
*> \ingroup realGTcomputational<br>
*<br>
*  =====================================================================<br>
*/
...
*<br>
*> \htmlonly<br>
*> Download SGTRFS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgtrfs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgtrfs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgtrfs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGTRFS( TRANS, N, NRHS, DL, D, DU, DLF, DF, DUF, DU2,<br>
*                          IPIV, B, LDB, X, LDX, FERR, BERR, WORK, IWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> SGTRFS improves the computed solution to a system of linear<br>
...
*> \param[in] DLF<br>
*> \verbatim<br>
*>          DLF is REAL array, dimension (N-1)<br>
*>          The (n-1) multipliers that define the matrix L from the<br>
*>          LU factorization of A as computed by SGTTRF.<br>
*> \endverbatim<br>
*><br>
...
*> \param[in] DUF<br>
*> \verbatim<br>
*>          DUF is REAL array, dimension (N-1)<br>
*>          The (n-1) elements of the first superdiagonal of U.<br>
*> \endverbatim<br>
*><br>
*> \param[in] DU2<br>
...
*> \verbatim<br>
*>          X is REAL array, dimension (LDX,NRHS)<br>
*>          On entry, the solution matrix X, as computed by SGTTRS.<br>
*>          On exit, the improved solution matrix X.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDX<br>
...
/**
*> \brief <b> SGTSV computes the solution to system of linear equations A * X = B for GT matrices <b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGTSV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgtsv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgtsv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgtsv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGTSV( N, NRHS, DL, D, DU, B, LDB, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \date September 2012<br>
*<br>
*> \ingroup realGTsolve<br>
*<br>
*  =====================================================================<br>
*/
	public void sgtsv_(INTEGER N,INTEGER NRHS,float[] DL,float[] D,float[] DU,float[] B,INTEGER LDB,INTEGER INFO);
/**
*> \brief <b> SGTSVX computes the solution to system of linear equations A * X = B for GT matrices <b><br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGTSVX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgtsvx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgtsvx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgtsvx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGTSVX( FACT, TRANS, N, NRHS, DL, D, DU, DLF, DF, DUF,<br>
...
*> \verbatim<br>
*><br>
*> SGTSVX uses the LU factorization to compute the solution to a real<br>
...
*>          the LU factorization of A as computed by SGTTRF.<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download SGTTRF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgttrf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgttrf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgttrf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGTTRF( N, DL, D, DU, DU2, IPIV, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> SGTTRF computes an LU factorization of a real tridiagonal matrix A<br>
...
*<br>
*> \htmlonly<br>
*> Download SGTTRS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgttrs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgttrs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgttrs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGTTRS( TRANS, N, NRHS, DL, D, DU, DU2, IPIV, B, LDB,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANS<br>
...
*> \verbatim<br>
*><br>
*> SGTTRS solves one of the systems of equations<br>
*>    A*X = B  or  A**T*X = B,<br>
...
/**
*> \brief \b SGTTS2 solves a system of linear equations with a tridiagonal matrix using the LU factorization computed by sgttrf.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download SGTTS2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sgtts2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sgtts2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sgtts2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SGTTS2( ITRANS, N, NRHS, DL, D, DU, DU2, IPIV, B, LDB )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> SGTTS2 solves one of the systems of equations<br>
*>    A*X = B  or  A**T*X = B,<br>
*> with a tridiagonal matrix A using the LU factorization computed<br>
*> by SGTTRF.<br>
*> \endverbatim<br>
