...
*<br>
*> \htmlonly<br>
*> Download DTBCON + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtbcon.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtbcon.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtbcon.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTBCON( NORM, UPLO, DIAG, N, KD, AB, LDAB, RCOND, WORK,<br>
*                          IWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> DTBCON estimates the reciprocal of the condition number of a<br>
...
*<br>
*> \htmlonly<br>
*> Download DTBRFS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtbrfs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtbrfs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtbrfs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTBRFS( UPLO, TRANS, DIAG, N, KD, NRHS, AB, LDAB, B,<br>
...
*       .. Array Arguments ..<br>
*       INTEGER            IWORK( * )<br>
*       DOUBLE PRECISION   AB( LDAB, * ), B( LDB, * ), BERR( * ),<br>
*      $                   FERR( * ), WORK( * ), X( LDX, * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> DTBRFS provides error bounds and backward error estimates for the<br>
*> solution to a system of linear equations with a triangular band<br>
*> coefficient matrix.<br>
*><br>
*> The solution matrix X must be computed by DTBTRS or some other<br>
*> means before entering this routine.  DTBRFS does not do iterative<br>
...
*<br>
*> \htmlonly<br>
*> Download DTBTRS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtbtrs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtbtrs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtbtrs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTBTRS( UPLO, TRANS, DIAG, N, KD, NRHS, AB, LDAB, B,<br>
*                          LDB, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          DIAG, TRANS, UPLO<br>
...
*> \verbatim<br>
*><br>
*> DTBTRS solves a triangular system of the form<br>
*><br>
*>    A * X = B  or  A**T * X = B,<br>
*><br>
...
/**
*> \brief \b DTFSM solves a matrix equation (one operand is a triangular matrix in RFP format).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DTFSM + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtfsm.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtfsm.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtfsm.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTFSM( TRANSR, SIDE, UPLO, TRANS, DIAG, M, N, ALPHA, A,<br>
*                         B, LDB )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   A( 0: * ), B( 0: LDB-1, 0: * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*><br>
*> DTFSM  solves the matrix equation<br>
*><br>
...
*> \param[in] A<br>
*> \verbatim<br>
*>          A is DOUBLE PRECISION array, dimension (NT)<br>
...
*<br>
*> \htmlonly<br>
*> Download DTFTRI + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtftri.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtftri.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtftri.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTFTRI( TRANSR, UPLO, DIAG, N, A, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> DTFTRI computes the inverse of a triangular matrix A stored in RFP<br>
*> format.<br>
*><br>
...
*> \param[in,out] A<br>
*> \verbatim<br>
*>          A is DOUBLE PRECISION array, dimension (0:nt-1);<br>
...
/**
*> \brief \b DTFTTP copies a triangular matrix from the rectangular full packed format (TF) to the standard packed format (TP).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DTFTTP + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtfttp.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtfttp.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtfttp.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTFTTP( TRANSR, UPLO, N, ARF, AP, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   AP( 0: * ), ARF( 0: * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DTFTTP copies a triangular matrix A from rectangular full packed<br>
...
*> \param[in] ARF<br>
*> \verbatim<br>
*>          ARF is DOUBLE PRECISION array, dimension ( N*(N+1)/2 ),<br>
...
/**
*> \brief \b DTFTTR copies a triangular matrix from the rectangular full packed format (TF) to the standard full format (TR).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DTFTTR + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtfttr.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtfttr.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtfttr.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTFTTR( TRANSR, UPLO, N, ARF, A, LDA, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANSR, UPLO<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   A( 0: LDA-1, 0: * ), ARF( 0: * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DTFTTR copies a triangular matrix A from rectangular full packed<br>
...
*<br>
*> \htmlonly<br>
*> Download DTGEVC + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtgevc.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtgevc.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtgevc.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTGEVC( SIDE, HOWMNY, SELECT, N, S, LDS, P, LDP, VL,<br>
...
*       .. Array Arguments ..<br>
*       LOGICAL            SELECT( * )<br>
*       DOUBLE PRECISION   P( LDP, * ), S( LDS, * ), VL( LDVL, * ),<br>
*      $                   VR( LDVR, * ), WORK( * )<br>
*       ..<br>
*  <br>
*  <br>
...
*> \verbatim<br>
*><br>
*> DTGEVC computes some or all of the right and/or left eigenvectors of<br>
...
*><br>
*> as computed by DGGHRD + DHGEQZ.<br>
*><br>
...
*> \param[in] S<br>
*> \verbatim<br>
*>          S is DOUBLE PRECISION array, dimension (LDS,N)<br>
*>          The upper quasi-triangular matrix S from a generalized Schur<br>
*>          factorization, as computed by DHGEQZ.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDS<br>
*> \verbatim<br>
...
*> \param[in] P<br>
*> \verbatim<br>
*>          P is DOUBLE PRECISION array, dimension (LDP,N)<br>
...
*>          of left Schur vectors returned by DHGEQZ).<br>
...
*>          of right Schur vectors returned by DHGEQZ).<br>
*><br>
...
/**
*> \brief \b DTGEX2 swaps adjacent diagonal blocks in an upper (quasi) triangular matrix pair by an orthogonal equivalence transformation.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DTGEX2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtgex2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtgex2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtgex2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTGEX2( WANTQ, WANTZ, N, A, LDA, B, LDB, Q, LDQ, Z,<br>
...
*> \verbatim<br>
*><br>
*> DTGEX2 swaps adjacent diagonal blocks (A11, B11) and (A22, B22)<br>
...
*> by DGGES), i.e. A is block upper triangular with 1-by-1 and 2-by-2<br>
...
*> \param[in,out] A<br>
*> \verbatim<br>
*>          A is DOUBLE PRECISION array, dimensions (LDA,N)<br>
...
*> \param[in,out] B<br>
*> \verbatim<br>
*>          B is DOUBLE PRECISION array, dimensions (LDB,N)<br>
...
*>          LWORK >=  MAX( 1, N*(N2+N1), (N2+N1)*(N2+N1)*2 )<br>
*> \endverbatim<br>
*><br>
*> \param[out] INFO<br>
*> \verbatim<br>
...
*<br>
*> \htmlonly<br>
*> Download DTGEXC + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtgexc.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtgexc.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtgexc.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTGEXC( WANTQ, WANTZ, N, A, LDA, B, LDB, Q, LDQ, Z,<br>
...
*> \verbatim<br>
*><br>
*> DTGEXC reorders the generalized real Schur decomposition of a real<br>
...
*<br>
*> \htmlonly<br>
*> Download DTGSEN + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtgsen.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtgsen.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtgsen.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTGSEN( IJOB, WANTQ, WANTZ, SELECT, N, A, LDA, B, LDB,<br>
...
*> \verbatim<br>
*><br>
*> DTGSEN reorders the generalized real Schur decomposition of a real<br>
...
*> Schur canonical form (as returned by DGGES), i.e. A is block upper<br>
*> triangular with 1-by-1 and 2-by-2 diagonal blocks. B is upper<br>
*> triangular.<br>
*><br>
*> DTGSEN also computes the generalized eigenvalues<br>
*><br>
*>             w(j) = (ALPHAR(j) + i*ALPHAI(j))/BETA(j)<br>
*><br>
*> of the reordered matrix pair (A, B).<br>
*><br>
*> Optionally, DTGSEN computes the estimates of reciprocal condition<br>
...
*<br>
*> \htmlonly<br>
*> Download DTGSJA + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtgsja.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtgsja.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtgsja.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTGSJA( JOBU, JOBV, JOBQ, M, P, N, K, L, A, LDA, B,<br>
...
*> \verbatim<br>
*><br>
*> DTGSJA computes the generalized singular value decomposition (GSVD)<br>
...
*> forms, which may be obtained by the preprocessing subroutine DGGSVP<br>
...
*>          of A and B, whose GSVD is going to be computed by DTGSJA.<br>
...
*>          the orthogonal matrix returned by DGGSVP).<br>
*>          On exit,<br>
...
*> \verbatim<br>
*><br>
*>  DTGSJA essentially uses a variant of Kogbetliantz algorithm to reduce<br>
...
*<br>
*> \htmlonly<br>
*> Download DTGSNA + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtgsna.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtgsna.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtgsna.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTGSNA( JOB, HOWMNY, SELECT, N, A, LDA, B, LDB, VL,<br>
...
*       LOGICAL            SELECT( * )<br>
*       INTEGER            IWORK( * )<br>
*       DOUBLE PRECISION   A( LDA, * ), B( LDB, * ), DIF( * ), S( * ),<br>
...
*> \verbatim<br>
*><br>
*> DTGSNA estimates reciprocal condition numbers for specified<br>
...
*><br>
*> (A, B) must be in generalized real Schur form (as returned by DGGES),<br>
...
*> \param[in] VL<br>
*> \verbatim<br>
*>          VL is DOUBLE PRECISION array, dimension (LDVL,M)<br>
...
*>          columns of VL, as returned by DTGEVC.<br>
...
*> \param[in] VR<br>
*> \verbatim<br>
*>          VR is DOUBLE PRECISION array, dimension (LDVR,M)<br>
*>          If JOB = 'E' or 'B', VR must contain right eigenvectors of<br>
*>          (A, B), corresponding to the eigenpairs specified by HOWMNY<br>
*>          and SELECT. The eigenvectors must be stored in consecutive<br>
*>          columns ov VR, as returned by DTGEVC.<br>
...
*>     (see DLATDF), then the parameter DIFDRI (see below) should be<br>
*>     changed from 3 to 4 (routine DLATDF(IJOB = 2 will be used)).<br>
*>     See DTGSYL for more details.<br>
*><br>
...
*>     DLATDF), then the parameter DIFDRI (see below) should be changed<br>
*>     from 3 to 4 (routine DLATDF(IJOB = 2 will be used)). See DTGSYL<br>
*>     for more details.<br>
*><br>
...
/**
*> \brief \b DTGSY2 solves the generalized Sylvester equation (unblocked algorithm).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DTGSY2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtgsy2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtgsy2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtgsy2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTGSY2( TRANS, IJOB, M, N, A, LDA, B, LDB, C, LDC, D,<br>
...
*> \verbatim<br>
*><br>
*> DTGSY2 solves the generalized Sylvester equation:<br>
*><br>
...
*> sigma_min(Z) using reverse communicaton with DLACON.<br>
*><br>
*> DTGSY2 also (IJOB >= 1) contributes to the computation in DTGSYL<br>
...
*> DTGSYL. See DTGSYL for details.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*> \param[in] D<br>
*> \verbatim<br>
*>          D is DOUBLE PRECISION array, dimension (LDD, M)<br>
...
*> \param[in] E<br>
*> \verbatim<br>
*>          E is DOUBLE PRECISION array, dimension (LDE, N)<br>
...
*> \param[in,out] F<br>
*> \verbatim<br>
*>          F is DOUBLE PRECISION array, dimension (LDF, N)<br>
...
*>          NOTE: RDSUM only makes sense when DTGSY2 is called by DTGSYL.<br>
*> \endverbatim<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download DTGSYL + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtgsyl.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtgsyl.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtgsyl.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTGSYL( TRANS, IJOB, M, N, A, LDA, B, LDB, C, LDC, D,<br>
...
*> \verbatim<br>
*><br>
*> DTGSYL solves the generalized Sylvester equation:<br>
*><br>
*>             A * R - L * B = scale * C                 (1)<br>
*>             D * R - L * E = scale * F<br>
*><br>
...
*><br>
*> If TRANS = 'T', DTGSYL solves the transposed system Z**T*y = scale*b,<br>
*> which is equivalent to solve for R and L in<br>
*><br>
*>             A**T * R + D**T * L = scale * C           (3)<br>
*>             R * B**T + L * E**T = scale * -F<br>
...
*> and (B,E), using DLACON.<br>
*><br>
*> If IJOB >= 1, DTGSYL computes a Frobenius norm-based estimate<br>
...
*>               ( DGECON on sub-systems is used ).<br>
*>          Not referenced if TRANS = 'T'.<br>
*> \endverbatim<br>
*><br>
*> \param[in] M<br>
...
*<br>
*> \htmlonly<br>
*> Download DTPCON + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtpcon.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtpcon.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtpcon.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTPCON( NORM, UPLO, DIAG, N, AP, RCOND, WORK, IWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          DIAG, NORM, UPLO<br>
...
*> \verbatim<br>
*><br>
*> DTPCON estimates the reciprocal of the condition number of a packed<br>
...
*<br>
*> \htmlonly<br>
*> Download DTPMQRT + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtpmqrt.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtpmqrt.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtpmqrt.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTPMQRT( SIDE, TRANS, M, N, K, L, NB, V, LDV, T, LDT,<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   V( LDV, * ), A( LDA, * ), B( LDB, * ), <br>
*      $                   T( LDT, * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> DTPMQRT applies a real orthogonal matrix Q obtained from a <br>
...
*> \param[in] V<br>
*> \verbatim<br>
*>          V is DOUBLE PRECISION array, dimension (LDA,K)<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is DOUBLE PRECISION array. The dimension of WORK is<br>
...
*<br>
*> \htmlonly<br>
*> Download DTPQRT + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtpqrt.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtpqrt.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtpqrt.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTPQRT( M, N, L, NB, A, LDA, B, LDB, T, LDT, WORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION A( LDA, * ), B( LDB, * ), T( LDT, * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DTPQRT computes a blocked QR factorization of a real <br>
...
/**
*> \brief \b DTPQRT2 computes a QR factorization of a real or complex "triangular-pentagonal" matrix, which is composed of a triangular block and a pentagonal block, using the compact WY representation for Q.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DTPQRT2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtpqrt2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtpqrt2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtpqrt2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTPQRT2( M, N, L, A, LDA, B, LDB, T, LDT, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER   INFO, LDA, LDB, LDT, N, M, L<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   A( LDA, * ), B( LDB, * ), T( LDT, * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DTPQRT2 computes a QR factorization of a real "triangular-pentagonal"<br>
...
/**
*> \brief \b DTPRFB applies a real or complex "triangular-pentagonal" blocked reflector to a real or complex matrix, which is composed of two blocks.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DTPRFB + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtprfb.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtprfb.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtprfb.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTPRFB( SIDE, TRANS, DIRECT, STOREV, M, N, K, L, <br>
...
*> \verbatim<br>
*><br>
*> DTPRFB applies a real "triangular-pentagonal" block reflector H or its <br>
*> transpose H**T to a real matrix C, which is composed of two <br>
...
*>          On entry, the K-by-N or M-by-K matrix A.<br>
*>          On exit, A is overwritten by the corresponding block of <br>
*>          H*C or H**T*C or C*H or C*H**T.  See Futher Details.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDA<br>
*> \verbatim<br>
...
*>          On entry, the M-by-N matrix B.<br>
*>          On exit, B is overwritten by the corresponding block of<br>
*>          H*C or H**T*C or C*H or C*H**T.  See Further Details.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDB<br>
*> \verbatim<br>
...
*<br>
*> \htmlonly<br>
*> Download DTPRFS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtprfs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtprfs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtprfs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTPRFS( UPLO, TRANS, DIAG, N, NRHS, AP, B, LDB, X, LDX,<br>
...
*       .. Array Arguments ..<br>
*       INTEGER            IWORK( * )<br>
*       DOUBLE PRECISION   AP( * ), B( LDB, * ), BERR( * ), FERR( * ),<br>
*      $                   WORK( * ), X( LDX, * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> DTPRFS provides error bounds and backward error estimates for the<br>
*> solution to a system of linear equations with a triangular packed<br>
*> coefficient matrix.<br>
*><br>
*> The solution matrix X must be computed by DTPTRS or some other<br>
*> means before entering this routine.  DTPRFS does not do iterative<br>
*> refinement because doing so cannot improve the backward error.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download DTPTRI + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtptri.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtptri.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtptri.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTPTRI( UPLO, DIAG, N, AP, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> DTPTRI computes the inverse of a real upper or lower triangular<br>
...
*<br>
*> \htmlonly<br>
*> Download DTPTRS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtptrs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtptrs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtptrs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTPTRS( UPLO, TRANS, DIAG, N, NRHS, AP, B, LDB, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          DIAG, TRANS, UPLO<br>
...
*> \verbatim<br>
*><br>
*> DTPTRS solves a triangular system of the form<br>
*><br>
*>    A * X = B  or  A**T * X = B,<br>
*><br>
...
/**
*> \brief \b DTPTTF copies a triangular matrix from the standard packed format (TP) to the rectangular full packed format (TF).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DTPTTF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtpttf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtpttf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtpttf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTPTTF( TRANSR, UPLO, N, AP, ARF, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANSR, UPLO<br>
*       INTEGER            INFO, N<br>
...
*> \verbatim<br>
*><br>
*> DTPTTF copies a triangular matrix A from standard packed format (TP)<br>
...
/**
*> \brief \b DTPTTR copies a triangular matrix from the standard packed format (TP) to the standard full format (TR).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DTPTTR + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtpttr.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtpttr.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtpttr.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTPTTR( UPLO, N, AP, A, LDA, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          UPLO<br>
*       INTEGER            INFO, N, LDA<br>
...
*> \verbatim<br>
*><br>
*> DTPTTR copies a triangular matrix A from standard packed format (TP)<br>
...
*<br>
*> \htmlonly<br>
*> Download DTRCON + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtrcon.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtrcon.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtrcon.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTRCON( NORM, UPLO, DIAG, N, A, LDA, RCOND, WORK,<br>
*                          IWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          DIAG, NORM, UPLO<br>
...
*> \verbatim<br>
*><br>
*> DTRCON estimates the reciprocal of the condition number of a<br>
*> triangular matrix A, in either the 1-norm or the infinity-norm.<br>
*><br>
*> The norm of A is computed and an estimate is obtained for<br>
*> norm(inv(A)), then the reciprocal of the condition number is<br>
...
*<br>
*> \htmlonly<br>
*> Download DTREVC + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtrevc.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtrevc.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtrevc.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTREVC( SIDE, HOWMNY, SELECT, N, T, LDT, VL, LDVL, VR,<br>
...
*       .. Array Arguments ..<br>
*       LOGICAL            SELECT( * )<br>
*       DOUBLE PRECISION   T( LDT, * ), VL( LDVL, * ), VR( LDVR, * ),<br>
*      $                   WORK( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> DTREVC computes some or all of the right and/or left eigenvectors of<br>
*> a real upper quasi-triangular matrix T.<br>
*> Matrices of this type are produced by the Schur factorization of<br>
*> a real general matrix:  A = Q*T*Q**T, as computed by DHSEQR.<br>
*> <br>
...
*<br>
*> \htmlonly<br>
*> Download DTREVC3 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtrevc3.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtrevc3.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtrevc3.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTREVC3( SIDE, HOWMNY, SELECT, N, T, LDT, VL, LDVL,<br>
...
*> \verbatim<br>
*><br>
*> DTREVC3 computes some or all of the right and/or left eigenvectors of<br>
*> a real upper quasi-triangular matrix T.<br>
*> Matrices of this type are produced by the Schur factorization of<br>
*> a real general matrix:  A = Q*T*Q**T, as computed by DHSEQR.<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download DTREXC + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtrexc.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtrexc.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtrexc.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTREXC( COMPQ, N, T, LDT, Q, LDQ, IFST, ILST, WORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          COMPQ<br>
...
*> \verbatim<br>
*><br>
*> DTREXC reorders the real Schur factorization of a real matrix<br>
...
*><br>
*> T must be in Schur canonical form (as returned by DHSEQR), that is,<br>
...
*<br>
*> \htmlonly<br>
*> Download DTRRFS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtrrfs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtrrfs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtrrfs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTRRFS( UPLO, TRANS, DIAG, N, NRHS, A, LDA, B, LDB, X,<br>
...
*       .. Array Arguments ..<br>
*       INTEGER            IWORK( * )<br>
*       DOUBLE PRECISION   A( LDA, * ), B( LDB, * ), BERR( * ), FERR( * ),<br>
*      $                   WORK( * ), X( LDX, * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> DTRRFS provides error bounds and backward error estimates for the<br>
*> solution to a system of linear equations with a triangular<br>
*> coefficient matrix.<br>
*><br>
*> The solution matrix X must be computed by DTRTRS or some other<br>
*> means before entering this routine.  DTRRFS does not do iterative<br>
*> refinement because doing so cannot improve the backward error.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download DTRSEN + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtrsen.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtrsen.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtrsen.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTRSEN( JOB, COMPQ, SELECT, N, T, LDT, Q, LDQ, WR, WI,<br>
...
*       LOGICAL            SELECT( * )<br>
*       INTEGER            IWORK( * )<br>
*       DOUBLE PRECISION   Q( LDQ, * ), T( LDT, * ), WI( * ), WORK( * ),<br>
*      $                   WR( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> DTRSEN reorders the real Schur factorization of a real matrix<br>
...
*> \verbatim<br>
*><br>
*>  DTRSEN first collects the selected eigenvalues by computing an<br>
...
*<br>
*> \htmlonly<br>
*> Download DTRSNA + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtrsna.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtrsna.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtrsna.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTRSNA( JOB, HOWMNY, SELECT, N, T, LDT, VL, LDVL, VR,<br>
...
*       LOGICAL            SELECT( * )<br>
*       INTEGER            IWORK( * )<br>
*       DOUBLE PRECISION   S( * ), SEP( * ), T( LDT, * ), VL( LDVL, * ),<br>
...
*> \verbatim<br>
*><br>
*> DTRSNA estimates reciprocal condition numbers for specified<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is DOUBLE PRECISION array, dimension (LDWORK,N+6)<br>
...
*<br>
*> \htmlonly<br>
*> Download DTRSYL + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtrsyl.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtrsyl.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtrsyl.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTRSYL( TRANA, TRANB, ISGN, M, N, A, LDA, B, LDB, C,<br>
*                          LDC, SCALE, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> DTRSYL solves the real Sylvester matrix equation:<br>
*><br>
...
*><br>
*> A and B must be in Schur canonical form (as returned by DHSEQR), that<br>
...
/**
*> \brief \b DTRTI2 computes the inverse of a triangular matrix (unblocked algorithm).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DTRTI2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtrti2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtrti2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtrti2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTRTI2( UPLO, DIAG, N, A, LDA, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          DIAG, UPLO<br>
*       INTEGER            INFO, LDA, N<br>
...
*> \verbatim<br>
*><br>
*> DTRTI2 computes the inverse of a real upper or lower triangular<br>
*> matrix.<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download DTRTRI + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtrtri.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtrtri.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtrtri.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTRTRI( UPLO, DIAG, N, A, LDA, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          DIAG, UPLO<br>
*       INTEGER            INFO, LDA, N<br>
...
*> \verbatim<br>
*><br>
*> DTRTRI computes the inverse of a real upper or lower triangular<br>
*> matrix A.<br>
*><br>
...
*<br>
*> \htmlonly<br>
*> Download DTRTRS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtrtrs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtrtrs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtrtrs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTRTRS( UPLO, TRANS, DIAG, N, NRHS, A, LDA, B, LDB,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          DIAG, TRANS, UPLO<br>
...
*> \verbatim<br>
*><br>
*> DTRTRS solves a triangular system of the form<br>
*><br>
*>    A * X = B  or  A**T * X = B,<br>
*><br>
...
/**
*> \brief \b DTRTTF copies a triangular matrix from the standard full format (TR) to the rectangular full packed format (TF).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DTRTTF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtrttf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtrttf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtrttf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTRTTF( TRANSR, UPLO, N, A, LDA, ARF, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANSR, UPLO<br>
*       INTEGER            INFO, N, LDA<br>
...
*> \verbatim<br>
*><br>
*> DTRTTF copies a triangular matrix A from standard full format (TR)<br>
*> to rectangular full packed format (TF) .<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*> \param[out] ARF<br>
*> \verbatim<br>
*>          ARF is DOUBLE PRECISION array, dimension (NT).<br>
...
/**
*> \brief \b DTRTTP copies a triangular matrix from the standard full format (TR) to the standard packed format (TP).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DTRTTP + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtrttp.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtrttp.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtrttp.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTRTTP( UPLO, N, A, LDA, AP, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          UPLO<br>
*       INTEGER            INFO, N, LDA<br>
...
*> \verbatim<br>
*><br>
*> DTRTTP copies a triangular matrix A from full format (TR) to standard<br>
*> packed format (TP).<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*<br>
*> \htmlonly<br>
*> Download DTZRZF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dtzrzf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dtzrzf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dtzrzf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DTZRZF( M, N, A, LDA, TAU, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> DTZRZF reduces the M-by-N ( M<=N ) real upper trapezoidal matrix A<br>
