...
*<br>
*> \htmlonly<br>
*> Download SHGEQZ + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/shgeqz.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/shgeqz.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/shgeqz.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SHGEQZ( JOB, COMPQ, COMPZ, N, ILO, IHI, H, LDH, T, LDT,<br>
...
*> \verbatim<br>
*><br>
*> SHGEQZ computes the eigenvalues of a real matrix pair (H,T),<br>
...
*> If Q1 and Z1 are the orthogonal matrices from SGGHRD that reduced<br>
...
*<br>
*> \htmlonly<br>
*> Download SHSEIN + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/shsein.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/shsein.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/shsein.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SHSEIN( SIDE, EIGSRC, INITV, SELECT, N, H, LDH, WR, WI,<br>
...
*> \verbatim<br>
*><br>
*> SHSEIN uses inverse iteration to find specified right and/or left<br>
...
*>          = 'Q': the eigenvalues were found using SHSEQR; thus, if<br>
...
*>                 the j-th row/column.  This property allows SHSEIN to<br>
...
*>                 case, SHSEIN must always perform inverse iteration<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is REAL array, dimension ((N+2)*N)<br>
*> \endverbatim<br>
*><br>
*> \param[out] IFAILL<br>
*> \verbatim<br>
...
*<br>
*> \htmlonly<br>
*> Download SHSEQR + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/shseqr.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/shseqr.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/shseqr.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE SHSEQR( JOB, COMPZ, N, ILO, IHI, H, LDH, WR, WI, Z,<br>
...
*> \verbatim<br>
*><br>
*>    SHSEQR computes the eigenvalues of a Hessenberg matrix H<br>
...
*>           set by a previous call to SGEBAL, and then passed to ZGEHRD<br>
*>           when the matrix output by SGEBAL is reduced to Hessenberg<br>
...
*>           below.)<br>
*><br>
*>           Unlike earlier versions of SHSEQR, this subroutine may<br>
...
*>           Normally Q is the orthogonal matrix generated by SORGHR<br>
*>           after the call to SGEHRD which formed the Hessenberg matrix<br>
...
*>           size.<br>
*><br>
*>           If LWORK = -1, then SHSEQR does a workspace query.<br>
*>           In this case, SHSEQR checks the input parameters and<br>
...
*>                    value<br>
*>           .GT. 0:  if INFO = i, SHSEQR failed to compute all of<br>
...
*>             ILAENV(ISPEC,'SHSEQR',JOB(:1)//COMPZ(:1),N,ILO,IHI,LWORK).<br>
...
*><br>
*>            ISPEC=12: The SLAHQR vs SLAQR0 crossover point.<br>
...
*>                       SLAHQR and this parameter is ignored.  See<br>
