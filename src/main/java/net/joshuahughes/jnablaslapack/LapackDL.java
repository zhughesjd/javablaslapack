...
*<br>
*> \htmlonly<br>
*> Download DLABAD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlabad.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlabad.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlabad.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLABAD( SMALL, LARGE )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       DOUBLE PRECISION   LARGE, SMALL<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLABAD takes as input the values computed by DLAMCH for underflow and<br>
...
*> the values computed by DLAMCH.  This subroutine is needed because<br>
*> DLAMCH does not compensate for poor arithmetic in the upper half of<br>
...
*> \verbatim<br>
*>          SMALL is DOUBLE PRECISION<br>
*>          On entry, the underflow threshold as computed by DLAMCH.<br>
...
*> \verbatim<br>
*>          LARGE is DOUBLE PRECISION<br>
*>          On entry, the overflow threshold as computed by DLAMCH.<br>
*>          On exit, if LOG10(LARGE) is sufficiently large, the square<br>
...
/**
*> \brief \b DLABRD reduces the first nb rows and columns of a general matrix to a bidiagonal form.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLABRD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlabrd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlabrd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlabrd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLABRD( M, N, NB, A, LDA, D, E, TAUQ, TAUP, X, LDX, Y,<br>
*                          LDY )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> DLABRD reduces the first NB rows and columns of a real general<br>
...
*> bidiagonal form.<br>
*><br>
*> This is an auxiliary routine called by DGEBRD<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*> \param[out] TAUQ<br>
*> \verbatim<br>
*>          TAUQ is DOUBLE PRECISION array dimension (NB)<br>
...
*> \param[out] TAUP<br>
*> \verbatim<br>
*>          TAUP is DOUBLE PRECISION array, dimension (NB)<br>
*>          The scalar factors of the elementary reflectors which<br>
...
*> \param[out] X<br>
*> \verbatim<br>
*>          X is DOUBLE PRECISION array, dimension (LDX,NB)<br>
...
*> \param[out] Y<br>
*> \verbatim<br>
*>          Y is DOUBLE PRECISION array, dimension (LDY,NB)<br>
...
/**
*> \brief \b DLACN2 estimates the 1-norm of a square matrix, using reverse communication for evaluating matrix-vector products.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLACN2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlacn2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlacn2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlacn2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLACN2( N, V, X, ISGN, EST, KASE, ISAVE )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            KASE, N<br>
...
*> \verbatim<br>
*><br>
*> DLACN2 estimates the 1-norm of a square, real matrix A.<br>
...
*> \param[out] V<br>
*> \verbatim<br>
*>          V is DOUBLE PRECISION array, dimension (N)<br>
...
*>               A * X,   if KASE=1,<br>
*>               A**T * X,  if KASE=2,<br>
*>         and DLACN2 must be re-called with all the other parameters<br>
*>         unchanged.<br>
*> \endverbatim<br>
*><br>
*> \param[out] ISGN<br>
...
*>         unchanged from the previous call to DLACN2.<br>
...
*><br>
*>  This is a thread safe version of DLACON, which uses the array ISAVE<br>
...
/**
*> \brief \b DLACON estimates the 1-norm of a square matrix, using reverse communication for evaluating matrix-vector products.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLACON + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlacon.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlacon.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlacon.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLACON( N, V, X, ISGN, EST, KASE )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            KASE, N<br>
*       DOUBLE PRECISION   EST<br>
...
*> \verbatim<br>
*><br>
*> DLACON estimates the 1-norm of a square, real matrix A.<br>
*> Reverse communication is used for evaluating matrix-vector products.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*>               A * X,   if KASE=1,<br>
*>               A**T * X,  if KASE=2,<br>
*>         and DLACON must be re-called with all the other parameters<br>
*>         unchanged.<br>
*> \endverbatim<br>
*><br>
*> \param[out] ISGN<br>
...
*>         unchanged from the previous call to DLACON.<br>
*>         On exit, EST is an estimate (a lower bound) for norm(A). <br>
*> \endverbatim<br>
*><br>
*> \param[in,out] KASE<br>
*> \verbatim<br>
*>          KASE is INTEGER<br>
*>         On the initial call to DLACON, KASE should be 0.<br>
*>         On an intermediate return, KASE will be 1 or 2, indicating<br>
*>         whether X should be overwritten by A * X  or A**T * X.<br>
*>         On the final return from DLACON, KASE will again be 0.<br>
*> \endverbatim<br>
*<br>
*  Authors:<br>
*  ========<br>
...
/**
*> \brief \b DLACPY copies all or part of one two-dimensional array to another.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLACPY + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlacpy.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlacpy.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlacpy.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLACPY( UPLO, M, N, A, LDA, B, LDB )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          UPLO<br>
...
*> \verbatim<br>
*><br>
*> DLACPY copies all or part of a two-dimensional matrix A to another<br>
*> matrix B.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
/**
*> \brief \b DLADIV performs complex division in real arithmetic, avoiding unnecessary overflow.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLADIV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dladiv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dladiv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dladiv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLADIV( A, B, C, D, P, Q )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       DOUBLE PRECISION   A, B, C, D, P, Q<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLADIV performs complex division in  real arithmetic<br>
*><br>
*>                       a + i*b<br>
*>            p + i*q = ---------<br>
*>                       c + i*d<br>
...
*> \param[in] A<br>
*> \verbatim<br>
*>          A is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[in] B<br>
*> \verbatim<br>
*>          B is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[in] C<br>
*> \verbatim<br>
...
*> \param[in] D<br>
*> \verbatim<br>
*>          D is DOUBLE PRECISION<br>
*>          The scalars a, b, c, and d in the above expression.<br>
*> \endverbatim<br>
*><br>
*> \param[out] P<br>
*> \verbatim<br>
*>          P is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[out] Q<br>
*> \verbatim<br>
*>          Q is DOUBLE PRECISION<br>
...
/**
*> \brief \b DLAE2 computes the eigenvalues of a 2-by-2 symmetric matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAE2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlae2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlae2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlae2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAE2( A, B, C, RT1, RT2 )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       DOUBLE PRECISION   A, B, C, RT1, RT2<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLAE2  computes the eigenvalues of a 2-by-2 symmetric matrix<br>
*>    [  A   B  ]<br>
*>    [  B   C  ].<br>
...
/**
*> \brief \b DLAEBZ computes the number of eigenvalues of a real symmetric tridiagonal matrix which are less than or equal to a given value, and performs other tasks required by the routine sstebz.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAEBZ + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaebz.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaebz.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaebz.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
...
*> \verbatim<br>
*><br>
*> DLAEBZ contains the iteration loops which compute and use the<br>
...
*>          Other values will cause DLAEBZ to return with INFO=-1.<br>
*> \endverbatim<br>
*><br>
*> \param[in] NITMAX<br>
*> \verbatim<br>
...
*>          are generated, then DLAEBZ will quit with INFO=MMAX+1.<br>
*> \endverbatim<br>
*><br>
*> \param[in] MINP<br>
*> \verbatim<br>
...
*> \param[in] E2<br>
*> \verbatim<br>
*>          E2 is DOUBLE PRECISION array, dimension (N)<br>
...
*> \param[in,out] AB<br>
*> \verbatim<br>
*>          AB is DOUBLE PRECISION array, dimension (MMAX,2)<br>
...
*> \param[in,out] C<br>
*> \verbatim<br>
*>          C is DOUBLE PRECISION array, dimension (MMAX)<br>
...
*>             NAB(i,j)=N(AB(i,j)), from a previous call to DLAEBZ with<br>
*>             IJOB=1.<br>
...
*>             distinctive value(s) before DLAEBZ is called.<br>
*> \endverbatim<br>
*><br>
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is DOUBLE PRECISION array, dimension (MMAX)<br>
*>          Workspace.<br>
*> \endverbatim<br>
*><br>
*> \param[out] IWORK<br>
...
*>  for two purposes:<br>
*><br>
*>  (a) finding eigenvalues.  In this case, DLAEBZ should have one or<br>
*>      more initial intervals set up in AB, and DLAEBZ should be called<br>
...
*>      interval does not lie in (a,b).  DLAEBZ is then called with<br>
...
/**
*> \brief \b DLAED0 used by sstedc. Computes all eigenvalues and corresponding eigenvectors of an unreduced symmetric tridiagonal matrix using the divide and conquer method.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAED0 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaed0.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaed0.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaed0.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAED0( ICOMPQ, QSIZ, N, D, E, Q, LDQ, QSTORE, LDQS,<br>
*                          WORK, IWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       .. Array Arguments ..<br>
*       INTEGER            IWORK( * )<br>
*       DOUBLE PRECISION   D( * ), E( * ), Q( LDQ, * ), QSTORE( LDQS, * ),<br>
*      $                   WORK( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> DLAED0 computes all eigenvalues and corresponding eigenvectors of a<br>
...
*> \param[out] QSTORE<br>
*> \verbatim<br>
*>          QSTORE is DOUBLE PRECISION array, dimension (LDQS, N)<br>
...
/**
*> \brief \b DLAED1 used by sstedc. Computes the updated eigensystem of a diagonal matrix after modification by a rank-one symmetric matrix. Used when the original matrix is tridiagonal.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAED1 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaed1.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaed1.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaed1.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAED1( N, D, Q, LDQ, INDXQ, RHO, CUTPNT, WORK, IWORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       DOUBLE PRECISION   D( * ), Q( LDQ, * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLAED1 computes the updated eigensystem of a diagonal<br>
...
*> eigenvalues and eigenvectors of a tridiagonal matrix.  DLAED7 handles<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is DOUBLE PRECISION array, dimension (4*N + N**2)<br>
*> \endverbatim<br>
*><br>
*> \param[out] IWORK<br>
*> \verbatim<br>
...
/**
*> \brief \b DLAED2 used by sstedc. Merges eigenvalues and deflates secular equation. Used when the original matrix is tridiagonal.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAED2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaed2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaed2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaed2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAED2( K, N, N1, D, Q, LDQ, INDXQ, RHO, Z, DLAMDA, W,<br>
...
*      $                   INDXQ( * )<br>
*       DOUBLE PRECISION   D( * ), DLAMDA( * ), Q( LDQ, * ), Q2( * ),<br>
*      $                   W( * ), Z( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> DLAED2 merges the two sets of eigenvalues together into a single<br>
...
*>         DLAED3 to form the secular equation.<br>
*> \endverbatim<br>
*><br>
*> \param[out] W<br>
*> \verbatim<br>
...
*>         which will be passed to DLAED3.<br>
*> \endverbatim<br>
*><br>
*> \param[out] Q2<br>
*> \verbatim<br>
*>          Q2 is DOUBLE PRECISION array, dimension (N1**2+(N-N1)**2)<br>
*>         A copy of the first K eigenvectors which will be used by<br>
*>         DLAED3 in a matrix multiply (DGEMM) to solve for the new<br>
*>         eigenvectors.<br>
*> \endverbatim<br>
*><br>
*> \param[out] INDX<br>
...
/**
*> \brief \b DLAED3 used by sstedc. Finds the roots of the secular equation and updates the eigenvectors. Used when the original matrix is tridiagonal.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAED3 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaed3.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaed3.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaed3.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAED3( K, N, N1, D, Q, LDQ, RHO, DLAMDA, Q2, INDX,<br>
*                          CTOT, W, S, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, K, LDQ, N, N1<br>
...
*> \verbatim<br>
*><br>
*> DLAED3 finds the roots of the secular equation, as defined by the<br>
*> values in D, W, and RHO, between 1 and K.  It makes the<br>
*> appropriate calls to DLAED4 and then updates the eigenvectors by<br>
...
*> \verbatim<br>
*>          DLAMDA is DOUBLE PRECISION array, dimension (K)<br>
...
*>          The rows of the eigenvectors found by DLAED4 must be likewise<br>
...
*> \param[in,out] W<br>
*> \verbatim<br>
*>          W is DOUBLE PRECISION array, dimension (K)<br>
...
*> \param[out] S<br>
*> \verbatim<br>
*>          S is DOUBLE PRECISION array, dimension (N1 + 1)*K<br>
...
/**
*> \brief \b DLAED4 used by sstedc. Finds a single root of the secular equation.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAED4 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaed4.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaed4.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaed4.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAED4( N, I, D, Z, DELTA, RHO, DLAM, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            I, INFO, N<br>
*       DOUBLE PRECISION   DLAM, RHO<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   D( * ), DELTA( * ), Z( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \param[out] DELTA<br>
*> \verbatim<br>
*>          DELTA is DOUBLE PRECISION array, dimension (N)<br>
*>         If N .GT. 2, DELTA contains (D(j) - lambda_I) in its  j-th<br>
*>         component.  If N = 1, then DELTA(1) = 1. If N = 2, see DLAED5<br>
*>         for detail. The vector DELTA contains the information necessary<br>
*>         to construct the eigenvectors by DLAED3 and DLAED9.<br>
*> \endverbatim<br>
*><br>
*> \param[in] RHO<br>
*> \verbatim<br>
...
/**
*> \brief \b DLAED5 used by sstedc. Solves the 2-by-2 secular equation.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAED5 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaed5.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaed5.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaed5.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAED5( I, D, Z, DELTA, RHO, DLAM )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            I<br>
*       DOUBLE PRECISION   DLAM, RHO<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   D( 2 ), DELTA( 2 ), Z( 2 )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \param[in] D<br>
*> \verbatim<br>
*>          D is DOUBLE PRECISION array, dimension (2)<br>
*>         The original eigenvalues.  We assume D(1) < D(2).<br>
*> \endverbatim<br>
*><br>
*> \param[in] Z<br>
*> \verbatim<br>
*>          Z is DOUBLE PRECISION array, dimension (2)<br>
*>         The components of the updating vector.<br>
*> \endverbatim<br>
*><br>
*> \param[out] DELTA<br>
*> \verbatim<br>
*>          DELTA is DOUBLE PRECISION array, dimension (2)<br>
...
/**
*> \brief \b DLAED6 used by sstedc. Computes one Newton step in solution of the secular equation.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAED6 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaed6.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaed6.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaed6.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAED6( KNITER, ORGATI, RHO, D, Z, FINIT, TAU, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       LOGICAL            ORGATI<br>
*       INTEGER            INFO, KNITER<br>
*       DOUBLE PRECISION   FINIT, RHO, TAU<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   D( 3 ), Z( 3 )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLAED6 computes the positive or negative root (closest to the origin)<br>
*> of<br>
*>                  z(1)        z(2)        z(3)<br>
*> f(x) =   rho + --------- + ---------- + ---------<br>
...
*><br>
*> This routine will be called by DLAED4 when necessary. In most cases,<br>
...
*>               Refer to DLAED4 for its significance.<br>
*> \endverbatim<br>
*><br>
*> \param[in] ORGATI<br>
*> \verbatim<br>
...
*> \param[in] D<br>
*> \verbatim<br>
*>          D is DOUBLE PRECISION array, dimension (3)<br>
*>               D satisfies d(1) < d(2) < d(3).<br>
*> \endverbatim<br>
*><br>
*> \param[in] Z<br>
*> \verbatim<br>
*>          Z is DOUBLE PRECISION array, dimension (3)<br>
*>               Each of the elements in z must be positive.<br>
*> \endverbatim<br>
*><br>
*> \param[in] FINIT<br>
*> \verbatim<br>
*>          FINIT is DOUBLE PRECISION<br>
...
/**
*> \brief \b DLAED7 used by sstedc. Computes the updated eigensystem of a diagonal matrix after modification by a rank-one symmetric matrix. Used when the original matrix is dense.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAED7 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaed7.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaed7.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaed7.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAED7( ICOMPQ, N, QSIZ, TLVLS, CURLVL, CURPBM, D, Q,<br>
...
*       DOUBLE PRECISION   D( * ), GIVNUM( 2, * ), Q( LDQ, * ),<br>
*      $                   QSTORE( * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> DLAED7 computes the updated eigensystem of a diagonal<br>
*> matrix after modification by a rank-one symmetric matrix. This<br>
*> routine is used only for the eigenproblem which requires all<br>
*> eigenvalues and optionally eigenvectors of a dense symmetric matrix<br>
*> that has been reduced to tridiagonal form.  DLAED1 handles<br>
...
*>       the Z vector.  For each such occurrence the dimension of the<br>
*>       secular equation problem is reduced by one.  This stage is<br>
*>       performed by the routine DLAED8.<br>
*><br>
*>       The second stage consists of calculating the updated<br>
*>       eigenvalues. This is done by finding the roots of the secular<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is DOUBLE PRECISION array, dimension (3*N+2*QSIZ*N)<br>
*> \endverbatim<br>
*><br>
*> \param[out] IWORK<br>
*> \verbatim<br>
...
/**
*> \brief \b DLAED8 used by sstedc. Merges eigenvalues and deflates secular equation. Used when the original matrix is dense.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAED8 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaed8.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaed8.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaed8.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAED8( ICOMPQ, K, N, QSIZ, D, Q, LDQ, INDXQ, RHO,<br>
...
*      $                   INDXQ( * ), PERM( * )<br>
*       DOUBLE PRECISION   D( * ), DLAMDA( * ), GIVNUM( 2, * ),<br>
...
*> \verbatim<br>
*><br>
*> DLAED8 merges the two sets of eigenvalues together into a single<br>
*> sorted set.  Then it tries to deflate the size of the problem.<br>
*> There are two ways in which deflation can occur:  when two or more<br>
...
*>         a copy of the first K eigenvectors which will be used by<br>
*>         DLAED7 in a matrix multiply (DGEMM) to update the new<br>
*>         eigenvectors.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDQ2<br>
...
/**
*> \brief \b DLAED9 used by sstedc. Finds the roots of the secular equation and updates the eigenvectors. Used when the original matrix is dense.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAED9 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaed9.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaed9.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaed9.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAED9( K, KSTART, KSTOP, N, D, Q, LDQ, RHO, DLAMDA, W,<br>
*                          S, LDS, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   D( * ), DLAMDA( * ), Q( LDQ, * ), S( LDS, * ),<br>
*      $                   W( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> DLAED9 finds the roots of the secular equation, as defined by the<br>
*> values in D, Z, and RHO, between KSTART and KSTOP.  It makes the<br>
*> appropriate calls to DLAED4 and then stores the new matrix of<br>
...
*> \param[out] S<br>
*> \verbatim<br>
*>          S is DOUBLE PRECISION array, dimension (LDS, K)<br>
*>          Will contain the eigenvectors of the repaired matrix which<br>
...
/**
*> \brief \b DLAEDA used by sstedc. Computes the Z vector determining the rank-one modification of the diagonal matrix. Used when the original matrix is dense.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAEDA + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaeda.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaeda.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaeda.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAEDA( N, TLVLS, CURLVL, CURPBM, PRMPTR, PERM, GIVPTR,<br>
...
*      $                   PRMPTR( * ), QPTR( * )<br>
*       DOUBLE PRECISION   GIVNUM( 2, * ), Q( * ), Z( * ), ZTEMP( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLAEDA computes the Z vector corresponding to the merge step in the<br>
...
*> \param[in] Q<br>
*> \verbatim<br>
*>          Q is DOUBLE PRECISION array, dimension (N**2)<br>
...
*> \param[out] ZTEMP<br>
*> \verbatim<br>
*>          ZTEMP is DOUBLE PRECISION array, dimension (N)<br>
*> \endverbatim<br>
*><br>
*> \param[out] INFO<br>
*> \verbatim<br>
...
/**
*> \brief \b DLAEIN computes a specified right or left eigenvector of an upper Hessenberg matrix by inverse iteration.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAEIN + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaein.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaein.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaein.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAEIN( RIGHTV, NOINIT, N, H, LDH, WR, WI, VR, VI, B,<br>
*                          LDB, WORK, EPS3, SMLNUM, BIGNUM, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       LOGICAL            NOINIT, RIGHTV<br>
*       INTEGER            INFO, LDB, LDH, N<br>
*       DOUBLE PRECISION   BIGNUM, EPS3, SMLNUM, WI, WR<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   B( LDB, * ), H( LDH, * ), VI( * ), VR( * ),<br>
*      $                   WORK( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> DLAEIN uses inverse iteration to find a right or left eigenvector<br>
...
*> \param[in] WR<br>
*> \verbatim<br>
*>          WR is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[in] WI<br>
*> \verbatim<br>
*>          WI is DOUBLE PRECISION<br>
...
*> \param[in,out] VR<br>
*> \verbatim<br>
*>          VR is DOUBLE PRECISION array, dimension (N)<br>
*> \endverbatim<br>
*><br>
*> \param[in,out] VI<br>
*> \verbatim<br>
*>          VI is DOUBLE PRECISION array, dimension (N)<br>
...
/**
*> \brief \b DLAEV2 computes the eigenvalues and eigenvectors of a 2-by-2 symmetric/Hermitian matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAEV2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaev2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaev2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaev2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAEV2( A, B, C, RT1, RT2, CS1, SN1 )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       DOUBLE PRECISION   A, B, C, CS1, RT1, RT2, SN1<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLAEV2 computes the eigendecomposition of a 2-by-2 symmetric matrix<br>
*>    [  A   B  ]<br>
*>    [  B   C  ].<br>
...
/**
*> \brief \b DLAEXC swaps adjacent diagonal blocks of a real upper quasi-triangular matrix in Schur canonical form, by an orthogonal similarity transformation.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAEXC + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaexc.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaexc.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaexc.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAEXC( WANTQ, N, T, LDT, Q, LDQ, J1, N1, N2, WORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       LOGICAL            WANTQ<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   Q( LDQ, * ), T( LDT, * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLAEXC swaps adjacent diagonal blocks T11 and T22 of order 1 or 2 in<br>
...
/**
*> \brief \b DLAG2 computes the eigenvalues of a 2-by-2 generalized eigenvalue problem, with scaling as necessary to avoid over-/underflow.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAG2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlag2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlag2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlag2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAG2( A, LDA, B, LDB, SAFMIN, SCALE1, SCALE2, WR1,<br>
*                         WR2, WI )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            LDA, LDB<br>
*       DOUBLE PRECISION   SAFMIN, SCALE1, SCALE2, WI, WR1, WR2<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   A( LDA, * ), B( LDB, * )<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> DLAG2 computes the eigenvalues of a 2 x 2 generalized eigenvalue<br>
...
*> \param[in] A<br>
*> \verbatim<br>
*>          A is DOUBLE PRECISION array, dimension (LDA, 2)<br>
...
*> \param[in] B<br>
*> \verbatim<br>
*>          B is DOUBLE PRECISION array, dimension (LDB, 2)<br>
...
*> \param[in] SAFMIN<br>
*> \verbatim<br>
*>          SAFMIN is DOUBLE PRECISION<br>
*>          The smallest positive number s.t. 1/SAFMIN does not<br>
*>          overflow.  (This should always be DLAMCH('S') -- it is an<br>
*>          argument in order to avoid having to call DLAMCH frequently.)<br>
*> \endverbatim<br>
*><br>
*> \param[out] SCALE1<br>
*> \verbatim<br>
*>          SCALE1 is DOUBLE PRECISION<br>
...
/**
*> \brief \b DLAG2S converts a double precision matrix to a single precision matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAG2S + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlag2s.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlag2s.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlag2s.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAG2S( M, N, A, LDA, SA, LDSA, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> DLAG2S converts a DOUBLE PRECISION matrix, SA, to a SINGLE<br>
*> PRECISION matrix, A.<br>
*><br>
*> RMAX is the overflow for the SINGLE PRECISION arithmetic<br>
*> DLAG2S checks that all the entries of A are between -RMAX and<br>
...
/**
*> \brief \b DLAGS2 computes 2-by-2 orthogonal matrices U, V, and Q, and applies them to matrices A and B such that the rows of the transformed A and B are parallel.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAGS2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlags2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlags2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlags2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAGS2( UPPER, A1, A2, A3, B1, B2, B3, CSU, SNU, CSV,<br>
*                          SNV, CSQ, SNQ )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       LOGICAL            UPPER<br>
*       DOUBLE PRECISION   A1, A2, A3, B1, B2, B3, CSQ, CSU, CSV, SNQ,<br>
*      $                   SNU, SNV<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> DLAGS2 computes 2-by-2 orthogonal matrices U, V and Q, such<br>
...
/**
*> \brief \b DLAGTF computes an LU factorization of a matrix T-λI, where T is a general tridiagonal matrix, and λ a scalar, using partial pivoting with row interchanges.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAGTF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlagtf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlagtf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlagtf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAGTF( N, A, LAMBDA, B, C, TOL, D, IN, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, N<br>
*       DOUBLE PRECISION   LAMBDA, TOL<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       INTEGER            IN( * )<br>
...
*> \verbatim<br>
*><br>
*> DLAGTF factorizes the matrix (T - lambda*I), where T is an n by n<br>
...
*><br>
*> The parameter LAMBDA is included in the routine so that DLAGTF may<br>
*> be used, in conjunction with DLAGTS, to obtain eigenvectors of T by<br>
...
*> \param[in,out] A<br>
*> \verbatim<br>
*>          A is DOUBLE PRECISION array, dimension (N)<br>
...
*> \param[in,out] B<br>
*> \verbatim<br>
*>          B is DOUBLE PRECISION array, dimension (N-1)<br>
...
*> \param[in,out] C<br>
*> \verbatim<br>
*>          C is DOUBLE PRECISION array, dimension (N-1)<br>
...
*> \param[out] D<br>
*> \verbatim<br>
*>          D is DOUBLE PRECISION array, dimension (N-2)<br>
...
/**
*> \brief \b DLAGTM performs a matrix-matrix product of the form C = αAB+βC, where A is a tridiagonal matrix, B and C are rectangular matrices, and α and β are scalars, which may be 0, 1, or -1.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAGTM + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlagtm.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlagtm.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlagtm.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAGTM( TRANS, N, NRHS, ALPHA, DL, D, DU, X, LDX, BETA,<br>
*                          B, LDB )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANS<br>
...
*> \verbatim<br>
*><br>
*> DLAGTM performs a matrix-vector product of the form<br>
*><br>
...
/**
*> \brief \b DLAGTS solves the system of equations (T-λI)x = y or (T-λI)Tx = y,where T is a general tridiagonal matrix and λ a scalar, using the LU factorization computed by slagtf.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAGTS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlagts.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlagts.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlagts.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAGTS( JOB, N, A, B, C, D, IN, Y, TOL, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> DLAGTS may be used to solve one of the systems of equations<br>
*><br>
...
*>    (T - lambda*I) = P*L*U ,<br>
*><br>
*> by routine DLAGTF. The choice of equation to be solved is<br>
...
*> \verbatim<br>
*>          JOB is INTEGER<br>
*>          Specifies the job to be performed by DLAGTS as follows:<br>
...
*>          of U as returned from DLAGTF.<br>
*> \endverbatim<br>
*><br>
*> \param[in] IN<br>
*> \verbatim<br>
...
*> \param[in,out] Y<br>
*> \verbatim<br>
*>          Y is DOUBLE PRECISION array, dimension (N)<br>
...
/**
*> \brief \b DLAGV2 computes the Generalized Schur factorization of a real 2-by-2 matrix pencil (A,B) where B is upper triangular.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAGV2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlagv2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlagv2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlagv2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAGV2( A, LDA, B, LDB, ALPHAR, ALPHAI, BETA, CSL, SNL,<br>
*                          CSR, SNR )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            LDA, LDB<br>
*       DOUBLE PRECISION   CSL, CSR, SNL, SNR<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   A( LDA, * ), ALPHAI( 2 ), ALPHAR( 2 ),<br>
*      $                   B( LDB, * ), BETA( 2 )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> DLAGV2 computes the Generalized Schur factorization of a real 2-by-2<br>
...
*> \param[out] ALPHAR<br>
*> \verbatim<br>
*>          ALPHAR is DOUBLE PRECISION array, dimension (2)<br>
*> \endverbatim<br>
*><br>
*> \param[out] ALPHAI<br>
*> \verbatim<br>
*>          ALPHAI is DOUBLE PRECISION array, dimension (2)<br>
*> \endverbatim<br>
*><br>
*> \param[out] BETA<br>
*> \verbatim<br>
*>          BETA is DOUBLE PRECISION array, dimension (2)<br>
...
/**
*> \brief \b DLAHQR computes the eigenvalues and Schur factorization of an upper Hessenberg matrix, using the double-shift/single-shift QR algorithm.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAHQR + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlahqr.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlahqr.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlahqr.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAHQR( WANTT, WANTZ, N, ILO, IHI, H, LDH, WR, WI,<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   H( LDH, * ), WI( * ), WR( * ), Z( LDZ, * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*>    DLAHQR is an auxiliary routine called by DHSEQR to update the<br>
*>    eigenvalues and Schur decomposition already computed by DHSEQR, by<br>
...
*>          ILO = 1). DLAHQR works primarily with the Hessenberg<br>
...
*>          matrix Z of transformations accumulated by DHSEQR, and on<br>
...
*>          INFO is INTEGER<br>
*>           =   0: successful exit<br>
*>          .GT. 0: If INFO = i, DLAHQR failed to compute all the<br>
...
*>     This is a modified version of DLAHQR from LAPACK version 3.0.<br>
...
/**
*> \brief \b DLAHR2 reduces the specified number of first columns of a general rectangular matrix A so that elements below the specified subdiagonal are zero, and returns auxiliary matrices which are needed to apply the transformation to the unreduced part of A.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAHR2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlahr2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlahr2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlahr2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAHR2( N, K, NB, A, LDA, TAU, T, LDT, Y, LDY )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            K, LDA, LDT, LDY, N, NB<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION  A( LDA, * ), T( LDT, NB ), TAU( NB ),<br>
*      $                   Y( LDY, NB )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> DLAHR2 reduces the first NB columns of A real general n-BY-(n-k+1)<br>
...
*><br>
*> This is an auxiliary routine called by DGEHRD.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*> \param[in,out] A<br>
*> \verbatim<br>
*>          A is DOUBLE PRECISION array, dimension (LDA,N-K+1)<br>
...
*> \param[out] TAU<br>
*> \verbatim<br>
*>          TAU is DOUBLE PRECISION array, dimension (NB)<br>
...
*> \param[out] T<br>
*> \verbatim<br>
*>          T is DOUBLE PRECISION array, dimension (LDT,NB)<br>
...
/**
*> \brief \b DLAIC1 applies one step of incremental condition estimation.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAIC1 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaic1.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaic1.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaic1.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAIC1( JOB, J, X, SEST, W, GAMMA, SESTPR, S, C )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            J, JOB<br>
*       DOUBLE PRECISION   C, GAMMA, S, SEST, SESTPR<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   W( J ), X( J )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLAIC1 applies one step of incremental condition estimation in<br>
...
*>          twonorm(L*x) = sest<br>
*> Then DLAIC1 computes sestpr, s, c such that<br>
*> the vector<br>
*>                 [ s*x ]<br>
*>          xhat = [  c  ]<br>
...
*> \param[in] X<br>
*> \verbatim<br>
*>          X is DOUBLE PRECISION array, dimension (J)<br>
*>          The j-vector x.<br>
*> \endverbatim<br>
*><br>
*> \param[in] SEST<br>
...
*> \param[in] W<br>
*> \verbatim<br>
*>          W is DOUBLE PRECISION array, dimension (J)<br>
*>          The j-vector w.<br>
*> \endverbatim<br>
*><br>
*> \param[in] GAMMA<br>
*> \verbatim<br>
*>          GAMMA is DOUBLE PRECISION<br>
...
/**
*> \brief \b DLAISNAN tests input for NaN by comparing two arguments for inequality.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAISNAN + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaisnan.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaisnan.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaisnan.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       LOGICAL FUNCTION DLAISNAN( DIN1, DIN2 )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       DOUBLE PRECISION   DIN1, DIN2<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> over-optimization in DISNAN.<br>
*><br>
*> DLAISNAN checks for NaNs by comparing its two arguments for<br>
...
*> \param[in] DIN1<br>
*> \verbatim<br>
*>          DIN1 is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[in] DIN2<br>
*> \verbatim<br>
*>          DIN2 is DOUBLE PRECISION<br>
...
/**
*> \brief \b DLALN2 solves a 1-by-1 or 2-by-2 linear system of equations of the specified form.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLALN2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaln2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaln2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaln2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLALN2( LTRANS, NA, NW, SMIN, CA, A, LDA, D1, D2, B,<br>
*                          LDB, WR, WI, X, LDX, SCALE, XNORM, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       LOGICAL            LTRANS<br>
*       INTEGER            INFO, LDA, LDB, LDX, NA, NW<br>
*       DOUBLE PRECISION   CA, D1, D2, SCALE, SMIN, WI, WR, XNORM<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   A( LDA, * ), B( LDB, * ), X( LDX, * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLALN2 solves a system of the form  (ca A - w D ) X = s B<br>
...
*><br>
*> "s" is a scaling factor (.LE. 1), computed by DLALN2, which is<br>
...
*> \param[in] CA<br>
*> \verbatim<br>
*>          CA is DOUBLE PRECISION<br>
*>          The coefficient c, which A is multiplied by.<br>
*> \endverbatim<br>
*><br>
*> \param[in] A<br>
*> \verbatim<br>
*>          A is DOUBLE PRECISION array, dimension (LDA,NA)<br>
...
*> \param[out] X<br>
*> \verbatim<br>
*>          X is DOUBLE PRECISION array, dimension (LDX,NW)<br>
*>          The NA x NW matrix X (unknowns), as computed by DLALN2.<br>
...
/**
*> \brief \b DLALS0 applies back multiplying factors in solving the least squares problem using divide and conquer SVD approach. Used by sgelsd.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLALS0 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlals0.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlals0.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlals0.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLALS0( ICOMPQ, NL, NR, SQRE, NRHS, B, LDB, BX, LDBX,<br>
...
*       DOUBLE PRECISION   B( LDB, * ), BX( LDBX, * ), DIFL( * ),<br>
...
*> \verbatim<br>
*><br>
*> DLALS0 applies back the multiplying factors of either the left or the<br>
...
*> \param[out] BX<br>
*> \verbatim<br>
*>          BX is DOUBLE PRECISION array, dimension ( LDBX, NRHS )<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDBX<br>
*> \verbatim<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is DOUBLE PRECISION array, dimension ( K )<br>
*> \endverbatim<br>
*><br>
*> \param[out] INFO<br>
*> \verbatim<br>
...
/**
*> \brief \b DLALSA computes the SVD of the coefficient matrix in compact form. Used by sgelsd.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLALSA + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlalsa.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlalsa.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlalsa.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLALSA( ICOMPQ, SMLSIZ, N, NRHS, B, LDB, BX, LDBX, U,<br>
...
*      $                   K( * ), PERM( LDGCOL, * )<br>
*       DOUBLE PRECISION   B( LDB, * ), BX( LDBX, * ), C( * ),<br>
...
*> \verbatim<br>
*><br>
*> DLALSA is an itermediate step in solving the least squares problem<br>
...
*> matrices.).<br>
*><br>
*> If ICOMPQ = 0, DLALSA applies the inverse of the left singular vector<br>
*> matrix of an upper bidiagonal matrix to the right hand side; and if<br>
*> ICOMPQ = 1, DLALSA applies the right singular vector matrix to the<br>
*> right hand side. The singular vector matrices were generated in<br>
*> compact form by DLALSA.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
/**
*> \brief \b DLALSD uses the singular value decomposition of A to solve the least squares problem.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLALSD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlalsd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlalsd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlalsd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLALSD( UPLO, SMLSIZ, N, NRHS, D, E, B, LDB, RCOND,<br>
...
*       .. Array Arguments ..<br>
*       INTEGER            IWORK( * )<br>
*       DOUBLE PRECISION   B( LDB, * ), D( * ), E( * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLALSD uses the singular value decomposition of A to solve the least<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is DOUBLE PRECISION array, dimension at least<br>
...
/**
*> \brief \b DLAMRG creates a permutation list to merge the entries of two independently sorted sets into a single set sorted in ascending order.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAMRG + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlamrg.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlamrg.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlamrg.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAMRG( N1, N2, A, DTRD1, DTRD2, INDEX )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            DTRD1, DTRD2, N1, N2<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       INTEGER            INDEX( * )<br>
...
*> \verbatim<br>
*><br>
*> DLAMRG will create a permutation list which will merge the elements<br>
...
*> \param[in] A<br>
*> \verbatim<br>
*>          A is DOUBLE PRECISION array, dimension (N1+N2)<br>
...
*>         subset of A is sorted in ascending (DTRDx = 1) or descending<br>
*>         (DTRDx = -1) order.<br>
*> \endverbatim<br>
*><br>
*> \param[out] INDEX<br>
...
/**
*> \brief \b DLANEG computes the Sturm count.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLANEG + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaneg.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaneg.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaneg.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       INTEGER FUNCTION DLANEG( N, D, LLD, SIGMA, PIVMIN, R )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            N, R<br>
*       DOUBLE PRECISION   PIVMIN, SIGMA<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   D( * ), LLD( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLANEG computes the Sturm count, the number of negative pivots<br>
...
*><br>
*> This routine is called from DLARRB.<br>
*><br>
...
/**
*> \brief \b DLANGB returns the value of the 1-norm, Frobenius norm, infinity-norm, or the largest absolute value of any element of general band matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLANGB + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlangb.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlangb.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlangb.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLANGB( NORM, N, KL, KU, AB, LDAB,<br>
*                        WORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          NORM<br>
...
*> \verbatim<br>
*><br>
*> DLANGB  returns the value of the one norm,  or the Frobenius norm, or<br>
...
*> \verbatim<br>
*><br>
*>    DLANGB = ( max(abs(A(i,j))), NORM = 'M' or 'm'<br>
*>             (<br>
...
*>          Specifies the value to be returned in DLANGB as described<br>
*>          above.<br>
*> \endverbatim<br>
*><br>
*> \param[in] N<br>
*> \verbatim<br>
*>          N is INTEGER<br>
*>          The order of the matrix A.  N >= 0.  When N = 0, DLANGB is<br>
*>          set to zero.<br>
*> \endverbatim<br>
*><br>
*> \param[in] KL<br>
...
*> \date September 2012<br>
*<br>
*> \ingroup doubleGBauxiliary<br>
*<br>
*  =====================================================================<br>
*/
	public double dlangb_(CHARACTER NORM,INTEGER N,INTEGER KL,INTEGER KU,double[] AB,INTEGER LDAB,double[] WORK);
/**
*> \brief \b DLANGE returns the value of the 1-norm, Frobenius norm, infinity-norm, or the largest absolute value of any element of a general rectangular matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLANGE + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlange.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlange.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlange.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLANGE( NORM, M, N, A, LDA, WORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          NORM<br>
*       INTEGER            LDA, M, N<br>
...
*> \verbatim<br>
*><br>
*> DLANGE  returns the value of the one norm,  or the Frobenius norm, or<br>
...
*> \verbatim<br>
*><br>
*>    DLANGE = ( max(abs(A(i,j))), NORM = 'M' or 'm'<br>
*>             (<br>
*>             ( norm1(A),         NORM = '1', 'O' or 'o'<br>
*>             (<br>
*>             ( normI(A),         NORM = 'I' or 'i'<br>
...
*> \verbatim<br>
*>          NORM is CHARACTER*1<br>
*>          Specifies the value to be returned in DLANGE as described<br>
*>          above.<br>
*> \endverbatim<br>
*><br>
*> \param[in] M<br>
...
/**
*> \brief \b DLANGT returns the value of the 1-norm, Frobenius norm, infinity-norm, or the largest absolute value of any element of a general tridiagonal matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLANGT + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlangt.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlangt.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlangt.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLANGT( NORM, N, DL, D, DU )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          NORM<br>
*       INTEGER            N<br>
...
*> \verbatim<br>
*><br>
*> DLANGT  returns the value of the one norm,  or the Frobenius norm, or<br>
*> the  infinity norm,  or the  element of  largest absolute value  of a<br>
...
*> \verbatim<br>
*><br>
*>    DLANGT = ( max(abs(A(i,j))), NORM = 'M' or 'm'<br>
*>             (<br>
*>             ( norm1(A),         NORM = '1', 'O' or 'o'<br>
*>             (<br>
*>             ( normI(A),         NORM = 'I' or 'i'<br>
...
*> \verbatim<br>
*>          NORM is CHARACTER*1<br>
*>          Specifies the value to be returned in DLANGT as described<br>
*>          above.<br>
*> \endverbatim<br>
*><br>
*> \param[in] N<br>
*> \verbatim<br>
*>          N is INTEGER<br>
*>          The order of the matrix A.  N >= 0.  When N = 0, DLANGT is<br>
*>          set to zero.<br>
*> \endverbatim<br>
*><br>
*> \param[in] DL<br>
...
/**
*> \brief \b DLANHS returns the value of the 1-norm, Frobenius norm, infinity-norm, or the largest absolute value of any element of an upper Hessenberg matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLANHS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlanhs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlanhs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlanhs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLANHS( NORM, N, A, LDA, WORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          NORM<br>
*       INTEGER            LDA, N<br>
...
*> \verbatim<br>
*><br>
*> DLANHS  returns the value of the one norm,  or the Frobenius norm, or<br>
*> the  infinity norm,  or the  element of  largest absolute value  of a<br>
...
*> \verbatim<br>
*><br>
*>    DLANHS = ( max(abs(A(i,j))), NORM = 'M' or 'm'<br>
*>             (<br>
*>             ( norm1(A),         NORM = '1', 'O' or 'o'<br>
*>             (<br>
*>             ( normI(A),         NORM = 'I' or 'i'<br>
...
*> \verbatim<br>
*>          NORM is CHARACTER*1<br>
*>          Specifies the value to be returned in DLANHS as described<br>
*>          above.<br>
*> \endverbatim<br>
*><br>
*> \param[in] N<br>
*> \verbatim<br>
*>          N is INTEGER<br>
*>          The order of the matrix A.  N >= 0.  When N = 0, DLANHS is<br>
*>          set to zero.<br>
*> \endverbatim<br>
*><br>
*> \param[in] A<br>
...
/**
*> \brief \b DLANSB returns the value of the 1-norm, or the Frobenius norm, or the infinity norm, or the element of largest absolute value of a symmetric band matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLANSB + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlansb.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlansb.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlansb.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLANSB( NORM, UPLO, N, K, AB, LDAB,<br>
*                        WORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> DLANSB  returns the value of the one norm,  or the Frobenius norm, or<br>
*> the  infinity norm,  or the element of  largest absolute value  of an<br>
...
*> \verbatim<br>
*><br>
*>    DLANSB = ( max(abs(A(i,j))), NORM = 'M' or 'm'<br>
*>             (<br>
*>             ( norm1(A),         NORM = '1', 'O' or 'o'<br>
*>             (<br>
*>             ( normI(A),         NORM = 'I' or 'i'<br>
...
*> \verbatim<br>
*>          NORM is CHARACTER*1<br>
*>          Specifies the value to be returned in DLANSB as described<br>
*>          above.<br>
*> \endverbatim<br>
*><br>
*> \param[in] UPLO<br>
...
*> \verbatim<br>
*>          N is INTEGER<br>
*>          The order of the matrix A.  N >= 0.  When N = 0, DLANSB is<br>
*>          set to zero.<br>
*> \endverbatim<br>
*><br>
*> \param[in] K<br>
...
/**
*> \brief \b DLANSF returns the value of the 1-norm, or the Frobenius norm, or the infinity norm, or the element of largest absolute value of a symmetric matrix in RFP format.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLANSF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlansf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlansf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlansf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLANSF( NORM, TRANSR, UPLO, N, A, WORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   A( 0: * ), WORK( 0: * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLANSF returns the value of the one norm, or the Frobenius norm, or<br>
*> the infinity norm, or the element of largest absolute value of a<br>
...
*> \verbatim<br>
*><br>
*>    DLANSF = ( max(abs(A(i,j))), NORM = 'M' or 'm'<br>
*>             (<br>
*>             ( norm1(A),         NORM = '1', 'O' or 'o'<br>
*>             (<br>
*>             ( normI(A),         NORM = 'I' or 'i'<br>
...
*> \verbatim<br>
*>          NORM is CHARACTER*1<br>
*>          Specifies the value to be returned in DLANSF as described<br>
*>          above.<br>
*> \endverbatim<br>
*><br>
*> \param[in] TRANSR<br>
...
*> \verbatim<br>
*>          N is INTEGER<br>
*>          The order of the matrix A. N >= 0. When N = 0, DLANSF is<br>
*>          set to zero.<br>
*> \endverbatim<br>
*><br>
*> \param[in] A<br>
...
/**
*> \brief \b DLANSP returns the value of the 1-norm, or the Frobenius norm, or the infinity norm, or the element of largest absolute value of a symmetric matrix supplied in packed form.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLANSP + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlansp.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlansp.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlansp.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLANSP( NORM, UPLO, N, AP, WORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          NORM, UPLO<br>
*       INTEGER            N<br>
...
*> \verbatim<br>
*><br>
*> DLANSP  returns the value of the one norm,  or the Frobenius norm, or<br>
*> the  infinity norm,  or the  element of  largest absolute value  of a<br>
...
*> \verbatim<br>
*><br>
*>    DLANSP = ( max(abs(A(i,j))), NORM = 'M' or 'm'<br>
*>             (<br>
*>             ( norm1(A),         NORM = '1', 'O' or 'o'<br>
*>             (<br>
*>             ( normI(A),         NORM = 'I' or 'i'<br>
...
*> \verbatim<br>
*>          NORM is CHARACTER*1<br>
*>          Specifies the value to be returned in DLANSP as described<br>
*>          above.<br>
*> \endverbatim<br>
*><br>
*> \param[in] UPLO<br>
...
*> \verbatim<br>
*>          N is INTEGER<br>
*>          The order of the matrix A.  N >= 0.  When N = 0, DLANSP is<br>
*>          set to zero.<br>
*> \endverbatim<br>
*><br>
*> \param[in] AP<br>
...
/**
*> \brief \b DLANST returns the value of the 1-norm, or the Frobenius norm, or the infinity norm, or the element of largest absolute value of a real symmetric tridiagonal matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLANST + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlanst.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlanst.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlanst.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLANST( NORM, N, D, E )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          NORM<br>
*       INTEGER            N<br>
...
*> \verbatim<br>
*><br>
*> DLANST  returns the value of the one norm,  or the Frobenius norm, or<br>
*> the  infinity norm,  or the  element of  largest absolute value  of a<br>
...
*> \verbatim<br>
*><br>
*>    DLANST = ( max(abs(A(i,j))), NORM = 'M' or 'm'<br>
*>             (<br>
*>             ( norm1(A),         NORM = '1', 'O' or 'o'<br>
*>             (<br>
*>             ( normI(A),         NORM = 'I' or 'i'<br>
...
*> \verbatim<br>
*>          NORM is CHARACTER*1<br>
*>          Specifies the value to be returned in DLANST as described<br>
*>          above.<br>
*> \endverbatim<br>
*><br>
*> \param[in] N<br>
*> \verbatim<br>
*>          N is INTEGER<br>
*>          The order of the matrix A.  N >= 0.  When N = 0, DLANST is<br>
*>          set to zero.<br>
*> \endverbatim<br>
*><br>
*> \param[in] D<br>
...
/**
*> \brief \b DLANSY returns the value of the 1-norm, or the Frobenius norm, or the infinity norm, or the element of largest absolute value of a real symmetric matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLANSY + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlansy.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlansy.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlansy.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLANSY( NORM, UPLO, N, A, LDA, WORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          NORM, UPLO<br>
*       INTEGER            LDA, N<br>
...
*> \verbatim<br>
*><br>
*> DLANSY  returns the value of the one norm,  or the Frobenius norm, or<br>
*> the  infinity norm,  or the  element of  largest absolute value  of a<br>
...
*> \verbatim<br>
*><br>
*>    DLANSY = ( max(abs(A(i,j))), NORM = 'M' or 'm'<br>
*>             (<br>
*>             ( norm1(A),         NORM = '1', 'O' or 'o'<br>
*>             (<br>
*>             ( normI(A),         NORM = 'I' or 'i'<br>
...
*> \verbatim<br>
*>          NORM is CHARACTER*1<br>
*>          Specifies the value to be returned in DLANSY as described<br>
*>          above.<br>
*> \endverbatim<br>
*><br>
*> \param[in] UPLO<br>
...
*> \verbatim<br>
*>          N is INTEGER<br>
*>          The order of the matrix A.  N >= 0.  When N = 0, DLANSY is<br>
*>          set to zero.<br>
*> \endverbatim<br>
*><br>
*> \param[in] A<br>
...
/**
*> \brief \b DLANTB returns the value of the 1-norm, or the Frobenius norm, or the infinity norm, or the element of largest absolute value of a triangular band matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLANTB + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlantb.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlantb.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlantb.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLANTB( NORM, UPLO, DIAG, N, K, AB,<br>
*                        LDAB, WORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> DLANTB  returns the value of the one norm,  or the Frobenius norm, or<br>
*> the  infinity norm,  or the element of  largest absolute value  of an<br>
...
*> \verbatim<br>
*><br>
*>    DLANTB = ( max(abs(A(i,j))), NORM = 'M' or 'm'<br>
*>             (<br>
*>             ( norm1(A),         NORM = '1', 'O' or 'o'<br>
*>             (<br>
*>             ( normI(A),         NORM = 'I' or 'i'<br>
...
*> \verbatim<br>
*>          NORM is CHARACTER*1<br>
*>          Specifies the value to be returned in DLANTB as described<br>
*>          above.<br>
*> \endverbatim<br>
*><br>
*> \param[in] UPLO<br>
...
*> \verbatim<br>
*>          N is INTEGER<br>
*>          The order of the matrix A.  N >= 0.  When N = 0, DLANTB is<br>
*>          set to zero.<br>
*> \endverbatim<br>
*><br>
*> \param[in] K<br>
...
/**
*> \brief \b DLANTP returns the value of the 1-norm, or the Frobenius norm, or the infinity norm, or the element of largest absolute value of a triangular matrix supplied in packed form.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLANTP + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlantp.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlantp.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlantp.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLANTP( NORM, UPLO, DIAG, N, AP, WORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          DIAG, NORM, UPLO<br>
*       INTEGER            N<br>
...
*> \verbatim<br>
*><br>
*> DLANTP  returns the value of the one norm,  or the Frobenius norm, or<br>
*> the  infinity norm,  or the  element of  largest absolute value  of a<br>
...
*> \verbatim<br>
*><br>
*>    DLANTP = ( max(abs(A(i,j))), NORM = 'M' or 'm'<br>
*>             (<br>
*>             ( norm1(A),         NORM = '1', 'O' or 'o'<br>
*>             (<br>
*>             ( normI(A),         NORM = 'I' or 'i'<br>
...
*> \verbatim<br>
*>          NORM is CHARACTER*1<br>
*>          Specifies the value to be returned in DLANTP as described<br>
*>          above.<br>
*> \endverbatim<br>
*><br>
*> \param[in] UPLO<br>
...
*> \verbatim<br>
*>          N is INTEGER<br>
*>          The order of the matrix A.  N >= 0.  When N = 0, DLANTP is<br>
*>          set to zero.<br>
*> \endverbatim<br>
*><br>
*> \param[in] AP<br>
...
/**
*> \brief \b DLANTR returns the value of the 1-norm, or the Frobenius norm, or the infinity norm, or the element of largest absolute value of a trapezoidal or triangular matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLANTR + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlantr.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlantr.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlantr.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLANTR( NORM, UPLO, DIAG, M, N, A, LDA,<br>
*                        WORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          DIAG, NORM, UPLO<br>
...
*> \verbatim<br>
*><br>
*> DLANTR  returns the value of the one norm,  or the Frobenius norm, or<br>
*> the  infinity norm,  or the  element of  largest absolute value  of a<br>
...
*> \verbatim<br>
*><br>
*>    DLANTR = ( max(abs(A(i,j))), NORM = 'M' or 'm'<br>
*>             (<br>
*>             ( norm1(A),         NORM = '1', 'O' or 'o'<br>
*>             (<br>
*>             ( normI(A),         NORM = 'I' or 'i'<br>
...
*> \verbatim<br>
*>          NORM is CHARACTER*1<br>
*>          Specifies the value to be returned in DLANTR as described<br>
*>          above.<br>
*> \endverbatim<br>
*><br>
*> \param[in] UPLO<br>
...
*>          UPLO = 'U', M <= N.  When M = 0, DLANTR is set to zero.<br>
*> \endverbatim<br>
*><br>
*> \param[in] N<br>
*> \verbatim<br>
...
*>          UPLO = 'L', N <= M.  When N = 0, DLANTR is set to zero.<br>
*> \endverbatim<br>
*><br>
*> \param[in] A<br>
*> \verbatim<br>
...
/**
*> \brief \b DLANV2 computes the Schur factorization of a real 2-by-2 nonsymmetric matrix in standard form.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLANV2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlanv2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlanv2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlanv2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLANV2( A, B, C, D, RT1R, RT1I, RT2R, RT2I, CS, SN )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       DOUBLE PRECISION   A, B, C, CS, D, RT1I, RT1R, RT2I, RT2R, SN<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLANV2 computes the Schur factorization of a real 2-by-2 nonsymmetric<br>
...
*> \param[out] RT1R<br>
*> \verbatim<br>
*>          RT1R is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[out] RT1I<br>
*> \verbatim<br>
*>          RT1I is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[out] RT2R<br>
*> \verbatim<br>
*>          RT2R is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[out] RT2I<br>
*> \verbatim<br>
*>          RT2I is DOUBLE PRECISION<br>
...
/**
*> \brief \b DLAPLL measures the linear dependence of two vectors.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAPLL + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlapll.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlapll.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlapll.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAPLL( N, X, INCX, Y, INCY, SSMIN )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \param[in,out] X<br>
*> \verbatim<br>
*>          X is DOUBLE PRECISION array,<br>
...
*> \param[in,out] Y<br>
*> \verbatim<br>
*>          Y is DOUBLE PRECISION array,<br>
...
/**
*> \brief \b DLAPMR rearranges rows of a matrix as specified by a permutation vector.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAPMR + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlapmr.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlapmr.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlapmr.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAPMR( FORWRD, M, N, X, LDX, K )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       LOGICAL            FORWRD<br>
*       INTEGER            LDX, M, N<br>
...
*> \verbatim<br>
*><br>
*> DLAPMR rearranges the rows of the M by N matrix X as specified<br>
...
/**
*> \brief \b DLAPMT performs a forward or backward permutation of the columns of a matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAPMT + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlapmt.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlapmt.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlapmt.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAPMT( FORWRD, M, N, X, LDX, K )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       LOGICAL            FORWRD<br>
*       INTEGER            LDX, M, N<br>
...
*> \verbatim<br>
*><br>
*> DLAPMT rearranges the columns of the M by N matrix X as specified<br>
...
/**
*> \brief \b DLAPY2 returns sqrt(x2+y2).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAPY2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlapy2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlapy2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlapy2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLAPY2( X, Y )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       DOUBLE PRECISION   X, Y<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> DLAPY2 returns sqrt(x**2+y**2), taking care not to cause unnecessary<br>
*> overflow.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*> \param[in] X<br>
*> \verbatim<br>
*>          X is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[in] Y<br>
*> \verbatim<br>
*>          Y is DOUBLE PRECISION<br>
...
/**
*> \brief \b DLAPY3 returns sqrt(x2+y2+z2).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAPY3 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlapy3.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlapy3.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlapy3.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLAPY3( X, Y, Z )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       DOUBLE PRECISION   X, Y, Z<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLAPY3 returns sqrt(x**2+y**2+z**2), taking care not to cause<br>
...
/**
*> \brief \b DLAQGB scales a general band matrix, using row and column scaling factors computed by sgbequ.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAQGB + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaqgb.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaqgb.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaqgb.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAQGB( M, N, KL, KU, AB, LDAB, R, C, ROWCND, COLCND,<br>
*                          AMAX, EQUED )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          EQUED<br>
...
*> \verbatim<br>
*><br>
*> DLAQGB equilibrates a general M by N band matrix A with KL<br>
...
/**
*> \brief \b DLAQGE scales a general rectangular matrix, using row and column scaling factors computed by sgeequ.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAQGE + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaqge.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaqge.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaqge.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAQGE( M, N, A, LDA, R, C, ROWCND, COLCND, AMAX,<br>
*                          EQUED )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          EQUED<br>
...
*> \verbatim<br>
*><br>
*> DLAQGE equilibrates a general M by N matrix A using the row and<br>
...
/**
*> \brief \b DLAQP2 computes a QR factorization with column pivoting of the matrix block.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAQP2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaqp2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaqp2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaqp2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAQP2( M, N, OFFSET, A, LDA, JPVT, TAU, VN1, VN2,<br>
*                          WORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       .. Array Arguments ..<br>
*       INTEGER            JPVT( * )<br>
*       DOUBLE PRECISION   A( LDA, * ), TAU( * ), VN1( * ), VN2( * ),<br>
*      $                   WORK( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> DLAQP2 computes a QR factorization with column pivoting of<br>
...
/**
*> \brief \b DLAQPS computes a step of QR factorization with column pivoting of a real m-by-n matrix A by using BLAS level 3.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAQPS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaqps.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaqps.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaqps.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAQPS( M, N, OFFSET, NB, KB, A, LDA, JPVT, TAU, VN1,<br>
*                          VN2, AUXV, F, LDF )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       .. Array Arguments ..<br>
*       INTEGER            JPVT( * )<br>
*       DOUBLE PRECISION   A( LDA, * ), AUXV( * ), F( LDF, * ), TAU( * ),<br>
*      $                   VN1( * ), VN2( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> DLAQPS computes a step of QR factorization with column pivoting<br>
...
*> \param[out] TAU<br>
*> \verbatim<br>
*>          TAU is DOUBLE PRECISION array, dimension (KB)<br>
*>          The scalar factors of the elementary reflectors.<br>
*> \endverbatim<br>
*><br>
*> \param[in,out] VN1<br>
...
*> \verbatim<br>
*>          AUXV is DOUBLE PRECISION array, dimension (NB)<br>
*>          Auxiliar vector.<br>
*> \endverbatim<br>
*><br>
*> \param[in,out] F<br>
*> \verbatim<br>
*>          F is DOUBLE PRECISION array, dimension (LDF,NB)<br>
...
/**
*> \brief \b DLAQR0 computes the eigenvalues of a Hessenberg matrix, and optionally the matrices from the Schur decomposition.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAQR0 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaqr0.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaqr0.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaqr0.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAQR0( WANTT, WANTZ, N, ILO, IHI, H, LDH, WR, WI,<br>
...
*> \verbatim<br>
*><br>
*>    DLAQR0 computes the eigenvalues of a Hessenberg matrix H<br>
...
*>           previous call to DGEBAL, and then passed to DGEHRD when the<br>
...
*> \param[out] WR<br>
*> \verbatim<br>
*>          WR is DOUBLE PRECISION array, dimension (IHI)<br>
*> \endverbatim<br>
*><br>
*> \param[out] WI<br>
*> \verbatim<br>
*>          WI is DOUBLE PRECISION array, dimension (IHI)<br>
*>           The real and imaginary parts, respectively, of the computed<br>
...
*> \param[in,out] Z<br>
*> \verbatim<br>
*>          Z is DOUBLE PRECISION array, dimension (LDZ,IHI)<br>
...
*><br>
*>           If LWORK = -1, then DLAQR0 does a workspace query.<br>
...
/**
*> \brief \b DLAQR1 sets a scalar multiple of the first column of the product of 2-by-2 or 3-by-3 matrix H and specified shifts.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAQR1 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaqr1.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaqr1.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaqr1.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAQR1( N, H, LDH, SR1, SI1, SR2, SI2, V )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       DOUBLE PRECISION   SI1, SI2, SR1, SR2<br>
*       INTEGER            LDH, N<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   H( LDH, * ), V( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*>      Given a 2-by-2 or 3-by-3 matrix H, DLAQR1 sets v to a<br>
...
*> \param[in] H<br>
*> \verbatim<br>
*>          H is DOUBLE PRECISION array of dimension (LDH,N)<br>
...
*> \param[in] SR1<br>
*> \verbatim<br>
*>          SR1 is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[in] SI1<br>
*> \verbatim<br>
*>          SI1 is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[in] SR2<br>
*> \verbatim<br>
*>          SR2 is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[in] SI2<br>
*> \verbatim<br>
*>          SI2 is DOUBLE PRECISION<br>
*>              The shifts in (*).<br>
*> \endverbatim<br>
*><br>
*> \param[out] V<br>
*> \verbatim<br>
*>          V is DOUBLE PRECISION array of dimension N<br>
...
/**
*> \brief \b DLAQR2 performs the orthogonal similarity transformation of a Hessenberg matrix to detect and deflate fully converged eigenvalues from a trailing principal submatrix (aggressive early deflation).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAQR2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaqr2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaqr2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaqr2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAQR2( WANTT, WANTZ, N, KTOP, KBOT, NW, H, LDH, ILOZ,<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   H( LDH, * ), SI( * ), SR( * ), T( LDT, * ),<br>
...
*> \verbatim<br>
*><br>
*>    DLAQR2 is identical to DLAQR3 except that it avoids<br>
*>    recursion by calling DLAHQR instead of DLAQR4.<br>
*><br>
...
*> \param[out] SR<br>
*> \verbatim<br>
*>          SR is DOUBLE PRECISION array, dimension (KBOT)<br>
*> \endverbatim<br>
*><br>
*> \param[out] SI<br>
*> \verbatim<br>
*>          SI is DOUBLE PRECISION array, dimension (KBOT)<br>
...
*> \param[out] V<br>
*> \verbatim<br>
*>          V is DOUBLE PRECISION array, dimension (LDV,NW)<br>
...
*> \param[out] T<br>
*> \verbatim<br>
*>          T is DOUBLE PRECISION array, dimension (LDT,NW)<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDT<br>
*> \verbatim<br>
...
*> \param[out] WV<br>
*> \verbatim<br>
*>          WV is DOUBLE PRECISION array, dimension (LDWV,NW)<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDWV<br>
*> \verbatim<br>
...
*>          values of LWORK.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; DLAQR2<br>
...
/**
*> \brief \b DLAQR3 performs the orthogonal similarity transformation of a Hessenberg matrix to detect and deflate fully converged eigenvalues from a trailing principal submatrix (aggressive early deflation).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAQR3 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaqr3.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaqr3.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaqr3.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAQR3( WANTT, WANTZ, N, KTOP, KBOT, NW, H, LDH, ILOZ,<br>
*                          IHIZ, Z, LDZ, NS, ND, SR, SI, V, LDV, NH, T,<br>
*                          LDT, NV, WV, LDWV, WORK, LWORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*>    Aggressive early deflation:<br>
*><br>
*>    DLAQR3 accepts as input an upper Hessenberg matrix<br>
*>    H and performs an orthogonal similarity transformation<br>
*>    designed to detect and deflate fully converged eigenvalues from<br>
*>    a trailing principal submatrix.  On output H has been over-<br>
*>    written by a new Hessenberg matrix that is a perturbation of<br>
...
*>          values of LWORK.<br>
*><br>
*>          If LWORK = -1, then a workspace query is assumed; DLAQR3<br>
*>          only estimates the optimal workspace size for the given<br>
*>          values of N, NW, KTOP and KBOT.  The estimate is returned<br>
*>          in WORK(1).  No error message related to LWORK is issued<br>
*>          by XERBLA.  Neither H nor Z are accessed.<br>
...
/**
*> \brief \b DLAQR4 computes the eigenvalues of a Hessenberg matrix, and optionally the matrices from the Schur decomposition.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAQR4 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaqr4.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaqr4.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaqr4.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAQR4( WANTT, WANTZ, N, ILO, IHI, H, LDH, WR, WI,<br>
*                          ILOZ, IHIZ, Z, LDZ, WORK, LWORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            IHI, IHIZ, ILO, ILOZ, INFO, LDH, LDZ, LWORK, N<br>
...
*> \verbatim<br>
*><br>
*>    DLAQR4 implements one level of recursion for DLAQR0.<br>
*>    It is a complete implementation of the small bulge multi-shift<br>
*>    QR algorithm.  It may be called by DLAQR0 and, for large enough<br>
*>    deflation window size, it may be called by DLAQR3.  This<br>
*>    subroutine is identical to DLAQR0 except that it calls DLAQR2<br>
*>    instead of DLAQR3.<br>
*><br>
*>    DLAQR4 computes the eigenvalues of a Hessenberg matrix H<br>
*>    and, optionally, the matrices T and Z from the Schur decomposition<br>
*>    H = Z T Z**T, where T is an upper quasi-triangular matrix (the<br>
*>    Schur form), and Z is the orthogonal matrix of Schur vectors.<br>
*><br>
...
*>           to determine the optimal workspace size is recommended.<br>
*><br>
*>           If LWORK = -1, then DLAQR4 does a workspace query.<br>
*>           In this case, DLAQR4 checks the input parameters and<br>
*>           estimates the optimal workspace size for the given<br>
*>           values of N, ILO and IHI.  The estimate is returned<br>
*>           in WORK(1).  No error message related to LWORK is<br>
*>           issued by XERBLA.  Neither H nor Z are accessed.<br>
...
*>          INFO is INTEGER<br>
*>             =  0:  successful exit<br>
*>           .GT. 0:  if INFO = i, DLAQR4 failed to compute all of<br>
*>                the eigenvalues.  Elements 1:ilo-1 and i+1:n of WR<br>
*>                and WI contain those eigenvalues which have been<br>
*>                successfully computed.  (Failures are rare.)<br>
*><br>
...
/**
*> \brief \b DLAQR5 performs a single small-bulge multi-shift QR sweep.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAQR5 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaqr5.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaqr5.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaqr5.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAQR5( WANTT, WANTZ, KACC22, N, KTOP, KBOT, NSHFTS,<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   H( LDH, * ), SI( * ), SR( * ), U( LDU, * ),<br>
...
*> \verbatim<br>
*><br>
*>    DLAQR5, called by DLAQR0, performs a<br>
...
*>        = 0: DLAQR5 does not accumulate reflections and does not<br>
*>             use matrix-matrix multiply to update far-from-diagonal<br>
*>             matrix entries.<br>
*>        = 1: DLAQR5 accumulates reflections and uses matrix-matrix<br>
*>             multiply to update the far-from-diagonal matrix entries.<br>
*>        = 2: DLAQR5 accumulates reflections, uses matrix-matrix<br>
*>             multiply to update the far-from-diagonal matrix entries,<br>
...
*> \param[in,out] SR<br>
*> \verbatim<br>
*>          SR is DOUBLE PRECISION array of size (NSHFTS)<br>
*> \endverbatim<br>
*><br>
*> \param[in,out] SI<br>
*> \verbatim<br>
*>          SI is DOUBLE PRECISION array of size (NSHFTS)<br>
...
*> \param[in,out] H<br>
*> \verbatim<br>
*>          H is DOUBLE PRECISION array of size (LDH,N)<br>
...
*> \param[in,out] Z<br>
*> \verbatim<br>
*>          Z is DOUBLE PRECISION array of size (LDZ,IHIZ)<br>
...
*> \param[out] V<br>
*> \verbatim<br>
*>          V is DOUBLE PRECISION array of size (LDV,NSHFTS/2)<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDV<br>
*> \verbatim<br>
...
*> \param[out] U<br>
*> \verbatim<br>
*>          U is DOUBLE PRECISION array of size<br>
*>             (LDU,3*NSHFTS-3)<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDU<br>
...
*> \param[out] WH<br>
*> \verbatim<br>
*>          WH is DOUBLE PRECISION array of size (LDWH,NH)<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDWH<br>
*> \verbatim<br>
...
*> \param[out] WV<br>
*> \verbatim<br>
*>          WV is DOUBLE PRECISION array of size<br>
*>             (LDWV,3*NSHFTS-3)<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDWV<br>
...
/**
*> \brief \b DLAQSB scales a symmetric/Hermitian band matrix, using scaling factors computed by spbequ.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAQSB + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaqsb.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaqsb.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaqsb.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAQSB( UPLO, N, KD, AB, LDAB, S, SCOND, AMAX, EQUED )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> DLAQSB equilibrates a symmetric band matrix A using the scaling<br>
...
/**
*> \brief \b DLAQSP scales a symmetric/Hermitian matrix in packed storage, using scaling factors computed by sppequ.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAQSP + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaqsp.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaqsp.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaqsp.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAQSP( UPLO, N, AP, S, SCOND, AMAX, EQUED )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          EQUED, UPLO<br>
*       INTEGER            N<br>
...
*> \verbatim<br>
*><br>
*> DLAQSP equilibrates a symmetric matrix A using the scaling factors<br>
*> in the vector S.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
/**
*> \brief \b DLAQSY scales a symmetric/Hermitian matrix, using scaling factors computed by spoequ.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAQSY + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaqsy.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaqsy.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaqsy.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAQSY( UPLO, N, A, LDA, S, SCOND, AMAX, EQUED )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          EQUED, UPLO<br>
*       INTEGER            LDA, N<br>
...
*> \verbatim<br>
*><br>
*> DLAQSY equilibrates a symmetric matrix A using the scaling factors<br>
*> in the vector S.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
/**
*> \brief \b DLAQTR solves a real quasi-triangular system of equations, or a complex quasi-triangular system of special form, in real arithmetic.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAQTR + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaqtr.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaqtr.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaqtr.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAQTR( LTRAN, LREAL, N, T, LDT, B, W, SCALE, X, WORK,<br>
*                          INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       LOGICAL            LREAL, LTRAN<br>
*       INTEGER            INFO, LDT, N<br>
*       DOUBLE PRECISION   SCALE, W<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   B( * ), T( LDT, * ), WORK( * ), X( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLAQTR solves the real quasi-triangular system<br>
*><br>
...
*>          If LREAL = .FALSE., then the first diagonal block of T mu<br>
*>          be 1 by 1.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDT<br>
...
*> \param[in] B<br>
*> \verbatim<br>
*>          B is DOUBLE PRECISION array, dimension (N)<br>
...
*> \param[in,out] X<br>
*> \verbatim<br>
*>          X is DOUBLE PRECISION array, dimension (2*N)<br>
...
*>                  a small number in DLALN2 to keep nonsingularity.<br>
*>          NOTE: In the interests of speed, this routine does not<br>
*>                check the inputs for errors.<br>
*> \endverbatim<br>
*<br>
...
/**
*> \brief \b DLAR1V computes the (scaled) r-th column of the inverse of the submatrix in rows b1 through bn of the tridiagonal matrix LDLT - λI.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAR1V + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlar1v.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlar1v.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlar1v.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAR1V( N, B1, BN, LAMBDA, D, L, LD, LLD,<br>
...
*> \verbatim<br>
*><br>
*> DLAR1V computes the (scaled) r-th column of the inverse of<br>
...
/**
*> \brief \b DLAR2V applies a vector of plane rotations with real cosines and real sines from both sides to a sequence of 2-by-2 symmetric/Hermitian matrices.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAR2V + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlar2v.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlar2v.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlar2v.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAR2V( N, X, Y, Z, INCX, C, S, INCC )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INCC, INCX, N<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   C( * ), S( * ), X( * ), Y( * ), Z( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLAR2V applies a vector of real plane rotations from both sides to<br>
...
*> \param[in,out] Z<br>
*> \verbatim<br>
*>          Z is DOUBLE PRECISION array,<br>
*>                         dimension (1+(N-1)*INCX)<br>
*>          The vector z.<br>
*> \endverbatim<br>
*><br>
...
*> \param[in] S<br>
*> \verbatim<br>
*>          S is DOUBLE PRECISION array, dimension (1+(N-1)*INCC)<br>
...
/**
*> \brief \b DLARF applies an elementary reflector to a general rectangular matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARF( SIDE, M, N, V, INCV, TAU, C, LDC, WORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          SIDE<br>
*       INTEGER            INCV, LDC, M, N<br>
*       DOUBLE PRECISION   TAU<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   C( LDC, * ), V( * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLARF applies a real elementary reflector H to a real m by n matrix<br>
...
*> \param[in] V<br>
*> \verbatim<br>
*>          V is DOUBLE PRECISION array, dimension<br>
...
/**
*> \brief \b DLARFB applies a block reflector or its transpose to a general rectangular matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARFB + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarfb.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarfb.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarfb.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARFB( SIDE, TRANS, DIRECT, STOREV, M, N, K, V, LDV,<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   C( LDC, * ), T( LDT, * ), V( LDV, * ),<br>
*      $                   WORK( LDWORK, * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> DLARFB applies a real block reflector H or its transpose H**T to a<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is DOUBLE PRECISION array, dimension (LDWORK,K)<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDWORK<br>
*> \verbatim<br>
...
/**
*> \brief \b DLARFG generates an elementary reflector (Householder matrix).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARFG + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarfg.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarfg.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarfg.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARFG( N, ALPHA, X, INCX, TAU )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INCX, N<br>
*       DOUBLE PRECISION   ALPHA, TAU<br>
*       ..<br>
*       .. Array Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> DLARFG generates a real elementary reflector H of order n, such<br>
*> that<br>
*><br>
...
*> \param[in,out] X<br>
*> \verbatim<br>
*>          X is DOUBLE PRECISION array, dimension<br>
*>                         (1+(N-2)*abs(INCX))<br>
...
/**
*> \brief \b DLARFGP generates an elementary reflector (Householder matrix) with non-negative beta.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARFGP + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarfgp.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarfgp.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarfgp.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARFGP( N, ALPHA, X, INCX, TAU )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INCX, N<br>
*       DOUBLE PRECISION   ALPHA, TAU<br>
...
*> \verbatim<br>
*><br>
*> DLARFGP generates a real elementary reflector H of order n, such<br>
*> that<br>
*><br>
*>       H * ( alpha ) = ( beta ),   H**T * H = I.<br>
*>           (   x   )   (   0  )<br>
...
/**
*> \brief \b DLARFT forms the triangular factor T of a block reflector H = I - vtvH<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARFT + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarft.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarft.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarft.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARFT( DIRECT, STOREV, N, K, V, LDV, TAU, T, LDT )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   T( LDT, * ), TAU( * ), V( LDV, * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLARFT forms the triangular factor T of a real block reflector H<br>
...
/**
*> \brief \b DLARFX applies an elementary reflector to a general rectangular matrix, with loop unrolling when the reflector has order ≤ 10.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARFX + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarfx.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarfx.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarfx.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARFX( SIDE, M, N, V, TAU, C, LDC, WORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          SIDE<br>
*       INTEGER            LDC, M, N<br>
...
*> \verbatim<br>
*><br>
*> DLARFX applies a real elementary reflector H to a real m by n<br>
...
*> \param[in] V<br>
*> \verbatim<br>
*>          V is DOUBLE PRECISION array, dimension (M) if SIDE = 'L'<br>
*>                                     or (N) if SIDE = 'R'<br>
...
/**
*> \brief \b DLARGV generates a vector of plane rotations with real cosines and real sines.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARGV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlargv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlargv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlargv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARGV( N, X, INCX, Y, INCY, C, INCC )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INCC, INCX, INCY, N<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   C( * ), X( * ), Y( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLARGV generates a vector of real plane rotations, determined by<br>
...
/**
*> \brief \b DLARNV returns a vector of random numbers from a uniform or normal distribution.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARNV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarnv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarnv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarnv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARNV( IDIST, ISEED, N, X )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            IDIST, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> DLARNV returns a vector of n random real numbers from a uniform or<br>
...
/**
*> \brief \b DLARRA computes the splitting points with the specified threshold.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARRA + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarra.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarra.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarra.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARRA( N, D, E, E2, SPLTOL, TNRM,<br>
*                           NSPLIT, ISPLIT, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, N, NSPLIT<br>
*       DOUBLE PRECISION    SPLTOL, TNRM<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       INTEGER            ISPLIT( * )<br>
*       DOUBLE PRECISION   D( * ), E( * ), E2( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> DLARRA sets any "small" off-diagonal elements to zero.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
/**
*> \brief \b DLARRB provides limited bisection to locate eigenvalues for more accuracy.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARRB + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarrb.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarrb.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarrb.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARRB( N, D, LLD, IFIRST, ILAST, RTOL1,<br>
*                          RTOL2, OFFSET, W, WGAP, WERR, WORK, IWORK,<br>
*                          PIVMIN, SPDIAM, TWIST, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            IFIRST, ILAST, INFO, N, OFFSET, TWIST<br>
*       DOUBLE PRECISION   PIVMIN, RTOL1, RTOL2, SPDIAM<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       INTEGER            IWORK( * )<br>
*       DOUBLE PRECISION   D( * ), LLD( * ), W( * ),<br>
*      $                   WERR( * ), WGAP( * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> Given the relatively robust representation(RRR) L D L^T, DLARRB<br>
...
*> \verbatim<br>
*>          WGAP is DOUBLE PRECISION array, dimension (N-1)<br>
...
/**
*> \brief \b DLARRC computes the number of eigenvalues of the symmetric tridiagonal matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARRC + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarrc.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarrc.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarrc.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARRC( JOBT, N, VL, VU, D, E, PIVMIN,<br>
*                                   EIGCNT, LCNT, RCNT, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          JOBT<br>
*       INTEGER            EIGCNT, INFO, LCNT, N, RCNT<br>
*       DOUBLE PRECISION   PIVMIN, VL, VU<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   D( * ), E( * )<br>
*       ..<br>
...
/**
*> \brief \b DLARRD computes the eigenvalues of a symmetric tridiagonal matrix to suitable accuracy.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARRD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarrd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarrd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarrd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARRD( RANGE, ORDER, N, VL, VU, IL, IU, GERS,<br>
...
*       DOUBLE PRECISION    PIVMIN, RELTOL, VL, VU, WL, WU<br>
*       ..<br>
*       .. Array Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> DLARRD computes the eigenvalues of a symmetric tridiagonal<br>
...
*> \param[in] E2<br>
*> \verbatim<br>
*>          E2 is DOUBLE PRECISION array, dimension (N-1)<br>
...
*> \param[out] WL<br>
*> \verbatim<br>
*>          WL is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[out] WU<br>
*> \verbatim<br>
*>          WU is DOUBLE PRECISION<br>
...
*>                        on the spectrum.<br>
*>          If RANGE='I', then WL and WU are computed by DLAEBZ from the<br>
...
/**
*> \brief \b DLARRE given the tridiagonal matrix T, sets small off-diagonal elements to zero and for each unreduced block Ti, finds base representations and eigenvalues.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARRE + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarre.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarre.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarre.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARRE( RANGE, N, VL, VU, IL, IU, D, E, E2,<br>
...
*       CHARACTER          RANGE<br>
*       INTEGER            IL, INFO, IU, M, N, NSPLIT<br>
*       DOUBLE PRECISION  PIVMIN, RTOL1, RTOL2, SPLTOL, VL, VU<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       INTEGER            IBLOCK( * ), ISPLIT( * ), IWORK( * ),<br>
*      $                   INDEXW( * )<br>
*       DOUBLE PRECISION   D( * ), E( * ), E2( * ), GERS( * ),<br>
*      $                   W( * ),WERR( * ), WGAP( * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> tridiagonal matrix T, DLARRE sets any "small" off-diagonal<br>
...
*> find a few eigenvalues or the dqds algorithm (subroutine DLASQ2) to<br>
...
*>          If RANGE='I' or ='A', DLARRE computes bounds on the desired<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is DOUBLE PRECISION array, dimension (6*N)<br>
*>          Workspace.<br>
*> \endverbatim<br>
*><br>
*> \param[out] IWORK<br>
...
*>          INFO is INTEGER<br>
*>          = 0:  successful exit<br>
*>          > 0:  A problem occurred in DLARRE.<br>
...
/**
*> \brief \b DLARRF finds a new relatively robust representation such that at least one of the eigenvalues is relatively isolated.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARRF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarrf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarrf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarrf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARRF( N, D, L, LD, CLSTRT, CLEND,<br>
*                          W, WGAP, WERR,<br>
...
*       DOUBLE PRECISION   CLGAPL, CLGAPR, PIVMIN, SIGMA, SPDIAM<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   D( * ), DPLUS( * ), L( * ), LD( * ),<br>
...
*> W( CLEND ), DLARRF finds a new relatively robust representation<br>
...
*> \param[in] W<br>
*> \verbatim<br>
*>          W is DOUBLE PRECISION array, dimension<br>
...
*> \param[in,out] WGAP<br>
*> \verbatim<br>
*>          WGAP is DOUBLE PRECISION array, dimension<br>
*>          dimension is >=  (CLEND-CLSTRT+1)<br>
*>          The separation from the right neighbor eigenvalue in W.<br>
*> \endverbatim<br>
*><br>
*> \param[in] WERR<br>
*> \verbatim<br>
*>          WERR is DOUBLE PRECISION array, dimension<br>
*>          dimension is  >=  (CLEND-CLSTRT+1)<br>
...
*> \param[in] CLGAPL<br>
*> \verbatim<br>
*>          CLGAPL is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[in] CLGAPR<br>
*> \verbatim<br>
*>          CLGAPR is DOUBLE PRECISION<br>
...
*> \param[out] DPLUS<br>
*> \verbatim<br>
*>          DPLUS is DOUBLE PRECISION array, dimension (N)<br>
*>          The N diagonal elements of the diagonal matrix D(+).<br>
*> \endverbatim<br>
*><br>
*> \param[out] LPLUS<br>
*> \verbatim<br>
*>          LPLUS is DOUBLE PRECISION array, dimension (N-1)<br>
...
/**
*> \brief \b DLARRJ performs refinement of the initial estimates of the eigenvalues of the matrix T.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARRJ + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarrj.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarrj.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarrj.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARRJ( N, D, E2, IFIRST, ILAST,<br>
*                          RTOL, OFFSET, W, WERR, WORK, IWORK,<br>
*                          PIVMIN, SPDIAM, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            IFIRST, ILAST, INFO, N, OFFSET<br>
*       DOUBLE PRECISION   PIVMIN, RTOL, SPDIAM<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       INTEGER            IWORK( * )<br>
*       DOUBLE PRECISION   D( * ), E2( * ), W( * ),<br>
*      $                   WERR( * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> Given the initial eigenvalue approximations of T, DLARRJ<br>
...
/**
*> \brief \b DLARRK computes one eigenvalue of a symmetric tridiagonal matrix T to suitable accuracy.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARRK + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarrk.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarrk.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarrk.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARRK( N, IW, GL, GU,<br>
*                           D, E2, PIVMIN, RELTOL, W, WERR, INFO)<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER   INFO, IW, N<br>
*       DOUBLE PRECISION    PIVMIN, RELTOL, GL, GU, W, WERR<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   D( * ), E2( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLARRK computes one eigenvalue of a symmetric tridiagonal<br>
*> matrix T to suitable accuracy. This is an auxiliary code to be<br>
*> called from DSTEMR.<br>
*><br>
*> To avoid overflow, the matrix must be scaled so that its<br>
...
*> \param[in] GL<br>
*> \verbatim<br>
*>          GL is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[in] GU<br>
*> \verbatim<br>
*>          GU is DOUBLE PRECISION<br>
...
/**
*> \brief \b DLARRR performs tests to decide whether the symmetric tridiagonal matrix T warrants expensive computations which guarantee high relative accuracy in the eigenvalues.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARRR + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarrr.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarrr.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarrr.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARRR( N, D, E, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            N, INFO<br>
*       ..<br>
...
/**
*> \brief \b DLARRV computes the eigenvectors of the tridiagonal matrix T = L D LT given L, D and the eigenvalues of L D LT.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARRV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarrv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarrv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarrv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARRV( N, VL, VU, D, L, PIVMIN,<br>
...
*> \verbatim<br>
*><br>
*> DLARRV computes the eigenvectors of the tridiagonal matrix<br>
...
*>          = 0:  successful exit<br>
*><br>
*>          > 0:  A problem occurred in DLARRV.<br>
*>          < 0:  One of the called subroutines signaled an internal problem.<br>
*>                Needs inspection of the corresponding parameter IINFO<br>
*>                for further information.<br>
*><br>
...
/**
*> \brief \b DLARSCL2 performs reciprocal diagonal scaling on a vector.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARSCL2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarscl2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarscl2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarscl2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARSCL2 ( M, N, D, X, LDX )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            M, N, LDX<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   D( * ), X( LDX, * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLARSCL2 performs a reciprocal diagonal scaling on an vector:<br>
*>   x <-- inv(D) * x<br>
*> where the diagonal matrix D is stored as a vector.<br>
*><br>
*> Eventually to be replaced by BLAS_dge_diag_scale in the new BLAS<br>
*> standard.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*> \param[in] D<br>
*> \verbatim<br>
*>          D is DOUBLE PRECISION array, dimension (M)<br>
...
/**
*> \brief \b DLARTG generates a plane rotation with real cosine and real sine.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARTG + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlartg.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlartg.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlartg.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARTG( F, G, CS, SN, R )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       DOUBLE PRECISION   CS, F, G, R, SN<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLARTG generate a plane rotation so that<br>
*><br>
*>    [  CS  SN  ]  .  [ F ]  =  [ R ]   where CS**2 + SN**2 = 1.<br>
*>    [ -SN  CS  ]     [ G ]     [ 0 ]<br>
*><br>
*> This is a slower, more accurate version of the BLAS1 routine DROTG,<br>
...
*>       floating point operations (saves work in DBDSQR when<br>
...
*> \param[in] F<br>
*> \verbatim<br>
*>          F is DOUBLE PRECISION<br>
*>          The first component of vector to be rotated.<br>
*> \endverbatim<br>
*><br>
*> \param[in] G<br>
*> \verbatim<br>
*>          G is DOUBLE PRECISION<br>
...
/**
*> \brief \b DLARTGP generates a plane rotation so that the diagonal is nonnegative.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARTGP + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlartgp.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlartgp.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlartgp.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARTGP( F, G, CS, SN, R )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       DOUBLE PRECISION   CS, F, G, R, SN<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> DLARTGP generates a plane rotation so that<br>
*><br>
*>    [  CS  SN  ]  .  [ F ]  =  [ R ]   where CS**2 + SN**2 = 1.<br>
*>    [ -SN  CS  ]     [ G ]     [ 0 ]<br>
*><br>
*> This is a slower, more accurate version of the Level 1 BLAS routine DROTG,<br>
*> with the following other differences:<br>
*>    F and G are unchanged on return.<br>
*>    If G=0, then CS=(+/-)1 and SN=0.<br>
...
/**
*> \brief \b DLARTGS generates a plane rotation designed to introduce a bulge in implicit QR iteration for the bidiagonal SVD problem.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARTGS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlartgs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlartgs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlartgs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARTGS( X, Y, SIGMA, CS, SN )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       DOUBLE PRECISION        CS, SIGMA, SN, X, Y<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLARTGS generates a plane rotation designed to introduce a bulge in<br>
...
/**
*> \brief \b DLARTV applies a vector of plane rotations with real cosines and real sines to the elements of a pair of vectors.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARTV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlartv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlartv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlartv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARTV( N, X, INCX, Y, INCY, C, S, INCC )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INCC, INCX, INCY, N<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   C( * ), S( * ), X( * ), Y( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLARTV applies a vector of real plane rotations to elements of the<br>
...
/**
*> \brief \b DLARUV returns a vector of n random real numbers from a uniform distribution.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARUV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaruv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaruv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaruv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARUV( ISEED, N, X )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> DLARUV returns a vector of n random real numbers from a uniform (0,1)<br>
*> distribution (n <= 128).<br>
*><br>
*> This is an auxiliary routine called by DLARNV and ZLARNV.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
/**
*> \brief \b DLARZ applies an elementary reflector (as returned by stzrzf) to a general matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARZ + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarz.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarz.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarz.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARZ( SIDE, M, N, L, V, INCV, TAU, C, LDC, WORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          SIDE<br>
...
*> \verbatim<br>
*><br>
*> DLARZ applies a real elementary reflector H to a real M-by-N<br>
*> matrix C, from either the left or the right. H is represented in the<br>
*> form<br>
*><br>
*>       H = I - tau * v * v**T<br>
...
*><br>
*><br>
*> H is a product of k elementary reflectors as returned by DTZRZF.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*> \param[in] V<br>
*> \verbatim<br>
*>          V is DOUBLE PRECISION array, dimension (1+(L-1)*abs(INCV))<br>
*>          The vector v in the representation of H as returned by<br>
*>          DTZRZF. V is not used if TAU = 0.<br>
*> \endverbatim<br>
*><br>
*> \param[in] INCV<br>
*> \verbatim<br>
...
/**
*> \brief \b DLARZB applies a block reflector or its transpose to a general matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARZB + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarzb.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarzb.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarzb.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARZB( SIDE, TRANS, DIRECT, STOREV, M, N, K, L, V,<br>
...
*> \verbatim<br>
*><br>
*> DLARZB applies a real block reflector H or its transpose H**T to<br>
...
*> \param[in] V<br>
*> \verbatim<br>
*>          V is DOUBLE PRECISION array, dimension (LDV,NV).<br>
...
/**
*> \brief \b DLARZT forms the triangular factor T of a block reflector H = I - vtvH.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLARZT + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlarzt.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlarzt.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlarzt.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLARZT( DIRECT, STOREV, N, K, V, LDV, TAU, T, LDT )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          DIRECT, STOREV<br>
*       INTEGER            K, LDT, LDV, N<br>
...
*> \verbatim<br>
*><br>
*> DLARZT forms the triangular factor T of a real block reflector<br>
...
/**
*> \brief \b DLAS2 computes singular values of a 2-by-2 triangular matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAS2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlas2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlas2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlas2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAS2( F, G, H, SSMIN, SSMAX )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       DOUBLE PRECISION   F, G, H, SSMAX, SSMIN<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLAS2  computes the singular values of the 2-by-2 matrix<br>
*>    [  F   G  ]<br>
*>    [  0   H  ].<br>
...
/**
*> \brief \b DLASCL multiplies a general rectangular matrix by a real scalar defined as cto/cfrom.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASCL + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlascl.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlascl.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlascl.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASCL( TYPE, KL, KU, CFROM, CTO, M, N, A, LDA, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TYPE<br>
...
*> \verbatim<br>
*><br>
*> DLASCL multiplies the M by N real matrix A by the real scalar<br>
...
*>                  bandwidth KU. See DGBTRF for storage details.<br>
*> \endverbatim<br>
*><br>
*> \param[in] KL<br>
*> \verbatim<br>
...
/**
*> \brief \b DLASCL2 performs diagonal scaling on a vector.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASCL2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlascl2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlascl2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlascl2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASCL2 ( M, N, D, X, LDX )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            M, N, LDX<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> DLASCL2 performs a diagonal scaling on a vector:<br>
*>   x <-- D * x<br>
*> where the diagonal matrix D is stored as a vector.<br>
*><br>
*> Eventually to be replaced by BLAS_dge_diag_scale in the new BLAS<br>
...
/**
*> \brief \b DLASD0 computes the singular values of a real upper bidiagonal n-by-m matrix B with diagonal d and off-diagonal e. Used by sbdsdc.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASD0 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasd0.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasd0.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasd0.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASD0( N, SQRE, D, E, U, LDU, VT, LDVT, SMLSIZ, IWORK,<br>
*                          WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       .. Array Arguments ..<br>
*       INTEGER            IWORK( * )<br>
*       DOUBLE PRECISION   D( * ), E( * ), U( LDU, * ), VT( LDVT, * ),<br>
*      $                   WORK( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> Using a divide and conquer approach, DLASD0 computes the singular<br>
...
*><br>
*> A related subroutine, DLASDA, computes only the singular values,<br>
...
*> \param[in] E<br>
*> \verbatim<br>
*>          E is DOUBLE PRECISION array, dimension (M-1)<br>
...
*> \param[out] U<br>
*> \verbatim<br>
*>          U is DOUBLE PRECISION array, dimension at least (LDQ, N)<br>
...
*> \param[out] VT<br>
*> \verbatim<br>
*>          VT is DOUBLE PRECISION array, dimension at least (LDVT, M)<br>
...
*> \param[out] IWORK<br>
*> \verbatim<br>
*>          IWORK is INTEGER work array.<br>
*>         Dimension must be at least (8 * N)<br>
*> \endverbatim<br>
*><br>
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is DOUBLE PRECISION work array.<br>
*>         Dimension must be at least (3 * M**2 + 2 * M)<br>
*> \endverbatim<br>
*><br>
*> \param[out] INFO<br>
*> \verbatim<br>
...
/**
*> \brief \b DLASD1 computes the SVD of an upper bidiagonal matrix B of the specified size. Used by sbdsdc.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASD1 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasd1.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasd1.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasd1.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASD1( NL, NR, SQRE, D, ALPHA, BETA, U, LDU, VT, LDVT,<br>
...
*       DOUBLE PRECISION   D( * ), U( LDU, * ), VT( LDVT, * ), WORK( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLASD1 computes the SVD of an upper bidiagonal N-by-M matrix B,<br>
*> where N = NL + NR + 1 and M = N + SQRE. DLASD1 is called from DLASD0.<br>
*><br>
*> A related subroutine DLASD7 handles the case in which the singular<br>
*> values (and the singular vectors in factored form) are desired.<br>
*><br>
*> DLASD1 computes the SVD as follows:<br>
*><br>
*>               ( D1(in)    0    0       0 )<br>
...
*>    the Z vector.  For each such occurrence the dimension of the<br>
*>    secular equation problem is reduced by one.  This stage is<br>
*>    performed by the routine DLASD2.<br>
*><br>
*>    The second stage consists of calculating the updated<br>
*>    singular values. This is done by finding the square roots of the<br>
*>    roots of the secular equation via the routine DLASD4 (as called<br>
*>    by DLASD3). This routine also calculates the singular vectors of<br>
...
*> \param[in,out] D<br>
*> \verbatim<br>
*>          D is DOUBLE PRECISION array,<br>
...
*> \param[in,out] VT<br>
*> \verbatim<br>
*>          VT is DOUBLE PRECISION array, dimension(LDVT,M)<br>
*>         where M = N + SQRE.<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is DOUBLE PRECISION array, dimension( 3*M**2 + 2*M )<br>
*> \endverbatim<br>
*><br>
*> \param[out] INFO<br>
*> \verbatim<br>
...
/**
*> \brief \b DLASD2 merges the two sets of singular values together into a single sorted set. Used by sbdsdc.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASD2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasd2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasd2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasd2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASD2( NL, NR, SQRE, K, D, Z, ALPHA, BETA, U, LDU, VT,<br>
...
*      $                   IDXQ( * )<br>
*       DOUBLE PRECISION   D( * ), DSIGMA( * ), U( LDU, * ),<br>
...
*> \verbatim<br>
*><br>
*> DLASD2 merges the two sets of singular values together into a single<br>
*> sorted set.  Then it tries to deflate the size of the problem.<br>
*> There are two ways in which deflation can occur:  when two or more<br>
...
*> equation problem is reduced by one.<br>
*><br>
*> DLASD2 is called from DLASD1.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*> \param[out] DSIGMA<br>
*> \verbatim<br>
*>          DSIGMA is DOUBLE PRECISION array, dimension (N)<br>
...
*> \param[out] U2<br>
*> \verbatim<br>
*>          U2 is DOUBLE PRECISION array, dimension(LDU2,N)<br>
*>         Contains a copy of the first K-1 left singular vectors which<br>
*>         will be used by DLASD3 in a matrix multiply (DGEMM) to solve<br>
...
*> \param[out] VT2<br>
*> \verbatim<br>
*>          VT2 is DOUBLE PRECISION array, dimension(LDVT2,N)<br>
*>         VT2**T contains a copy of the first K right singular vectors<br>
*>         which will be used by DLASD3 in a matrix multiply (DGEMM) to<br>
...
/**
*> \brief \b DLASD3 finds all square roots of the roots of the secular equation, as defined by the values in D and Z, and then updates the singular vectors by matrix multiplication. Used by sbdsdc.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASD3 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasd3.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasd3.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasd3.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASD3( NL, NR, SQRE, K, D, Q, LDQ, DSIGMA, U, LDU, U2,<br>
...
*       DOUBLE PRECISION   D( * ), DSIGMA( * ), Q( LDQ, * ), U( LDU, * ),<br>
*      $                   U2( LDU2, * ), VT( LDVT, * ), VT2( LDVT2, * ),<br>
*      $                   Z( * )<br>
*       ..<br>
*  <br>
...
*> \verbatim<br>
*><br>
*> DLASD3 finds all the square roots of the roots of the secular<br>
*> equation, as defined by the values in D and Z.  It makes the<br>
*> appropriate calls to DLASD4 and then updates the singular<br>
...
*> without guard digits, but we know of none.<br>
*><br>
*> DLASD3 is called from DLASD1.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*> \param[out] D<br>
*> \verbatim<br>
*>          D is DOUBLE PRECISION array, dimension(K)<br>
...
*> \param[out] Q<br>
*> \verbatim<br>
*>          Q is DOUBLE PRECISION array,<br>
...
*> \param[in] DSIGMA<br>
*> \verbatim<br>
*>          DSIGMA is DOUBLE PRECISION array, dimension(K)<br>
*>         The first K elements of this array contain the old roots<br>
*>         of the deflated updating problem.  These are the poles<br>
*>         of the secular equation.<br>
*> \endverbatim<br>
...
*><br>
*>         The rows of the singular vectors found by DLASD4<br>
...
/**
*> \brief \b DLASD4 computes the square root of the i-th updated eigenvalue of a positive symmetric rank-one modification to a positive diagonal matrix. Used by dbdsdc.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at<br>
...
*<br>
*> \htmlonly<br>
*> Download DLASD4 + dependencies<br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasd4.f"><br>
*> [TGZ]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasd4.f"><br>
*> [ZIP]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasd4.f"><br>
*> [TXT]</a><br>
*> \endhtmlonly<br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASD4( N, I, D, Z, DELTA, RHO, SIGMA, WORK, INFO )<br>
*<br>
*       .. Scalar Arguments ..<br>
*       INTEGER            I, INFO, N<br>
*       DOUBLE PRECISION   RHO, SIGMA<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   D( * ), DELTA( * ), WORK( * ), Z( * )<br>
*       ..<br>
*<br>
*<br>
*> \par Purpose:<br>
...
/**
*> \brief \b DLASD5 computes the square root of the i-th eigenvalue of a positive symmetric rank-one modification of a 2-by-2 diagonal matrix. Used by sbdsdc.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASD5 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasd5.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasd5.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasd5.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASD5( I, D, Z, DELTA, RHO, DSIGMA, WORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            I<br>
*       DOUBLE PRECISION   DSIGMA, RHO<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   D( 2 ), DELTA( 2 ), WORK( 2 ), Z( 2 )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \param[out] DSIGMA<br>
*> \verbatim<br>
*>          DSIGMA is DOUBLE PRECISION<br>
*>         The computed sigma_I, the I-th updated eigenvalue.<br>
*> \endverbatim<br>
*><br>
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is DOUBLE PRECISION array, dimension ( 2 )<br>
...
/**
*> \brief \b DLASD6 computes the SVD of an updated upper bidiagonal matrix obtained by merging two smaller ones by appending a row. Used by sbdsdc.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASD6 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasd6.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasd6.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasd6.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASD6( ICOMPQ, NL, NR, SQRE, D, VF, VL, ALPHA, BETA,<br>
...
*      $                   NR, SQRE<br>
*       DOUBLE PRECISION   ALPHA, BETA, C, S<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       INTEGER            GIVCOL( LDGCOL, * ), IDXQ( * ), IWORK( * ),<br>
*      $                   PERM( * )<br>
*       DOUBLE PRECISION   D( * ), DIFL( * ), DIFR( * ),<br>
...
*> \verbatim<br>
*><br>
*> DLASD6 computes the SVD of an updated upper bidiagonal matrix B<br>
...
*> A related subroutine, DLASD1, handles the case in which all singular<br>
*> values and singular vectors of the bidiagonal matrix are desired.<br>
*><br>
*> DLASD6 computes the SVD as follows:<br>
*><br>
*>               ( D1(in)    0    0       0 )<br>
*>   B = U(in) * (   Z1**T   a   Z2**T    b ) * VT(in)<br>
*>               (   0       0   D2(in)   0 )<br>
...
*> respectively, in DLASD6. Hence U and VT are not explicitly<br>
*> referenced.<br>
*><br>
...
*>       secular equation problem is reduced by one. This stage is<br>
*>       performed by the routine DLASD7.<br>
*><br>
*>       The second stage consists of calculating the updated<br>
*>       singular values. This is done by finding the roots of the<br>
*>       secular equation via the routine DLASD4 (as called by DLASD8).<br>
...
*>       values.<br>
*><br>
*> DLASD6 is called from DLASDA.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*> \param[in,out] D<br>
*> \verbatim<br>
*>          D is DOUBLE PRECISION array, dimension ( NL+NR+1 ).<br>
*>         On entry D(1:NL,1:NL) contains the singular values of the<br>
...
*> \param[in,out] VF<br>
*> \verbatim<br>
*>          VF is DOUBLE PRECISION array, dimension ( M )<br>
...
*> \param[in,out] VL<br>
*> \verbatim<br>
*>          VL is DOUBLE PRECISION array, dimension ( M )<br>
...
*> \param[out] DIFL<br>
*> \verbatim<br>
*>          DIFL is DOUBLE PRECISION array, dimension ( N )<br>
...
*> \param[out] DIFR<br>
*> \verbatim<br>
*>          DIFR is DOUBLE PRECISION array,<br>
...
*><br>
*>         See DLASD8 for details on DIFL and DIFR.<br>
*> \endverbatim<br>
*><br>
*> \param[out] Z<br>
*> \verbatim<br>
*>          Z is DOUBLE PRECISION array, dimension ( M )<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is DOUBLE PRECISION array, dimension ( 4 * M )<br>
*> \endverbatim<br>
*><br>
*> \param[out] IWORK<br>
*> \verbatim<br>
...
/**
*> \brief \b DLASD7 merges the two sets of singular values together into a single sorted set. Then it tries to deflate the size of the problem. Used by sbdsdc.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASD7 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasd7.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasd7.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasd7.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASD7( ICOMPQ, NL, NR, SQRE, K, D, Z, ZW, VF, VFW, VL,<br>
...
*      $                   IDXQ( * ), PERM( * )<br>
*       DOUBLE PRECISION   D( * ), DSIGMA( * ), GIVNUM( LDGNUM, * ),<br>
*      $                   VF( * ), VFW( * ), VL( * ), VLW( * ), Z( * ),<br>
*      $                   ZW( * )<br>
*       ..<br>
*  <br>
...
*> \verbatim<br>
*><br>
*> DLASD7 merges the two sets of singular values together into a single<br>
...
*><br>
*> DLASD7 is called from DLASD6.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*> \param[out] ZW<br>
*> \verbatim<br>
*>          ZW is DOUBLE PRECISION array, dimension ( M )<br>
*>         Workspace for Z.<br>
*> \endverbatim<br>
*><br>
*> \param[in,out] VF<br>
...
*> \param[out] VFW<br>
*> \verbatim<br>
*>          VFW is DOUBLE PRECISION array, dimension ( M )<br>
*>         Workspace for VF.<br>
*> \endverbatim<br>
*><br>
*> \param[in,out] VL<br>
...
*> \param[out] VLW<br>
*> \verbatim<br>
*>          VLW is DOUBLE PRECISION array, dimension ( M )<br>
*>         Workspace for VL.<br>
*> \endverbatim<br>
*><br>
*> \param[in] ALPHA<br>
...
/**
*> \brief \b DLASD8 finds the square roots of the roots of the secular equation, and stores, for each element in D, the distance to its two nearest poles. Used by sbdsdc.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASD8 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasd8.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasd8.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasd8.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASD8( ICOMPQ, K, D, Z, VF, VL, DIFL, DIFR, LDDIFR,<br>
*                          DSIGMA, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   D( * ), DIFL( * ), DIFR( LDDIFR, * ),<br>
...
*> \verbatim<br>
*><br>
*> DLASD8 finds the square roots of the roots of the secular equation,<br>
*> as defined by the values in DSIGMA and Z. It makes the appropriate<br>
*> calls to DLASD4, and stores, for each  element in D, the distance<br>
...
*><br>
*> DLASD8 is called from DLASD6.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
*> \param[in,out] VF<br>
*> \verbatim<br>
*>          VF is DOUBLE PRECISION array, dimension ( K )<br>
...
*> \param[in,out] VL<br>
*> \verbatim<br>
*>          VL is DOUBLE PRECISION array, dimension ( K )<br>
...
*> \param[out] WORK<br>
*> \verbatim<br>
*>          WORK is DOUBLE PRECISION array, dimension at least 3 * K<br>
*> \endverbatim<br>
*><br>
*> \param[out] INFO<br>
*> \verbatim<br>
...
/**
*> \brief \b DLASDA computes the singular value decomposition (SVD) of a real upper bidiagonal matrix with diagonal d and off-diagonal e. Used by sbdsdc.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASDA + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasda.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasda.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasda.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASDA( ICOMPQ, SMLSIZ, N, SQRE, D, E, U, LDU, VT, K,<br>
...
*       INTEGER            GIVCOL( LDGCOL, * ), GIVPTR( * ), IWORK( * ),<br>
*      $                   K( * ), PERM( LDGCOL, * )<br>
*       DOUBLE PRECISION   C( * ), D( * ), DIFL( LDU, * ), DIFR( LDU, * ),<br>
...
*> \verbatim<br>
*><br>
*> Using a divide and conquer approach, DLASDA computes the singular<br>
...
*> compact form.<br>
*><br>
*> A related subroutine, DLASD0, computes the singular values and<br>
...
*> \param[out] U<br>
*> \verbatim<br>
*>          U is DOUBLE PRECISION array,<br>
...
*> \param[out] VT<br>
*> \verbatim<br>
*>          VT is DOUBLE PRECISION array,<br>
...
*>         the right singular vector matrix. See DLASD8 for details.<br>
*> \endverbatim<br>
*><br>
*> \param[out] Z<br>
*> \verbatim<br>
...
*> \param[out] POLES<br>
*> \verbatim<br>
*>          POLES is DOUBLE PRECISION array,<br>
...
*> \param[out] PERM<br>
*> \verbatim<br>
*>          PERM is INTEGER array,<br>
*>         dimension ( LDGCOL, NLVL ) if ICOMPQ = 1, and not referenced<br>
...
*> \param[out] GIVNUM<br>
*> \verbatim<br>
*>          GIVNUM is DOUBLE PRECISION array,<br>
...
*> \param[out] C<br>
*> \verbatim<br>
*>          C is DOUBLE PRECISION array,<br>
*>         dimension ( N ) if ICOMPQ = 1, and dimension 1 if ICOMPQ = 0.<br>
...
*> \param[out] S<br>
*> \verbatim<br>
*>          S is DOUBLE PRECISION array, dimension ( N ) if<br>
...
*> \verbatim<br>
*>          IWORK is INTEGER array.<br>
*>         Dimension must be at least (7 * N).<br>
*> \endverbatim<br>
*><br>
*> \param[out] INFO<br>
*> \verbatim<br>
...
/**
*> \brief \b DLASDQ computes the SVD of a real bidiagonal matrix with diagonal d and off-diagonal e. Used by sbdsdc.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASDQ + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasdq.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasdq.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasdq.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASDQ( UPLO, SQRE, N, NCVT, NRU, NCC, D, E, VT, LDVT,<br>
...
*> \verbatim<br>
*><br>
*> DLASDQ computes the singular value decomposition (SVD) of a real<br>
...
*> \param[in,out] E<br>
*> \verbatim<br>
*>          E is DOUBLE PRECISION array.<br>
...
/**
*> \brief \b DLASDT creates a tree of subproblems for bidiagonal divide and conquer. Used by sbdsdc.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASDT + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasdt.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasdt.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasdt.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASDT( N, LVL, ND, INODE, NDIML, NDIMR, MSUB )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> DLASDT creates a tree of subproblems for bidiagonal divide and<br>
*> conquer.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
/**
*> \brief \b DLASET initializes the off-diagonal elements and the diagonal elements of a matrix to given values.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASET + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaset.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaset.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaset.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASET( UPLO, M, N, ALPHA, BETA, A, LDA )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          UPLO<br>
*       INTEGER            LDA, M, N<br>
...
*> \verbatim<br>
*><br>
*> DLASET initializes an m-by-n matrix A to BETA on the diagonal and<br>
...
/**
*> \brief \b DLASQ1 computes the singular values of a real square bidiagonal matrix. Used by sbdsqr.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASQ1 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasq1.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasq1.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasq1.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASQ1( N, D, E, WORK, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INFO, N<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> DLASQ1 computes the singular values of a real N-by-N bidiagonal<br>
...
*>                  computation, or even feed back into DLASQ1<br>
...
/**
*> \brief \b DLASQ2 computes all the eigenvalues of the symmetric positive definite tridiagonal matrix associated with the qd Array Z to high relative accuracy. Used by sbdsqr and sstegr.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASQ2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasq2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasq2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasq2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
...
*> \verbatim<br>
*><br>
*> DLASQ2 computes all the eigenvalues of the symmetric positive <br>
...
*><br>
*> Note : DLASQ2 defines a logical variable, IEEE, which is true<br>
...
*> \param[in,out] Z<br>
*> \verbatim<br>
*>          Z is DOUBLE PRECISION array, dimension ( 4*N )<br>
...
/**
*> \brief \b DLASQ3 checks for deflation, computes a shift and calls dqds. Used by sbdsqr.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASQ3 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasq3.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasq3.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasq3.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASQ3( I0, N0, Z, PP, DMIN, SIGMA, DESIG, QMAX, NFAIL,<br>
...
*       DOUBLE PRECISION   DESIG, DMIN, DMIN1, DMIN2, DN, DN1, DN2, G,<br>
*      $                   QMAX, SIGMA, TAU<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   Z( * )<br>
...
*> \verbatim<br>
*><br>
*> DLASQ3 checks for deflation, computes a shift (TAU) and calls dqds.<br>
...
*> \param[in,out] Z<br>
*> \verbatim<br>
*>          Z is DOUBLE PRECISION array, dimension ( 4*N0 )<br>
...
*> \verbatim<br>
*>          DESIG is DOUBLE PRECISION<br>
*>         Lower order part of SIGMA<br>
*> \endverbatim<br>
*><br>
*> \param[in] QMAX<br>
*> \verbatim<br>
*>          QMAX is DOUBLE PRECISION<br>
...
*> \verbatim<br>
*>          IEEE is LOGICAL<br>
*>         Flag for IEEE or non IEEE arithmetic (passed to DLASQ5).<br>
*> \endverbatim<br>
*><br>
...
*> \verbatim<br>
*>          DMIN1 is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[in,out] DMIN2<br>
*> \verbatim<br>
*>          DMIN2 is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[in,out] DN<br>
*> \verbatim<br>
*>          DN is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[in,out] DN1<br>
*> \verbatim<br>
*>          DN1 is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[in,out] DN2<br>
*> \verbatim<br>
*>          DN2 is DOUBLE PRECISION<br>
*> \endverbatim<br>
*><br>
*> \param[in,out] G<br>
*> \verbatim<br>
...
/**
*> \brief \b DLASQ4 computes an approximation to the smallest eigenvalue using values of d from the previous transform. Used by sbdsqr.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASQ4 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasq4.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasq4.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasq4.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASQ4( I0, N0, Z, PP, N0IN, DMIN, DMIN1, DMIN2, DN,<br>
*                          DN1, DN2, TAU, TTYPE, G )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            I0, N0, N0IN, PP, TTYPE<br>
*       DOUBLE PRECISION   DMIN, DMIN1, DMIN2, DN, DN1, DN2, G, TAU<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   Z( * )<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> DLASQ4 computes an approximation TAU to the smallest eigenvalue<br>
...
/**
*> \brief \b DLASQ5 computes one dqds transform in ping-pong form. Used by sbdsqr and sstegr.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASQ5 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasq5.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasq5.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasq5.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASQ5( I0, N0, Z, PP, TAU, SIGMA, DMIN, DMIN1, DMIN2, DN,<br>
*                          DNM1, DNM2, IEEE, EPS )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       LOGICAL            IEEE<br>
*       INTEGER            I0, N0, PP<br>
*       DOUBLE PRECISION   DMIN, DMIN1, DMIN2, DN, DNM1, DNM2, TAU, SIGMA, EPS<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   Z( * )<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> DLASQ5 computes one dqds transform in ping-pong form, one<br>
...
*> \param[out] DNM1<br>
*> \verbatim<br>
*>          DNM1 is DOUBLE PRECISION<br>
*>        d(N0-1).<br>
*> \endverbatim<br>
*><br>
*> \param[out] DNM2<br>
*> \verbatim<br>
*>          DNM2 is DOUBLE PRECISION<br>
*>        d(N0-2).<br>
*> \endverbatim<br>
*><br>
*> \param[in] IEEE<br>
...
/**
*> \brief \b DLASQ6 computes one dqd transform in ping-pong form. Used by sbdsqr and sstegr.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASQ6 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasq6.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasq6.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasq6.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASQ6( I0, N0, Z, PP, DMIN, DMIN1, DMIN2, DN,<br>
*                          DNM1, DNM2 )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            I0, N0, PP<br>
*       DOUBLE PRECISION   DMIN, DMIN1, DMIN2, DN, DNM1, DNM2<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   Z( * )<br>
*       ..<br>
...
*> \verbatim<br>
*><br>
*> DLASQ6 computes one dqd (shift equal to zero) transform in<br>
...
/**
*> \brief \b DLASR applies a sequence of plane rotations to a general rectangular matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASR + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasr.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasr.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasr.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASR( SIDE, PIVOT, DIRECT, M, N, C, S, A, LDA )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> DLASR applies a sequence of plane rotations to a real matrix A,<br>
...
/**
*> \brief \b DLASRT sorts numbers in increasing or decreasing order.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASRT + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasrt.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasrt.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasrt.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASRT( ID, N, D, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          ID<br>
*       INTEGER            INFO, N<br>
...
/**
*> \brief \b DLASSQ updates a sum of squares represented in scaled form.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASSQ + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlassq.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlassq.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlassq.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASSQ( N, X, INCX, SCALE, SUMSQ )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            INCX, N<br>
...
*> \verbatim<br>
*><br>
*> DLASSQ  returns the values  scl  and  smsq  such that<br>
*><br>
...
/**
*> \brief \b DLASV2 computes the singular value decomposition of a 2-by-2 triangular matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASV2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasv2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasv2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasv2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASV2( F, G, H, SSMIN, SSMAX, SNR, CSR, SNL, CSL )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       DOUBLE PRECISION   CSL, CSR, F, G, H, SNL, SNR, SSMAX, SSMIN<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLASV2 computes the singular value decomposition of a 2-by-2<br>
...
/**
*> \brief \b DLASWP performs a series of row interchanges on a general rectangular matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASWP + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaswp.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaswp.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaswp.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASWP( N, A, LDA, K1, K2, IPIV, INCX )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> DLASWP performs a series of row interchanges on the matrix A.<br>
...
/**
*> \brief \b DLASY2 solves the Sylvester matrix equation where the matrices are of order 1 or 2.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLASY2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasy2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasy2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasy2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASY2( LTRANL, LTRANR, ISGN, N1, N2, TL, LDTL, TR,<br>
*                          LDTR, B, LDB, SCALE, X, LDX, XNORM, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       LOGICAL            LTRANL, LTRANR<br>
*       INTEGER            INFO, ISGN, LDB, LDTL, LDTR, LDX, N1, N2<br>
*       DOUBLE PRECISION   SCALE, XNORM<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   B( LDB, * ), TL( LDTL, * ), TR( LDTR, * ),<br>
*      $                   X( LDX, * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*> DLASY2 solves for the N1 by N2 matrix X, 1 <= N1,N2 <= 2, in<br>
*><br>
...
*> \param[in] TL<br>
*> \verbatim<br>
*>          TL is DOUBLE PRECISION array, dimension (LDTL,2)<br>
...
*> \param[in] TR<br>
*> \verbatim<br>
*>          TR is DOUBLE PRECISION array, dimension (LDTR,2)<br>
...
*> \param[out] X<br>
*> \verbatim<br>
*>          X is DOUBLE PRECISION array, dimension (LDX,2)<br>
...
/**
*> \brief \b DLASYF computes a partial factorization of a real symmetric matrix using the Bunch-Kaufman diagonal pivoting method.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at<br>
...
*<br>
*> \htmlonly<br>
*> Download DLASYF + dependencies<br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasyf.f"><br>
*> [TGZ]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasyf.f"><br>
*> [ZIP]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasyf.f"><br>
*> [TXT]</a><br>
*> \endhtmlonly<br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASYF( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW, INFO )<br>
*<br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          UPLO<br>
...
*       .. Array Arguments ..<br>
*       INTEGER            IPIV( * )<br>
*       DOUBLE PRECISION   A( LDA, * ), W( LDW, * )<br>
*       ..<br>
*<br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLASYF computes a partial factorization of a real symmetric matrix A<br>
...
*><br>
*> DLASYF is an auxiliary routine called by DSYTRF. It uses blocked code<br>
...
*> \param[out] W<br>
*> \verbatim<br>
*>          W is DOUBLE PRECISION array, dimension (LDW,NB)<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDW<br>
*> \verbatim<br>
...
/**
*> \brief \b DLASYF_ROOK *> DLASYF_ROOK computes a partial factorization of a real symmetric matrix using the bounded Bunch-Kaufman ("rook") diagonal pivoting method.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at<br>
...
*<br>
*> \htmlonly<br>
*> Download DLASYF_ROOK + dependencies<br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlasyf_rook.f"><br>
*> [TGZ]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlasyf_rook.f"><br>
*> [ZIP]</a><br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlasyf_rook.f"><br>
*> [TXT]</a><br>
*> \endhtmlonly<br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLASYF_ROOK( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW, INFO )<br>
*<br>
*       .. Scalar Arguments ..<br>
*       CHARADLATER          UPLO<br>
*       INTEGER            INFO, KB, LDA, LDW, N, NB<br>
...
*> \verbatim<br>
*><br>
*> DLASYF_ROOK computes a partial factorization of a real symmetric<br>
...
*> the argument KB, and is either NB or NB-1, or N if N <= NB.<br>
*><br>
*> DLASYF_ROOK is an auxiliary routine called by DSYTRF_ROOK. It uses<br>
...
/**
*> \brief \b DLAT2S converts a double-precision triangular matrix to a single-precision triangular matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAT2S + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlat2s.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlat2s.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlat2s.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAT2S( UPLO, N, A, LDA, SA, LDSA, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          UPLO<br>
...
*> \verbatim<br>
*><br>
*> DLAT2S converts a DOUBLE PRECISION triangular matrix, SA, to a SINGLE<br>
*> PRECISION triangular matrix, A.<br>
*><br>
*> RMAX is the overflow for the SINGLE PRECISION arithmetic<br>
*> DLAS2S checks that all the entries of A are between -RMAX and<br>
*> RMAX. If not the convertion is aborted and a flag is raised.<br>
*><br>
*> This is an auxiliary routine so there is no argument checking.<br>
*> \endverbatim<br>
...
/**
*> \brief \b DLATBS solves a triangular banded system of equations.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLATBS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlatbs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlatbs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlatbs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLATBS( UPLO, TRANS, DIAG, NORMIN, N, KD, AB, LDAB, X,<br>
*                          SCALE, CNORM, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   AB( LDAB, * ), CNORM( * ), X( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLATBS solves one of the triangular systems<br>
*><br>
...
*> overflow, the Level 2 BLAS routine DTBSV is called.  If the matrix A<br>
...
*> \verbatim<br>
*><br>
*>  A rough bound on x is computed; if that is less than overflow, DTBSV<br>
...
*>                                   1<=i< j<br>
*><br>
*>  Since |x(j)| <= M(j), we use the Level 2 BLAS routine DTBSV if the<br>
...
*>                      1<=i<=j<br>
*><br>
*>  and we can safely call DTBSV if 1/M(n) and 1/G(n) are both greater<br>
...
/**
*> \brief \b DLATDF uses the LU factorization of the n-by-n matrix computed by sgetc2 and computes a contribution to the reciprocal Dif-estimate.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLATDF + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlatdf.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlatdf.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlatdf.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLATDF( IJOB, N, Z, LDZ, RHS, RDSUM, RDSCAL, IPIV,<br>
*                          JPIV )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> DLATDF uses the LU factorization of the n-by-n matrix Z computed by<br>
*> DGETC2 and computes a contribution to the reciprocal Dif-estimate<br>
...
*><br>
*> The factorization of Z returned by DGETC2 has the form Z = P*L*U*Q,<br>
...
*>              of Z using DGECON, e is normalized and solve for<br>
...
*>          matrix Z computed by DGETC2:  Z = P * L * U * Q<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDZ<br>
*> \verbatim<br>
...
*>          the Dif-estimate under computation by DTGSYL, where the<br>
...
*>          NOTE: RDSUM only makes sense when DTGSY2 is called by STGSYL.<br>
*> \endverbatim<br>
*><br>
...
*>          NOTE: RDSCAL only makes sense when DTGSY2 is called by<br>
*>                DTGSYL.<br>
*> \endverbatim<br>
*><br>
*> \param[in] IPIV<br>
...
/**
*> \brief \b DLATPS solves a triangular system of equations with the matrix held in packed storage.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLATPS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlatps.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlatps.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlatps.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLATPS( UPLO, TRANS, DIAG, NORMIN, N, AP, X, SCALE,<br>
*                          CNORM, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          DIAG, NORMIN, TRANS, UPLO<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   AP( * ), CNORM( * ), X( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLATPS solves one of the triangular systems<br>
*><br>
*>    A *x = s*b  or  A**T*x = s*b<br>
*><br>
*> with scaling to prevent overflow, where A is an upper or lower<br>
...
*> DTPSV is called. If the matrix A is singular (A(j,j) = 0 for some j),<br>
...
*> \verbatim<br>
*><br>
*>  A rough bound on x is computed; if that is less than overflow, DTPSV<br>
*>  is called, otherwise, specific code is used which checks for possible<br>
*>  overflow or divide-by-zero at every operation.<br>
*><br>
*>  A columnwise scheme is used for solving A*x = b.  The basic algorithm<br>
...
*>                                   1<=i< j<br>
*><br>
*>  Since |x(j)| <= M(j), we use the Level 2 BLAS routine DTPSV if the<br>
*>  reciprocal of the largest M(j), j=1,..,n, is larger than<br>
*>  max(underflow, 1/overflow).<br>
*><br>
*>  The bound on x(j) is also used to determine when a step in the<br>
...
*>                      1<=i<=j<br>
*><br>
*>  and we can safely call DTPSV if 1/M(n) and 1/G(n) are both greater<br>
*>  than max(underflow, 1/overflow).<br>
*> \endverbatim<br>
*><br>
*  =====================================================================<br>
...
/**
*> \brief \b DLATRD reduces the first nb rows and columns of a symmetric/Hermitian matrix A to real tridiagonal form by an orthogonal similarity transformation.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLATRD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlatrd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlatrd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlatrd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLATRD( UPLO, N, NB, A, LDA, E, TAU, W, LDW )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          UPLO<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   A( LDA, * ), E( * ), TAU( * ), W( LDW, * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLATRD reduces NB rows and columns of a real symmetric matrix A to<br>
...
*><br>
*> If UPLO = 'U', DLATRD reduces the last NB rows and columns of a<br>
*> matrix, of which the upper triangle is supplied;<br>
*> if UPLO = 'L', DLATRD reduces the first NB rows and columns of a<br>
*> matrix, of which the lower triangle is supplied.<br>
*><br>
*> This is an auxiliary routine called by DSYTRD.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
*  ==========<br>
...
/**
*> \brief \b DLATRS solves a triangular system of equations with the scale factor set to prevent overflow.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLATRS + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlatrs.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlatrs.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlatrs.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLATRS( UPLO, TRANS, DIAG, NORMIN, N, A, LDA, X, SCALE,<br>
*                          CNORM, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          DIAG, NORMIN, TRANS, UPLO<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   A( LDA, * ), CNORM( * ), X( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLATRS solves one of the triangular systems<br>
*><br>
*>    A *x = s*b  or  A**T *x = s*b<br>
*><br>
...
*> or equal to 1, chosen so that the components of x will be less than<br>
*> the overflow threshold.  If the unscaled problem will not cause<br>
*> overflow, the Level 2 BLAS routine DTRSV is called.  If the matrix A<br>
*> is singular (A(j,j) = 0 for some j), then s is set to 0 and a<br>
*> non-trivial solution to A*x = 0 is returned.<br>
*> \endverbatim<br>
*<br>
...
*> \verbatim<br>
*><br>
*>  A rough bound on x is computed; if that is less than overflow, DTRSV<br>
*>  is called, otherwise, specific code is used which checks for possible<br>
*>  overflow or divide-by-zero at every operation.<br>
*><br>
*>  A columnwise scheme is used for solving A*x = b.  The basic algorithm<br>
...
*>                                   1<=i< j<br>
*><br>
*>  Since |x(j)| <= M(j), we use the Level 2 BLAS routine DTRSV if the<br>
*>  reciprocal of the largest M(j), j=1,..,n, is larger than<br>
*>  max(underflow, 1/overflow).<br>
*><br>
*>  The bound on x(j) is also used to determine when a step in the<br>
...
*>                      1<=i<=j<br>
*><br>
*>  and we can safely call DTRSV if 1/M(n) and 1/G(n) are both greater<br>
*>  than max(underflow, 1/overflow).<br>
*> \endverbatim<br>
*><br>
*  =====================================================================<br>
...
/**
*> \brief \b DLATRZ factors an upper trapezoidal matrix by means of orthogonal transformations.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLATRZ + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlatrz.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlatrz.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlatrz.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLATRZ( M, N, L, A, LDA, TAU, WORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*> \verbatim<br>
*><br>
*> DLATRZ factors the M-by-(M+L) real upper trapezoidal matrix<br>
...
*> \param[out] TAU<br>
*> \verbatim<br>
*>          TAU is DOUBLE PRECISION array, dimension (M)<br>
*>          The scalar factors of the elementary reflectors.<br>
*> \endverbatim<br>
*><br>
*> \param[out] WORK<br>
...
/**
*> \brief \b DLAUU2 computes the product UUH or LHL, where U and L are upper or lower triangular matrices (unblocked algorithm).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAUU2 + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlauu2.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlauu2.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlauu2.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAUU2( UPLO, N, A, LDA, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          UPLO<br>
*       INTEGER            INFO, LDA, N<br>
...
*> \verbatim<br>
*><br>
*> DLAUU2 computes the product U * U**T or L**T * L, where the triangular<br>
...
/**
*> \brief \b DLAUUM computes the product UUH or LHL, where U and L are upper or lower triangular matrices (blocked algorithm).<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLAUUM + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlauum.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlauum.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlauum.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLAUUM( UPLO, N, A, LDA, INFO )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          UPLO<br>
*       INTEGER            INFO, LDA, N<br>
...
*> \verbatim<br>
*><br>
*> DLAUUM computes the product U * U**T or L**T * L, where the triangular<br>
*> factor U or L is stored in the upper or lower triangular part of<br>
*> the array A.<br>
*><br>
*> If UPLO = 'U' or 'u' then the upper triangle of the result is stored,<br>
...
/**
*> \brief \b DLA_GBAMV performs a matrix-vector operation to calculate error bounds.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLA_GBAMV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dla_gbamv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dla_gbamv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dla_gbamv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLA_GBAMV( TRANS, M, N, KL, KU, ALPHA, AB, LDAB, X,<br>
*                             INCX, BETA, Y, INCY )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       DOUBLE PRECISION   ALPHA, BETA<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   AB( LDAB, * ), X( * ), Y( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLA_GBAMV  performs one of the matrix-vector operations<br>
*><br>
...
*> \param[in] AB<br>
*> \verbatim<br>
*>          AB is DOUBLE PRECISION array of DIMENSION ( LDAB, n )<br>
...
/**
*> \brief \b DLA_GBRCOND estimates the Skeel condition number for a general banded matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLA_GBRCOND + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dla_gbrcond.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dla_gbrcond.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dla_gbrcond.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLA_GBRCOND( TRANS, N, KL, KU, AB, LDAB,<br>
*                                              AFB, LDAFB, IPIV, CMODE, C,<br>
*                                              INFO, WORK, IWORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANS<br>
...
*       DOUBLE PRECISION   AB( LDAB, * ), AFB( LDAFB, * ), WORK( * ),<br>
*      $                   C( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*>    DLA_GBRCOND Estimates the Skeel condition number of  op(A) * op2(C)<br>
...
*>     computed by DGBTRF.  U is stored as an upper triangular<br>
...
/**
*> \brief \b DLA_GBRFSX_EXTENDED improves the computed solution to a system of linear equations for general banded matrices by performing extra-precise iterative refinement and provides error bounds and backward error estimates for the solution.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLA_GBRFSX_EXTENDED + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dla_gbrfsx_extended.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dla_gbrfsx_extended.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dla_gbrfsx_extended.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLA_GBRFSX_EXTENDED( PREC_TYPE, TRANS_TYPE, N, KL, KU,<br>
...
*><br>
*> <br>
*> DLA_GBRFSX_EXTENDED improves the computed solution to a system of<br>
...
*> This subroutine is called by DGBRFSX to perform iterative refinement.<br>
...
*> \verbatim<br>
*>          LDAB is INTEGER<br>
*>          The leading dimension of the array AB.  LDBA >= max(1,N).<br>
*> \endverbatim<br>
*><br>
*> \param[in] AFB<br>
*> \verbatim<br>
...
*>     A = P*L*U as computed by DGBTRF.<br>
*> \endverbatim<br>
*><br>
*> \param[in] LDAFB<br>
*> \verbatim<br>
...
*>     or vector Z. This is computed by DLA_LIN_BERR.<br>
*> \endverbatim<br>
*><br>
*> \param[in] N_NORMS<br>
*> \verbatim<br>
...
*> \param[in] RES<br>
*> \verbatim<br>
*>          RES is DOUBLE PRECISION array, dimension (N)<br>
...
*> \param[in] Y_TAIL<br>
*> \verbatim<br>
*>          Y_TAIL is DOUBLE PRECISION array, dimension (N)<br>
...
*>          INFO is INTEGER<br>
*>       = 0:  Successful exit.<br>
*>       < 0:  if INFO = -i, the ith argument to DGBTRS had an illegal<br>
*>             value<br>
*> \endverbatim<br>
*<br>
*  Authors:<br>
...
/**
*> \brief \b DLA_GBRPVGRW computes the reciprocal pivot growth factor norm(A)/norm(U) for a general banded matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLA_GBRPVGRW + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dla_gbrpvgrw.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dla_gbrpvgrw.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dla_gbrpvgrw.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLA_GBRPVGRW( N, KL, KU, NCOLS, AB,<br>
*                                               LDAB, AFB, LDAFB )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   AB( LDAB, * ), AFB( LDAFB, * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> DLA_GBRPVGRW computes the reciprocal pivot growth factor<br>
...
/**
*> \brief \b DLA_GEAMV computes a matrix-vector product using a general matrix to calculate error bounds.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLA_GEAMV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dla_geamv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dla_geamv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dla_geamv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLA_GEAMV ( TRANS, M, N, ALPHA, A, LDA, X, INCX, BETA,<br>
*                              Y, INCY )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       DOUBLE PRECISION   ALPHA, BETA<br>
...
*> \verbatim<br>
*><br>
*> DLA_GEAMV  performs one of the matrix-vector operations<br>
*><br>
*>         y := alpha*abs(A)*abs(x) + beta*abs(y),<br>
*>    or   y := alpha*abs(A)**T*abs(x) + beta*abs(y),<br>
*><br>
...
/**
*> \brief \b DLA_GERCOND estimates the Skeel condition number for a general matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLA_GERCOND + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dla_gercond.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dla_gercond.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dla_gercond.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLA_GERCOND ( TRANS, N, A, LDA, AF,<br>
*                                               LDAF, IPIV, CMODE, C,<br>
*                                               INFO, WORK, IWORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          TRANS<br>
...
*       DOUBLE PRECISION   A( LDA, * ), AF( LDAF, * ), WORK( * ),<br>
*      $                   C( * )<br>
*       ..<br>
*  <br>
*<br>
...
*> \verbatim<br>
*><br>
*>    DLA_GERCOND estimates the Skeel condition number of op(A) * op2(C)<br>
*>    where op2 is determined by CMODE as follows<br>
*>    CMODE =  1    op2(C) = C<br>
*>    CMODE =  0    op2(C) = I<br>
*>    CMODE = -1    op2(C) = inv(C)<br>
...
/**
*> \brief \b DLA_GERFSX_EXTENDED improves the computed solution to a system of linear equations for general matrices by performing extra-precise iterative refinement and provides error bounds and backward error estimates for the solution.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLA_GERFSX_EXTENDED + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dla_gerfsx_extended.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dla_gerfsx_extended.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dla_gerfsx_extended.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLA_GERFSX_EXTENDED( PREC_TYPE, TRANS_TYPE, N, NRHS, A,<br>
...
*><br>
*> <br>
*> DLA_GERFSX_EXTENDED improves the computed solution to a system of<br>
*> linear equations by performing extra-precise iterative refinement<br>
*> and provides error bounds and backward error estimates for the solution.<br>
*> This subroutine is called by DGERFSX to perform iterative refinement.<br>
*> In addition to normwise error bound, the code provides maximum<br>
...
*>          INFO is INTEGER<br>
*>       = 0:  Successful exit.<br>
*>       < 0:  if INFO = -i, the ith argument to DGETRS had an illegal<br>
*>             value<br>
*> \endverbatim<br>
*<br>
*  Authors:<br>
...
*<br>
*> \htmlonly<br>
*> Download DLA_GERPVGRW + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dla_gerpvgrw.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dla_gerpvgrw.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dla_gerpvgrw.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLA_GERPVGRW( N, NCOLS, A, LDA, AF,<br>
*                LDAF )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   A( LDA, * ), AF( LDAF, * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*><br>
*> <br>
*> DLA_GERPVGRW computes the reciprocal pivot growth factor<br>
*> norm(A)/norm(U). The "max absolute element" norm is used. If this is<br>
*> much less than 1, the stability of the LU factorization of the<br>
*> (equilibrated) matrix A could be poor. This also means that the<br>
*> solution X, estimated condition numbers, and error bounds could be<br>
...
/**
*> \brief \b DLA_LIN_BERR computes a component-wise relative backward error.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLA_LIN_BERR + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dla_lin_berr.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dla_lin_berr.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dla_lin_berr.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLA_LIN_BERR ( N, NZ, NRHS, RES, AYB, BERR )<br>
* <br>
*       .. Scalar Arguments ..<br>
...
*       DOUBLE PRECISION   RES( N, NRHS )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*>    DLA_LIN_BERR computes component-wise relative backward error from<br>
*>    the formula<br>
*>        max(i) ( abs(R(i)) / ( abs(op(A_s))*abs(Y) + abs(B_s) )(i) )<br>
*>    where abs(Z) is the component-wise absolute value of the matrix<br>
*>    or vector Z.<br>
*> \endverbatim<br>
*<br>
*  Arguments:<br>
...
*> \param[in] RES<br>
*> \verbatim<br>
*>          RES is DOUBLE PRECISION array, dimension (N,NRHS)<br>
...
*>     are from iterative refinement (see dla_gerfsx_extended.f).<br>
*> \endverbatim<br>
*>     <br>
*> \param[out] BERR<br>
*> \verbatim<br>
*>          BERR is DOUBLE PRECISION array, dimension (NRHS)<br>
*>     The component-wise relative backward error from the formula above.<br>
*> \endverbatim<br>
*<br>
*  Authors:<br>
*  ========<br>
...
/**
*> \brief \b DLA_PORCOND estimates the Skeel condition number for a symmetric positive-definite matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLA_PORCOND + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dla_porcond.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dla_porcond.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dla_porcond.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLA_PORCOND( UPLO, N, A, LDA, AF, LDAF,<br>
*                                              CMODE, C, INFO, WORK,<br>
*                                              IWORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          UPLO<br>
...
*> \verbatim<br>
*><br>
*>    DLA_PORCOND Estimates the Skeel condition number of  op(A) * op2(C)<br>
*>    where op2 is determined by CMODE as follows<br>
*>    CMODE =  1    op2(C) = C<br>
*>    CMODE =  0    op2(C) = I<br>
*>    CMODE = -1    op2(C) = inv(C)<br>
...
/**
*> \brief \b DLA_PORFSX_EXTENDED improves the computed solution to a system of linear equations for symmetric or Hermitian positive-definite matrices by performing extra-precise iterative refinement and provides error bounds and backward error estimates for the solution.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLA_PORFSX_EXTENDED + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dla_porfsx_extended.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dla_porfsx_extended.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dla_porfsx_extended.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLA_PORFSX_EXTENDED( PREC_TYPE, UPLO, N, NRHS, A, LDA,<br>
...
*> \verbatim<br>
*><br>
*> DLA_PORFSX_EXTENDED improves the computed solution to a system of<br>
*> linear equations by performing extra-precise iterative refinement<br>
*> and provides error bounds and backward error estimates for the solution.<br>
*> This subroutine is called by DPORFSX to perform iterative refinement.<br>
*> In addition to normwise error bound, the code provides maximum<br>
*> componentwise error bound if possible. See comments for ERR_BNDS_NORM<br>
*> and ERR_BNDS_COMP for details of the error bounds. Note that this<br>
*> subroutine is only resonsible for setting the second fields of<br>
...
*>          INFO is INTEGER<br>
*>       = 0:  Successful exit.<br>
*>       < 0:  if INFO = -i, the ith argument to DPOTRS had an illegal<br>
*>             value<br>
*> \endverbatim<br>
*<br>
*  Authors:<br>
...
/**
*> \brief \b DLA_PORPVGRW computes the reciprocal pivot growth factor norm(A)/norm(U) for a symmetric or Hermitian positive-definite matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLA_PORPVGRW + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dla_porpvgrw.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dla_porpvgrw.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dla_porpvgrw.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLA_PORPVGRW( UPLO, NCOLS, A, LDA, AF, <br>
*                                               LDAF, WORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER*1        UPLO<br>
...
*><br>
*> <br>
*> DLA_PORPVGRW computes the reciprocal pivot growth factor<br>
*> norm(A)/norm(U). The "max absolute element" norm is used. If this is<br>
*> much less than 1, the stability of the LU factorization of the<br>
*> (equilibrated) matrix A could be poor. This also means that the<br>
*> solution X, estimated condition numbers, and error bounds could be<br>
...
*<br>
*> \htmlonly<br>
*> Download DLA_SYAMV + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dla_syamv.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dla_syamv.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dla_syamv.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLA_SYAMV( UPLO, N, ALPHA, A, LDA, X, INCX, BETA, Y,<br>
*                             INCY )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       DOUBLE PRECISION   ALPHA, BETA<br>
...
*> \verbatim<br>
*><br>
*> DLA_SYAMV  performs the matrix-vector operation<br>
*><br>
*>         y := alpha*abs(A)*abs(x) + beta*abs(y),<br>
*><br>
*> where alpha and beta are scalars, x and y are vectors and A is an<br>
...
/**
*> \brief \b DLA_SYRCOND estimates the Skeel condition number for a symmetric indefinite matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLA_SYRCOND + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dla_syrcond.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dla_syrcond.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dla_syrcond.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLA_SYRCOND( UPLO, N, A, LDA, AF, LDAF, <br>
*                                              IPIV, CMODE, C, INFO, WORK,<br>
*                                              IWORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER          UPLO<br>
...
*       .. Array Arguments<br>
*       INTEGER            IWORK( * ), IPIV( * )<br>
*       DOUBLE PRECISION   A( LDA, * ), AF( LDAF, * ), WORK( * ), C( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*>    DLA_SYRCOND estimates the Skeel condition number of  op(A) * op2(C)<br>
*>    where op2 is determined by CMODE as follows<br>
*>    CMODE =  1    op2(C) = C<br>
*>    CMODE =  0    op2(C) = I<br>
*>    CMODE = -1    op2(C) = inv(C)<br>
...
/**
*> \brief \b DLA_SYRFSX_EXTENDED improves the computed solution to a system of linear equations for symmetric indefinite matrices by performing extra-precise iterative refinement and provides error bounds and backward error estimates for the solution.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLA_SYRFSX_EXTENDED + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dla_syrfsx_extended.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dla_syrfsx_extended.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dla_syrfsx_extended.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLA_SYRFSX_EXTENDED( PREC_TYPE, UPLO, N, NRHS, A, LDA,<br>
...
*><br>
*> <br>
*> DLA_SYRFSX_EXTENDED improves the computed solution to a system of<br>
*> linear equations by performing extra-precise iterative refinement<br>
*> and provides error bounds and backward error estimates for the solution.<br>
*> This subroutine is called by DSYRFSX to perform iterative refinement.<br>
*> In addition to normwise error bound, the code provides maximum<br>
*> componentwise error bound if possible. See comments for ERR_BNDS_NORM<br>
*> and ERR_BNDS_COMP for details of the error bounds. Note that this<br>
*> subroutine is only resonsible for setting the second fields of<br>
...
*>          INFO is INTEGER<br>
*>       = 0:  Successful exit.<br>
*>       < 0:  if INFO = -i, the ith argument to DLA_SYRFSX_EXTENDED had an illegal<br>
*>             value<br>
*> \endverbatim<br>
*<br>
*  Authors:<br>
...
/**
*> \brief \b DLA_SYRPVGRW computes the reciprocal pivot growth factor norm(A)/norm(U) for a symmetric indefinite matrix.<br>
*<br>
*  =========== DOCUMENTATION ===========<br>
*<br>
* Online html documentation available at <br>
...
*<br>
*> \htmlonly<br>
*> Download DLA_SYRPVGRW + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dla_syrpvgrw.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dla_syrpvgrw.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dla_syrpvgrw.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       DOUBLE PRECISION FUNCTION DLA_SYRPVGRW( UPLO, N, INFO, A, LDA, AF,<br>
*                                               LDAF, IPIV, WORK )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       CHARACTER*1        UPLO<br>
...
*><br>
*> <br>
*> DLA_SYRPVGRW computes the reciprocal pivot growth factor<br>
*> norm(A)/norm(U). The "max absolute element" norm is used. If this is<br>
*> much less than 1, the stability of the LU factorization of the<br>
*> (equilibrated) matrix A could be poor. This also means that the<br>
*> solution X, estimated condition numbers, and error bounds could be<br>
...
*> \verbatim<br>
*>          INFO is INTEGER<br>
*>     The value of INFO returned from DSYTRF, .i.e., the pivot in<br>
...
*<br>
*> \htmlonly<br>
*> Download DLA_WWADDW + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dla_wwaddw.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dla_wwaddw.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dla_wwaddw.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE DLA_WWADDW( N, X, Y, W )<br>
* <br>
*       .. Scalar Arguments ..<br>
*       INTEGER            N<br>
*       ..<br>
*       .. Array Arguments ..<br>
*       DOUBLE PRECISION   X( * ), Y( * ), W( * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*>    DLA_WWADDW adds a vector W into a doubled-single vector (X, Y).<br>
*><br>
