...
*<br>
*> \htmlonly<br>
*> Download CBBCSD + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cbbcsd.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cbbcsd.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cbbcsd.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CBBCSD( JOBU1, JOBU2, JOBV1T, JOBV2T, TRANS, M, P, Q,<br>
...
*> \verbatim<br>
*><br>
*> CBBCSD computes the CS decomposition of a unitary matrix in<br>
...
*> the TRANS and SIGNS options. See CUNCSD for details.)<br>
*><br>
...
*> \param[in,out] U1<br>
*> \verbatim<br>
*>          U1 is COMPLEX array, dimension (LDU1,P)<br>
...
*> \param[in,out] U2<br>
*> \verbatim<br>
*>          U2 is COMPLEX array, dimension (LDU2,M-P)<br>
...
*> \param[in,out] V1T<br>
*> \verbatim<br>
*>          V1T is COMPLEX array, dimension (LDV1T,Q)<br>
...
*> \param[in,out] V2T<br>
*> \verbatim<br>
*>          V2T is COMPLEX array, dimenison (LDV2T,M-Q)<br>
...
*>          When CBBCSD converges, B11D contains the cosines of THETA(1),<br>
*>          ..., THETA(Q). If CBBCSD fails to converge, then B11D<br>
...
*>          When CBBCSD converges, B11E contains zeros. If CBBCSD fails<br>
...
*>          When CBBCSD converges, B12D contains the negative sines of<br>
*>          THETA(1), ..., THETA(Q). If CBBCSD fails to converge, then<br>
...
*>          When CBBCSD converges, B12E contains zeros. If CBBCSD fails<br>
...
*>          When CBBCSD converges, B21D contains the negative sines of<br>
*>          THETA(1), ..., THETA(Q). If CBBCSD fails to converge, then<br>
...
*>          When CBBCSD converges, B21E contains zeros. If CBBCSD fails<br>
...
*>          When CBBCSD converges, B22D contains the negative sines of<br>
*>          THETA(1), ..., THETA(Q). If CBBCSD fails to converge, then<br>
...
*>          When CBBCSD converges, B22E contains zeros. If CBBCSD fails<br>
...
*> \param[out] RWORK<br>
*> \verbatim<br>
*>          RWORK is REAL array, dimension (MAX(1,LWORK))<br>
...
*>          > 0:  if CBBCSD did not converge, INFO specifies the number<br>
...
*<br>
*> \htmlonly<br>
*> Download CBDSQR + dependencies <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cbdsqr.f"> <br>
*> [TGZ]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cbdsqr.f"> <br>
*> [ZIP]</a> <br>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cbdsqr.f"> <br>
*> [TXT]</a><br>
*> \endhtmlonly <br>
*<br>
*  Definition:<br>
*  ===========<br>
*<br>
*       SUBROUTINE CBDSQR( UPLO, N, NCVT, NRU, NCC, D, E, VT, LDVT, U,<br>
...
*       .. Array Arguments ..<br>
*       REAL               D( * ), E( * ), RWORK( * )<br>
*       COMPLEX            C( LDC, * ), U( LDU, * ), VT( LDVT, * )<br>
*       ..<br>
*  <br>
*<br>
*> \par Purpose:<br>
...
*> \verbatim<br>
*><br>
*> CBDSQR computes the singular values and, optionally, the right and/or<br>
...
*> form: A = U*B*VT, as computed by CGEBRD, then<br>
*> <br>
*>    A = (U*Q) * S * (P**H*VT)<br>
*> <br>
...
*> \param[in,out] VT<br>
*> \verbatim<br>
*>          VT is COMPLEX array, dimension (LDVT, NCVT)<br>
...
*> \param[in,out] U<br>
*> \verbatim<br>
*>          U is COMPLEX array, dimension (LDU, N)<br>
...
*> \param[out] RWORK<br>
*> \verbatim<br>
*>          RWORK is REAL array, dimension (4*N)<br>
*> \endverbatim<br>
*><br>
*> \param[out] INFO<br>
*> \verbatim<br>
